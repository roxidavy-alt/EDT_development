...
Функция СтраницыРазделаКонтейнера(Контейнер, НомерЛиста, НомерПриложения, ИндексКомплектаСтраниц, ИмяРедакции) Экспорт
	...
	ИначеЕсли НомерПриложения = "5" Тогда
		ИндексПриложения = 4;
	ИначеЕсли НомерПриложения = "7А" Тогда
		ИндексПриложения = 5;
	ИначеЕсли НомерПриложения = "7Б" Тогда
		ИндексПриложения = 6;
	ИначеЕсли НомерПриложения = "7В" Тогда
		ИндексПриложения = 7;
	ИначеЕсли НомерПриложения = "7Г" Тогда
		ИндексПриложения = 8;
...
Функция КодМножественногоЭлемента(КодТаблицыФНС, КодЭлементаФНС, ИмяРедакции) Экспорт
	...
	Если КодТаблицыФНС = "ОстУбытНачПерГод"
		...
		Или КодТаблицыФНС = "ОстНеиспВычГод"
		Или КодТаблицыФНС = "ОстНеиспВычРИНВНачалоПериода"
		Или КодТаблицыФНС = "УменьшенНалогНаСуммуИНВЗаПериод"
		Или КодТаблицыФНС = "ОстНеиспВычРИНВКонецПериода"
		Или КодТаблицыФНС = "ОстНеиспВычРИНВФБНачалоПериода"
		Или КодТаблицыФНС = "ОстНеиспВычРИНВФБКонецПериода" Тогда

		Если КодЭлементаФНС = "Год" 
			ИЛИ КодЭлементаФНС = "Код" Тогда
			Возврат "00001";
		КонецЕсли;

		Если КодЭлементаФНС = "ОстУбыт"
			Или КодЭлементаФНС = "СумНеиспВыч"
			Или КодЭлементаФНС = "ОстНеиспВыч" 
			Или КодЭлементаФНС = "ОстНеиспВычРИНВНачалоПериода"
			Или КодЭлементаФНС = "УменьшенНалогНаСуммуИНВЗаПериод"
			Или КодЭлементаФНС = "ОстНеиспВычРИНВКонецПериода"
			Или КодЭлементаФНС = "ОстНеиспВычРИНВФБНачалоПериода"
			Или КодЭлементаФНС = "ОстНеиспВычРИНВФБКонецПериода" Тогда
			Возврат "00003";
		КонецЕсли;
	...
	ИначеЕсли КодТаблицыФНС = "РаспрНалСубРФТип" Тогда
		...
		Иначе
			...
			ИначеЕсли КодЭлементаФНС = "НаимОП" Тогда
				Возврат "00600";
			ИначеЕсли КодЭлементаФНС = "НомерДокумента" Тогда
				Возврат "00200";
			КонецЕсли;
		КонецЕсли;
...
Функция КодМногострочнойЧасти(КодЭлементаФНС)
	...
	ИначеЕсли КодЭлементаФНС = "ОстНеиспВычГод" Тогда
		Возврат "П0027ДМ2";
	ИначеЕсли КодЭлементаФНС = "ОстНеиспВычРИНВНачалоПериода" Тогда
		Возврат "П0027АМ1";
	ИначеЕсли КодЭлементаФНС = "УменьшенНалогНаСуммуИНВЗаПериод" Тогда
		Возврат "П0027АМ2";
	ИначеЕсли КодЭлементаФНС = "ОстНеиспВычРИНВКонецПериода" Тогда
		Возврат "П0027АМ3";
	ИначеЕсли КодЭлементаФНС = "ОстНеиспВычРИНВФБНачалоПериода" Тогда
		Возврат "П0027ГМ1";
	ИначеЕсли КодЭлементаФНС = "ОстНеиспВычРИНВФБКонецПериода" Тогда
		Возврат "П0027ГМ2";
	КонецЕсли;
