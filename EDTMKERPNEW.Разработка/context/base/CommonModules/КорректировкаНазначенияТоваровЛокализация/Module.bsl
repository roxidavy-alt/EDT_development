...
#Область ТекстКорректировкаНаправленийДеятельностиТовары // (Дт 41.01 :: Кт 41.01)
	...
	|	""КорректировкаНазначенияТоваровЛокализация_440"" КАК НомерФрагмента
	|
	|ИЗ
...
#Область ТекстКорректировкаНаправленийДеятельностиПроизводственныеТовары // (Дт 20 :: Кт 20)
	...
	|	СУММА(ЕСТЬNULL(Стоимости.СуммаВР, Строки.СуммаВР)) КАК СуммаВРКт,
	|	""Корректировка направления деятельности"" КАК Содержание,
	|	""КорректировкаНазначенияТоваровЛокализация_441"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#КонецОбласти
	...
	|	""КорректировкаНазначенияТоваровЛокализация_442"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Включение/исключение НДС в стоимость товара"" КАК Содержание,
	|	""КорректировкаНазначенияТоваровЛокализация_443"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
