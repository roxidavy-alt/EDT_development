...
Функция СформироватьПечатнуюФормуКО2(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	//++ НЕ УТ
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПорядокОтраженияНаСчетахУчетаПоПериодуДействия КАК ПорядокОтраженияНаСчетахУчетаПереопределяемый
	...
	|			И ДанныеДокумента.Дата >= ПорядокОтраженияНаСчетахУчетаПереопределяемый.НачалоДействия
	|			И ДанныеДокумента.Дата < ПорядокОтраженияНаСчетахУчетаПереопределяемый.ОкончаниеДействия
	//-- НЕ УТ
	|ГДЕ
...
#Область СдачаВБанк
	...
	|	""РасходныйКассовыйОрдерЛокализация_1068"" КАК НомерФрагмента
	|
	|ИЗ 
	...
	|	""РасходныйКассовыйОрдерЛокализация_1069"" КАК НомерФрагмента
	|	
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыдачаВКассуККМ
	...
	|	""РасходныйКассовыйОрдерЛокализация_1070"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВозвратКлиентуАвансаПогашениеДолга
	...
	|	""РасходныйКассовыйОрдерЛокализация_1825"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВозвратДСКлиенту
	...
	|	""РасходныйКассовыйОрдерЛокализация_1826"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ОплатаАвансаПоставщикуДругойОрганизации
	...
	|	""РасходныйКассовыйОрдерЛокализация_1827"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ОплатаДолгаПоставщикуДругойОрганизации
	...
	|	КОНЕЦ КАК Содержание,
	|	""РасходныйКассовыйОрдерЛокализация_1828"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыплатаЗарПлатыПоВедомостям
	...
	|	""РасходныйКассовыйОрдерЛокализация_1071"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыплатаЗарПлатыРаботнику
	...
	|	""РасходныйКассовыйОрдерЛокализация_1072"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыдачаПодотчетнику
	...
	|	""РасходныйКассовыйОрдерЛокализация_1073"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область КонвертацияВалюты
	...
	|	""РасходныйКассовыйОрдерЛокализация_1074"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыдачаДСВДругуюКассу
	...
	|	""РасходныйКассовыйОрдерЛокализация_1075"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВнутренняяПередачаДС
	...
	|	""РасходныйКассовыйОрдерЛокализация_1076"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область РасчетыПоКредитамЗаймам // (Дт 66.01, 66.02, 76.09 :: Кт 50)
	...
	|	КОНЕЦ КАК Содержание,
	|	""РасходныйКассовыйОрдерЛокализация_1829"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыдачаЗайма                     // (Дт 58.03 :: Кт 50)
	...
	|	""РасходныйКассовыйОрдерЛокализация_1077"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыдачаЗаймаСотруднику           // (Дт 73.01 :: Кт 50)
	...
	|	""РасходныйКассовыйОрдерЛокализация_1078"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВозвратЗалогаЗаТару
	...
	|	""РасходныйКассовыйОрдерЛокализация_1079"" КАК НомерФрагмента
	|
	|ИЗ 
	|	Документ.РасходныйКассовыйОрдер КАК Операция
	|	
...
#Область ПрочиеРасходы
	...
	|	""РасходныйКассовыйОрдерЛокализация_1080"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПрочееСписание
	...
	|	""РасходныйКассовыйОрдерЛокализация_1081"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ОплатаАрендодателю
	...
	|	""РасходныйКассовыйОрдерЛокализация_1082"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстОплатаДолгаАвансаПоставщикуДругойОрганизацииМежФилиальная()
	...
	|		ИНАЧЕ ""Оплата аванса поставщику""
	|	КОНЕЦ КАК Содержание,
	|	""РасходныйКассовыйОрдерЛокализация_1830"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
