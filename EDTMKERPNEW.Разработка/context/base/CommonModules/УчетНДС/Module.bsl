	...
	ИначеЕсли ВерсияКодовВидовОпераций = 6 Тогда 
		...
		Если ЧастьЖурнала = Перечисления.ЧастиЖурналаУчетаСчетовФактур.ПолученныеСчетаФактуры Тогда
			...
			СписокКодовОпераций.Добавить("46", НСтр("ru = '46 - Ввоз товаров из ЕАЭС по договору комиссии на закупку';
													|en = '46 - Goods import from EAEU under the purchase commission contract'"));
			...
			СписокКодовОпераций.Добавить("54", НСтр("ru = '54 - Авансы выданные за работы (услуги) по ВСМ (Постановление № 1992)';
													|en = '54 - Advances issued for high-speed rail transport works (services) (Decree No. 1992)'"));
			СписокКодовОпераций.Добавить("55", НСтр("ru = '55 - Изменение стоимости работ (услуг) по ВСМ в сторону уменьшения (Постановление № 1992)';
													|en = '55 - Change in cost of high-speed rail transport works (services) toward decrease (Decree No. 1992)'"));
			СписокКодовОпераций.Добавить("58", НСтр("ru = '58 - Авансы выданные за медные полуфабрикаты п.8 ст. 161 НК';
													|en = '58 - Advances issued for copper semi-finished products cl.8, art. 161 of the Tax Code'"));
			СписокКодовОпераций.Добавить("59", НСтр("ru = '59 - Получение медных полуфабрикатов п.8 ст. 161 НК';
													|en = '59 - Receipt of copper semi-finished products cl. 8 of art. 161 of the Tax Code'"));
			СписокКодовОпераций.Добавить("60", НСтр("ru = '60 - Возврат, зачет авансовых платежей за медные полуфабрикаты п.8 ст. 161 НК';
													|en = '60 - Return and recognition of advance payments for copper semi-finished products, cl. 8 of art. 161 of the Tax Code'"));
			СписокКодовОпераций.Добавить("61", НСтр("ru = '61 - Изменение стоимости полученных медных полуфабрикатов п.8 ст. 161 НК в сторону уменьшения';
													|en = '61 - Change of received copper semi-finished products cost toward decrease cl.8 of art.161 of the Tax Code'"));
		...
		ИначеЕсли ЧастьЖурнала = Перечисления.ЧастиЖурналаУчетаСчетовФактур.ВыставленныеСчетаФактуры Тогда
			...
			СписокКодовОпераций.Добавить("47", НСтр("ru = '47 - Перепродажа товаров физических лиц, п.5.1, п.5.2 ст.154 НК';
													|en = '47 - Resale of person goods, subcl. 5.1, subcl. 5.2, art. 154 of the Tax Code of the Russian Federation'"));
				
			// Коды, введенные в действие с 1 января 2026 года.  
			СписокКодовОпераций.Добавить("52", НСтр("ru = '52 - Авансы полученные за работы (услуги) по ВСМ (Постановление № 1992)';
													|en = '52 - Advance payments received for high-speed rail transport works (services) (Decree No. 1992)'"));
			СписокКодовОпераций.Добавить("53", НСтр("ru = '53 - Реализация работ (услуг) по ВСМ (Постановление № 1992)';
													|en = '53 - Sale of high-speed rail transport works (services) (Decree No. 1992)'"));
			СписокКодовОпераций.Добавить("56", НСтр("ru = '56 - Авансы полученные за медные полуфабрикаты п.8 ст. 161 НК';
													|en = '56 - Advance payments received for copper semi-finished products cl.8, art. 161 of the Tax Code'"));
			СписокКодовОпераций.Добавить("57", НСтр("ru = '57 - Реализация медных полуфабрикатов п.8 ст. 161 НК';
													|en = '57 - Sale of copper semi-finished products cl. 8 of art. 161 of the Tax Code'"));
