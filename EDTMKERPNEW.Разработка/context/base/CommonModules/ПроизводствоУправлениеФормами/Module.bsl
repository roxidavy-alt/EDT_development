...
Процедура УстановитьУсловноеОформлениеОбеспеченияМатериаламиИРаботами(Форма, ИмяОбъекта, ИмяТЧ, ИменаЭлементов, ПутиКДанным = Неопределено) Экспорт
	...
	#Область Номенклатура_Характеристика_Серия
	...
	Если ЗначениеЗаполнено(ИменаЭлементов.ТЧРемонтируемоеИзделиеНоменклатура) Тогда
		
		Элемент = УсловноеОформление.Элементы.Добавить();
		
		ПолеЭлемента = Элемент.Поля.Элементы.Добавить();
		ПолеЭлемента.Поле = Новый ПолеКомпоновкиДанных(ИменаЭлементов.ТЧРемонтируемоеИзделиеНоменклатура);
		
		Отбор = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		Отбор.ЛевоеЗначение = ПолеКомпоновкиДанныхПоПути(ИмяОбъекта, ПутиКДанным, "ПланированиеРабот");
		Отбор.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
		Отбор.ПравоеЗначение = Истина;
		
		Отбор = Элемент.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		Отбор.ЛевоеЗначение = Новый ПолеКомпоновкиДанных(ИмяОбъекта + "." + ИмяТЧ + ".РемонтируемоеИзделиеНоменклатура");
		Отбор.ВидСравнения = ВидСравненияКомпоновкиДанных.НеЗаполнено;
		
		Элемент.Оформление.УстановитьЗначениеПараметра("ЦветТекста", ЦветаСтиля.ТекстЗапрещеннойЯчейкиЦвет);
		Элемент.Оформление.УстановитьЗначениеПараметра("ОтметкаНезаполненного", Ложь);
		Элемент.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = '<указывается справочно>';
		...
		НоменклатураСервер.УстановитьУсловноеОформлениеХарактеристикНоменклатуры(
			Форма,
			ИменаЭлементов.ТЧРемонтируемоеИзделиеХарактеристика,
			ИмяОбъекта + "." + ИмяТЧ + ".РемонтируемоеИзделиеХарактеристикиИспользуются");

		НоменклатураСервер.УстановитьУсловноеОформлениеСерийНоменклатуры(
			Форма,
			"СерииВсегдаВТЧТовары",
			ИменаЭлементов.ТЧРемонтируемоеИзделиеСерия,
			ИмяОбъекта + "." + ИмяТЧ + ".РемонтируемоеИзделиеСтатусУказанияСерий", 
			ИмяОбъекта + "." + ИмяТЧ + ".РемонтируемоеИзделиеТипНоменклатуры");
...
// * ТЧНазначение - Строка - имя колонки в табличной части
// * ТЧПроизводится - Строка - имя колонки в табличной части
// * ТЧРемонтируемоеИзделиеНоменклатура - Строка - имя колонки в табличной части
// * ТЧРемонтируемоеИзделиеХарактеристика - Строка - имя колонки в табличной части
Функция ИменаЭлементовОбеспеченияМатериаламиИРаботами() Экспорт
	...
	ВозвращаемоеЗначение.Вставить("ТЧРемонтируемоеИзделиеНоменклатура");
	ВозвращаемоеЗначение.Вставить("ТЧРемонтируемоеИзделиеХарактеристика");
	ВозвращаемоеЗначение.Вставить("ТЧРемонтируемоеИзделиеСерия");
