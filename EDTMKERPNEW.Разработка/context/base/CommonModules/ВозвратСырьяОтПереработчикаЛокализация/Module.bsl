...
Функция ТекстОтраженияСторноПередачиКомиссионныхТоваровРасходы()
	...
	|	""ВозвратСырьяОтПереработчикаЛокализация_259"" КАК НомерФрагмента
	|ИЗ
...
Функция ТекстОтраженияВозвратСобственныхТоваров()
	...
	|	""ВозвратСырьяОтПереработчикаЛокализация_260"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""ВозвратСырьяОтПереработчикаЛокализация_261"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстОтраженияВозвратПереданнойТары()
	...
	|	""ВозвратСырьяОтПереработчикаЛокализация_262"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Себестоимость реализованного товара"" КАК Содержание,
	|	""ВозвратСырьяОтПереработчикаЛокализация_263"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстОтраженияСторноПередачиКомиссионныхТоваровСписание()
	...
	|	""ВозвратСырьяОтПереработчикаЛокализация_264"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
