...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	#Область ТаможенныйСбор
		...
		|	Операция.ОбъектРасчетов.УникальныйИдентификатор КАК ИдентификаторСтроки,
		|
		...
		|	""ТаможеннаяДекларацияИмпортЛокализация_1312"" КАК НомерФрагмента
		|
		|ИЗ
	...
	#Область ТаможенныйШтраф
		...
		|	""ТаможеннаяДекларацияИмпортЛокализация_1313"" КАК НомерФрагмента
		|
		|ИЗ
		|	ДокументыКОтражению КАК ДокументыКОтражению
		|	
	...
	#Область Пошлина
		...
		|	""ТаможеннаяДекларацияИмпортЛокализация_1314"" КАК НомерФрагмента
		|
		|ИЗ
		|	ДокументыКОтражению КАК ДокументыКОтражению
		|	
	...
	#Область ПошлинаСкладПроизводства
		...
		|	0 КАК СуммаВРКт,
		|	""Таможенная пошлина"" КАК Содержание,
		|	""ТаможеннаяДекларацияИмпортЛокализация_1315"" КАК НомерФрагмента
		|
		|ИЗ
		|	ДокументыКОтражению КАК ДокументыКОтражению
		|	
	...
	#Область ПошлинаТоварыПути
		...
		|	""ТаможеннаяДекларацияИмпортЛокализация_1316"" КАК НомерФрагмента
		|
		|ИЗ
		|	ДокументыКОтражению КАК ДокументыКОтражению
		|	
	...
	#Область НДСВСтоимость
		...
		|	""ТаможеннаяДекларацияИмпортЛокализация_1317"" КАК НомерФрагмента
		|
		|ИЗ
		|	ДокументыКОтражению КАК ДокументыКОтражению
		|	
	...
	#Область НДСВСтоимостьСкладПроизводства
		...
		|	0 КАК СуммаВРКт,
		|	""Включение НДС в стоимость"" КАК Содержание,
		|	""ТаможеннаяДекларацияИмпортЛокализация_1318"" КАК НомерФрагмента
		|
		|ИЗ
		|	ДокументыКОтражению КАК ДокументыКОтражению
		|	
	...
	#Область НДСВСтоимостьТоварыВПути
		...
		|	""ТаможеннаяДекларацияИмпортЛокализация_1319"" КАК НомерФрагмента
		|
		|ИЗ
		|	ДокументыКОтражению КАК ДокументыКОтражению
		|	
	...
	#Область НДСКВычету
		...
		|	""ТаможеннаяДекларацияИмпортЛокализация_1320"" КАК НомерФрагмента
		|
		|ИЗ
		|	ДокументыКОтражению КАК ДокументыКОтражению
		|	
	...
	|	""ТаможеннаяДекларацияИмпортЛокализация_1321"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Включение/исключение НДС в стоимость товара"" КАК Содержание,
	|	""ТаможеннаяДекларацияИмпортЛокализация_1322"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|////////////////////////////////////////////////////////////////////////////////////////////////////
	|// Начисление акцизов (Дт 19.06 :: Кт 76)
	|ВЫБРАТЬ
	...
	|
	|	Строки.СуммаАкцизаРегл КАК Сумма,
	|	Строки.СуммаАкцизаУпр КАК СуммаУУ,
	|
	|	// Дт ///////////////////////////////////////////////////////////////////////////////////////////
	|
	...
	|	НЕОПРЕДЕЛЕНО КАК СубконтоКт3,
	|
	|	Строки.СуммаАкцизаУпр КАК ВалютнаяСуммаКт,
	|	0 КАК КоличествоКт,
	|
	|	0 КАК СуммаНУДКт,
	|	0 КАК СуммаПРКт,
	...
	|	""ТаможеннаяДекларацияИмпортЛокализация_1941"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	|		РегистрНакопления.ДвиженияПоАкцизам КАК Строки
	|	ПО
	...
	|
	|ГДЕ
	|	Строки.Номенклатура <> ЗНАЧЕНИЕ(Справочник.Номенклатура.ПустаяСсылка)
	|";
	#КонецОбласти
		...
		ТекстыОтражения.Добавить(ТекстВключениеАкцизовВСтоимость());
		ТекстыОтражения.Добавить(ТекстВключениеАкцизовВСтоимостьОтклоненияВСтоимости());
...
// Функция возвращает текст фрагмента включения в стоимость акцизов.
//
// Возвращаемое значение:
//	Строка - сформированный текст запроса.
//
Функция ТекстВключениеАкцизовВСтоимость() Экспорт
	
	ТекстВключениеАкцизовВСтоимость = "
	|////////////////////////////////////////////////////////////////////////////////////////////////////
	|// Включение в стоимость акцизов (Дт 41, 10 :: Кт 19.06)
	|ВЫБРАТЬ
	...
	|	СтрокиДт.Склад КАК СубконтоДт2,
	|	СтрокиДт.ТипЗатрат КАК СубконтоДт3,
	|
	|	0 КАК ВалютнаяСуммаДт,
	|	0 КАК КоличествоДт,
	|
	|	СтрокиДт.СуммаНУ КАК СуммаНУДДт,
	...
	|
	|	ЗНАЧЕНИЕ(ПланСчетов.Хозрасчетный.АкцизыПоОплаченнымМатериальнымЦенностям) КАК СчетКт,
	...
	|	0 КАК СуммаВРКт,
	|
	|	""Включение акцизов в стоимость"" КАК Содержание,
	|	""ТаможеннаяДекларацияИмпортЛокализация_1942"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|		УчетнаяПолитикаОрганизаций КАК УчетнаяПолитикаОрганизаций
	|	ПО
	|		СтрокиКт.Регистратор = УчетнаяПолитикаОрганизаций.Ссылка
	|		И СтрокиКт.Организация = УчетнаяПолитикаОрганизаций.Организация
	|		И НАЧАЛОПЕРИОДА(СтрокиКт.Период, ДЕНЬ) = УчетнаяПолитикаОрганизаций.ДатаОтражения
	|	
	|ГДЕ
	|	НЕ ЕСТЬNULL(УчетнаяПолитикаОрганизаций.ИспользуетсяСреднескользящаяОценка, ЛОЖЬ)
	|";
	
	Возврат ТекстВключениеАкцизовВСтоимость;
	
КонецФункции

// Функция возвращает текст фрагмента включения в стоимость акцизов при использовании среднескользящей оценке стоимости.
//
// Возвращаемое значение:
//	Строка - сформированный текст запроса.
//
Функция ТекстВключениеАкцизовВСтоимостьОтклоненияВСтоимости() Экспорт

	ТекстВключениеАкцизовВСтоимость = "
	|////////////////////////////////////////////////////////////////////////////////////////////////////
	|// Включение в стоимость акцизов (Дт 41.ОТ :: Кт 19.06)
	|ВЫБРАТЬ
	|	СтрокиКт.Регистратор КАК Ссылка,
	|	СтрокиКт.Период КАК Период,
	|	СтрокиКт.Организация КАК Организация,
	...
	|
	|	""Включение акцизов в стоимость"" КАК Содержание,
	|	""ТаможеннаяДекларацияИмпортЛокализация_1943"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|		И СтрокиДт.ВидДвижения = ЗНАЧЕНИЕ(ВидДвиженияНакопления.Приход)
	|		И СтрокиДт.НастройкаХозяйственнойОперации = ЗНАЧЕНИЕ(Справочник.НастройкиХозяйственныхОпераций.НачислениеАкцизов)
	...
	|	
	|ГДЕ
	|	ЕСТЬNULL(УчетнаяПолитикаОрганизаций.ИспользуетсяСреднескользящаяОценка, ЛОЖЬ)
	|";
