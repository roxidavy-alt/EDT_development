...
Функция ПараметрыДляПроведенияДокумента(Документ, Свойства) Экспорт
	...
	Если Свойства.РежимЗаписи = РежимЗаписиДокумента.Проведение Тогда
		...
		Параметры.ПодчиненныеРегистры.Добавить(Метаданные.РегистрыСведений.РасчетТранспортногоНалогаДо2020);
...
Процедура ОтразитьДвижения(ТаблицыДляДвижений, Движения, Отказ) Экспорт
	...
	ПроведениеДокументов.ОтразитьДвижения(ТаблицыДляДвижений, Движения, "РасчетТранспортногоНалогаДо2020");
...
Процедура ПроверитьНастройкиЛьготыПоТранспортномуНалогу(Объект, ДанныеЛьготы, ДатаПараметров, Отказ, ИмяТЧ = Неопределено) Экспорт
	...
	ВидЛьготы = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(ДанныеЛьготы.ОснованиеЛьготы, "ВидЛьготы");
	
	Если ВидЛьготы = Перечисления.ВидыНалоговыхЛьготПоТранспортномуНалогуДо2020.УменьшениеСуммыНалогаНаСумму
	...
	Если НЕ ЗначениеЗаполнено(ДанныеЛьготы.ЛьготнаяСтавка)
		И ВидЛьготы = Перечисления.ВидыНалоговыхЛьготПоТранспортномуНалогуДо2020.СнижениеНалоговойСтавки Тогда
	...
	Если НЕ ЗначениеЗаполнено(ДанныеЛьготы.СуммаУменьшения)
		И ВидЛьготы = Перечисления.ВидыНалоговыхЛьготПоТранспортномуНалогуДо2020.УменьшениеСуммыНалогаНаСумму Тогда
