...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Accrual and deduction kinds'", КодыЯзыков); // @НСтр-2
	...
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Справочник_КартыИсследованияТоваров";
	Набор.Ссылка = Новый УникальныйИдентификатор("76740654-da70-11f0-8de9-0242ac120002");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Карты исследования товаров';
		|en = 'Goods research sheets'", КодыЯзыков); // @НСтр-2
		
	Набор = Элементы.Добавить();
	Набор.ИмяПредопределенногоНабора = "Документ_ИсследованиеКачестваТоваров";
	Набор.Ссылка = Новый УникальныйИдентификатор("1a762b0c-da70-11f0-8de9-0242ac120002");
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Исследование качества товаров';
		|en = 'Goods quality research'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Операции с электронными билетами';
		|en = 'Electronic ticket transactions'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Бронирования Smartway';
		|en = 'Smartway bookings'", КодыЯзыков); // @НСтр-2
	//-- Локализация
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Акт контроля качества товаров';
		|en = 'Goods quality control certificate'", КодыЯзыков); // @НСтр-2
	...
	Набор.Используется = Истина;
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Заявка на контроль качества товаров';
		|en = 'Request for goods quality control'", КодыЯзыков); // @НСтр-2
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		...
		|en = 'Item variants'", КодыЯзыков); // @НСтр-2
	...
	Наименование = "ru = 'Заявки на обеспечение';
					|en = 'Provision requests'"; // @НСтр
	...
	Наименование = "ru = 'Заявки на закупку';
					|en = 'Purchase requests'"; // @НСтр
	...
	Наименование = "ru = 'Корректировки графика взаиморасчетов';
					|en = 'AR/AP accounting schedule adjustments'"; // @НСтр
	...
	Наименование = "ru = 'Корректировки расчетов с подотчетными лицами';
					|en = 'Adjustments of AR/AP accounting with advance holders'"; // @НСтр
	...
	Наименование = "ru = 'Оприходования излишков отгруженных товаров';
					|en = 'Stock surpluses of shipped goods'"; // @НСтр
	...
	Наименование = "ru = 'Отгрузка товаров клиентам';
					|en = 'Goods shipment to customers'"; // @НСтр
	...
	Наименование = "ru = 'Списания отгруженных товаров';
					|en = 'Shipped goods write-offs'"; // @НСтр
	...
	Наименование = "ru = 'Поступления товаров от клиентов';
					|en = 'Goods receipts from customers'"; // @НСтр
	...
	Наименование = "ru = '(не используется) Дополнительные отчеты и обработки';
					|en = '(not used) Additional reports and data processors'"; // @НСтр
	...
	Наименование = "ru = 'Подтверждения ставки НДС 0%';
					|en = 'Confirmations of 0% VAT rate'"; // @НСтр
	...
	Наименование = "ru = 'Корректировки прошлых периодов НУ';
					|en = 'Adjustments for last TA periods'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "2d16896f-27f2-4b48-90d8-32256e32b795", 
	"Справочник_КорректировкиПрошлыхПериодовНУ", Наименование, КодыЯзыков);
	...
	Наименование = "ru = 'Документация по контролируемым сделкам';
					|en = 'Documentation on controlled transactions'"; // @НСтр
	...
	Наименование = "ru = 'Корректировка стоимости и амортизации НМА';
					|en = 'Adjust intangible asset cost and amortization'"; // @НСтр
	...
	Наименование = "ru = 'Модернизация ОС';
					|en = 'Fixed assets appreciation'"; // @НСтр
	...
	Наименование = "ru = 'Отнесение отклонений в стоимость ОС';
					|en = 'Allocate variances to fixed asset cost'"; // @НСтр
	ДобавитьЭлементНабораСвойств(Элементы, "742d8aef-7795-456c-960b-ac0daf7ce61e", 
	"Документ_ОтнесениеОтклоненийВСтоимостьОС", Наименование, КодыЯзыков);
	...
	Наименование = "ru = 'Распределение материалов и работ';
					|en = 'Material and labor allocation'"; // @НСтр
	...
	Наименование = "ru = 'Технологические операции';
					|en = 'Technological operations'"; // @НСтр
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Набор, "Наименование",
		"ru = 'Виды оповещений пользователей';
		|en = 'User notification kinds'", КодыЯзыков); // @НСтр-2
