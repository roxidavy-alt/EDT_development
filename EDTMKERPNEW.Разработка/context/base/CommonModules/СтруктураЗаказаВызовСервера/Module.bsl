...
// Если не запущено фоновое задание расчета структуры, то запускает его.
Процедура ПроверитьЗапуститьФоновоеЗаданиеРасчетаСтруктурыЗаказа() Экспорт
	
	СтруктураЗаказаСлужебный.ПроверитьЗапуститьФоновоеЗаданиеРасчетаСтруктурыЗаказа();
	
КонецПроцедуры

// Запускает расчет структуры заказа
// 
