...
#Область Описание_профилей_Учет_производства
	...
	ДобавитьСогласованияРазрешенийНаЗаменуМатериалов(ОписанияПрофилей);
#КонецОбласти
...
Процедура ДобавитьПрофильГлавногоДиспетчера(ОписанияПрофилей)
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеСтадийПроизводства");
...
Процедура ДобавитьПрофильМенеджераПоПереработкеДавальческогоСырья(ОписанияПрофилей)
	...
	ОписаниеПрофиля.ЗначенияДоступа.Добавить("ХозяйственныеОперации", "Перечисление.ХозяйственныеОперации.ПроизводствоПродукцииИзДавальческогоСырья2_5");
	ОписаниеПрофиля.ЗначенияДоступа.Добавить("ХозяйственныеОперации", "Перечисление.ХозяйственныеОперации.РемонтПродукцииИзДавальческогоСырья2_5");
	ОписаниеПрофиля.ЗначенияДоступа.Добавить("ХозяйственныеОперации", "Перечисление.ХозяйственныеОперации.ВыполнениеРаботСИспользованиемДавальческогоСырья2_5");
	ОписаниеПрофиля.ЗначенияДоступа.Добавить("ХозяйственныеОперации", "Перечисление.ХозяйственныеОперации.ВыполнениеРемонтныхРаботСИспользованиемДавальческогоСырья2_5");
...
Процедура ДобавитьСогласованияРазрешенийНаЗаменуМатериалов(ОписанияПрофилей)
	
	// Профиль "Согласование разрешений на замену материалов".
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "УчастникСогласованияРазрешенийНаЗаменуМатериалов";
	ОписаниеПрофиля.Идентификатор = "a1c153b5-46e5-45e2-90b7-70bdaff48980";
	ОписаниеПрофиля.Родитель      = "Производство";
	ОписаниеПрофиля.Наименование  = НСтр("ru = 'Участник согласования разрешений на замену материалов';
										|en = 'Participant of approval of engineering change orders'", ОбщегоНазначения.КодОсновногоЯзыка());
	
	ДополнитьПрофильОбязательнымиРолями(ОписаниеПрофиля);
		
	ОписаниеПрофиля.Роли.Добавить("ЧтениеРазрешенийНаЗаменуМатериалов");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеСогласованияРазрешенийНаЗаменуМатериалов");
	
	// Описание поставляемого профиля.
	ОписаниеПрофиля.Описание = НСтр("ru = 'Под профилем происходит согласование разрешений на замену материалов.';
									|en = 'Use this profile to approve engineering change orders.'");
