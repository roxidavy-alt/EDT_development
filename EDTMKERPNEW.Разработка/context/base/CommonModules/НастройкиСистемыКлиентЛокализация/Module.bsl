...
Процедура ДополнитьФормыДляПоиска(МассивФорм) Экспорт
	...
	Если ПользователиКлиент.ЭтоПолноправныйПользователь()
		...
		//++ НЕ УТ
		МассивФорм.Добавить("Обработка.ПанельАдминистрированияКА.Форма.РегламентированныйУчет");
		МассивФорм.Добавить("Обработка.ПанельАдминистрированияСППР.Форма.СистемаПроектированияПрикладныхРешений");
		//-- НЕ УТ
...
Процедура ПриИзмененииРеквизита_Производство(Элемент, Форма) Экспорт
	...
	//++ НЕ УТКА
	Если Элемент.Имя = "ИспользоватьДополнительныйРазрезТарифнойСетки" Тогда
		Форма.НаборКонстант.ДополнительныйРазрезТарифнойСетки = ?(Форма.ИспользоватьДополнительныйРазрезТарифнойСетки,
			ПредопределенноеЗначение("Перечисление.ДополнительныеРазрезыТарифнойСетки.Подразделение"),
			ПредопределенноеЗначение("Перечисление.ДополнительныеРазрезыТарифнойСетки.БезДетализации"));
	КонецЕсли;
	//-- НЕ УТКА
