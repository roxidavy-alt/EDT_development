...
//             - ОпределяемыйТип.КонтрагентОбъект - ссылка на элемент метаданных контрагента,
...
// Открыть форму с расширенной информацией о контрагенте по данным сервиса 1СПАРК Риски.
//
// Параметры:
//  Параметры - Структура - параметры открытия формы:
//  * ИНН - Строка - ИНН контрагента;
//  * Контрагент - ОпределяемыйТип.КонтрагентОбъект, Неопределено - ссылка на элемент метаданных контрагента;
//
Процедура ПоказатьРасширенныеДанныеСПАРК(Параметры) Экспорт
	
	Если Параметры.Контрагент = Неопределено Тогда
		УникальностьФормы = Новый УникальныйИдентификатор;
	Иначе
		УникальностьФормы = Параметры.Контрагент;
	КонецЕсли;
	
	ОткрытьФорму(
		"Обработка.ПроверкаКонтрагента.Форма.РасширеннаяИнформацияСПАРКРиски",
		Параметры,,
		УникальностьФормы,,,,
