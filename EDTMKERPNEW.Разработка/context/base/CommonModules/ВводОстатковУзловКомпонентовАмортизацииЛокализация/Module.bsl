	...
	Если ОбновитьВсе Тогда
		...
		Если ВспомогательныеРеквизиты.ВариантУчетаОтложенногоНалога = ПредопределенноеЗначение("Перечисление.ВариантыУчетаОтложенногоНалога.БалансовыйМетод")
			...
			Если Форма.ТекущаяСтоимостьПР <> 0
				...
				ИЛИ Форма.НакопленнаяАмортизацияПР <> 0 Тогда
...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	""ВводОстатковУзловКомпонентовАмортизацииЛокализация_175"" КАК НомерФрагмента
	|ИЗ
	...
	|	""ВводОстатковУзловКомпонентовАмортизацииЛокализация_176"" КАК НомерФрагмента
	|
	|ИЗ
	...
	|	""ВводОстатковУзловКомпонентовАмортизацииЛокализация_177"" КАК НомерФрагмента
	|
	|ИЗ
