...
Функция ВходящиеДанныеДляФормированияЗаданийОСВНМА() Экспорт
	...
	ВходящиеДанные.Добавить(Метаданные.Документы.ОтнесениеОтклоненийВСтоимостьОС);
...
Функция ЗапросУзлыОбменаСБухгалтерией() Экспорт
	...
	МассивВариантов.Добавить(ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ИдентификаторНастройкиОбменаБП30());
	МассивВариантов.Добавить(ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ИдентификаторНастройкиОбменаБПКОРП30());
	МассивВариантов.Добавить(ПланыОбмена.СинхронизацияДанныхЧерезУниверсальныйФормат.ИдентификаторНастройкиОбменаУниверсальный());
