...
Процедура ПреобразоватьВременнуюТаблицуТоваровДляСчетаФактуры(МенеджерВременныхТаблиц) Экспорт
	...
	|	0,
	|	0,
	|	ТаблицаДокумента.ОблагаетсяАкцизом,
	//-- НЕ УТ
	|	0,
	|	0,
	|	0,
...
#Область ТекстВозвратОтКомиссионера                        // (Дт 41.01 :: Кт 45.01)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_265"" КАК НомерФрагмента
	|ИЗ
...
#Область ТекстВозвратНаСкладПроизводстваОтКомиссионера                        // (Дт 20 :: Кт 45.01)
	...
	|	ЕСТЬNULL(Стоимости.СуммаВР, 0) КАК СуммаВРКт,
	|	""Возврат товаров от комиссионера"" КАК Содержание,
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_266"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстВозвратПоСубкомиссии                         // (Дт 004.01 :: Кт 004.02)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_267"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
#Область ТекстСторноНачисленияНДСПолучателяПрошлыхЛет                // (сторно Дт 90.03 :: Кт 19.03)
	ТекстСторноНачисленияНДСПолучателяПрошлыхЛет = "
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_269"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
#Область ТекстУменьшениеНДСПрошлыхЛет // (Дт 90.03 :: Кт 19.09)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_271"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПереносНДС // (Дт 68.02 :: Кт 19.09)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_272"" КАК НомерФрагмента
	|	
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
...
#Область ТекстВозвратРеализацииПрошлыхЛет // (Дт 91.02 :: Кт 62.01)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_278"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
#Область ТекстВозвратСебестоимостиТоваровПрошлыхЛет // (Дт 41.01 :: Кт 91.01)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_279"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
#Область ТекстВозвратСебестоимостиТоваровПрошлыхЛетСкладПроизводства // (Дт 20 :: Кт 91.01)
	...
	|	ЕСТЬNULL(Стоимости.СуммаВР, Строки.СуммаВР) КАК СуммаВРКт,
	|	""Себестоимость возвращенного товара прошлых лет"" КАК Содержание,
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_280"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
#Область ТекстСторноВыручкиОтРеализацииКомиссионногоТовара  // (сторно Дт 62.01 :: Кт 76.ОК)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_281"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
#Область ТекстВосстановлениеАвансаПереносДолгаОтКлиента // (Дт <62.2> :: Кт <62.1, 76>)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_1702"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстВозвратПроданногоКомиссионногоТовара         // (Дт :: Кт 004.01 сторно)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_282"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
#Область ТекстОтправительСебестоимость                     // (Дт 76.02 :: Кт 41.01)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_283"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
#Область ТекстОтправительСебестоимостьСкладПроизводства                     // (Дт 76.02 :: Кт 20)
	...
	|	0 КАК СуммаВРКт,
	|	""Возврат себестоимости"" КАК Содержание,
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_284"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
#Область ТекстОтправительНДС                               // (Дт 76.02 :: Кт 68.02/19.03)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_285"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
#Область ТекстПереносПретензииНаРасчеты                    // (Дт 60.02 :: Кт 76.02)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_286"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_287"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстВключениеИсключениеНДСВСтоимость             // (Дт 91 :: Кт 19.03)
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_288"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#КонецОбласти
	...
	ТекстыОтражения.Добавить(ТекстСторноНДС()); // Входящий НДС (сторно) (Дт 90.03 :: Кт 19.03)
	ТекстыОтражения.Добавить(ТекстСторноНачисленияНДСПолучателяПрошлыхЛет);
	ТекстыОтражения.Добавить(ТекстУменьшениеНДС()); // Уменьшение НДС с реализации собственных товаров (Дт 90.03 :: Кт 19.09)
	ТекстыОтражения.Добавить(ТекстУменьшениеНДСПрошлыхЛет);
	ТекстыОтражения.Добавить(ТекстПереносНДС);
	ТекстыОтражения.Добавить(ТекстВыручкаОтРеализации()); // Выручка от реализации собственного товара (сторно) (Дт 62.01 :: Кт 90.01)
	...
	ТекстыОтражения.Добавить(РеализацияТоваровУслугЛокализация.ТекстНачислениеАкцизов()); // Корректировка начисления акцизов (Дт 90.04 :: Кт 68.03)
...
Функция ТекстОтправительВозвратСебестоимостиПретензииНовыеВзаиморасчеты()
	...
	|	""Возврат себестоимости"" КАК Содержание,
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_289"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстОтправительВозвратНДСНовыеВзаиморасчеты()
	...
	|	0 КАК СуммаВРКт,
	|	""Возврат НДС"" КАК Содержание,
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_290"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстОтправительОтклонениеВСтоимостиРасходы()
	...
	|	Расходы.ИдентификаторФинЗаписи КАК ИдентификаторСтроки,
	|
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_291"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстОтправительОтклонениеВСтоимостиДоходы()
	...
	|	Стоимости.Период КАК Период,
	|	Стоимости.Организация КАК Организация,
	|	ПрочиеДоходы.ИдентификаторФинЗаписи КАК ИдентификаторСтроки,
	|
	...
	|	0 КАК ВалютнаяСуммаКт,
	|	0 КАК КоличествоКт,
	|	ПрочиеДоходы.СуммаРегл - ПрочиеДоходы.ПостояннаяРазница - ПрочиеДоходы.ВременнаяРазница КАК СуммаНУКт,
	|	ПрочиеДоходы.ПостояннаяРазница КАК СуммаПРКт,
	|	ПрочиеДоходы.ВременнаяРазница КАК СуммаВРКт,
	|	""Отклонение в стоимости возвращенных товаров (доходы)"" КАК Содержание,
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_292"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстОтправительВозвратНеСобственногоТовара()
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_1703"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстВыручкаОтРеализации()
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_2024"" КАК НомерФрагмента
	|ИЗ
	|
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстСторноНДС()
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_2025"" КАК НомерФрагмента
	|
	|ИЗ
	|
	|	ДокументыКОтражению КАК ДокументыКОтражению
...
Функция ТекстУменьшениеНДС()
	...
	|	""ВозвратТоваровМеждуОрганизациямиЛокализация_2026"" КАК НомерФрагмента
	|ИЗ
	|
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстСторноСебестоимостиРеализованногоТовараПрошлыхМесяцев()
	...
	|	""ВозвратТоваровОтКлиентаЛокализация_2034"" КАК НомерФрагмента
	|ИЗ
	|
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	СтрокиДт.СебестоимостьВР КАК СуммаВРКт,
	|	""Себестоимость реализованного товара прошлых месяцев (сторно)"" КАК Содержание,
	|	""ВозвратТоваровОтКлиентаЛокализация_2035"" КАК НомерФрагмента
	|ИЗ
	|
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
