...
//
Процедура ПоказатьФормуПредложениеОформитьЗаявлениеНаПодключениеПриЗаполнении(ПараметрыПоказа, Отказ, НоваяФорма = ЛОжь) Экспорт
...
Процедура ПоказатьФормуПредложениеОформитьЗаявлениеНаПодключениеПриЗаполненииЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	Попытка
		...
		Форма.ЗаполнитьАвто(Форма.Команды.Заполнить);
	Исключение
	КонецПопытки;
