...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	ТекстыОтражения.Добавить(СписаниеНедостачТоваровЛокализация.СписаниеАкцизовНаРасходы()); // Списание акцизов на расходы (Дт 91.02 :: Кт 68.03)
...
Функция ТекстСписаниеТоваровНаРасходы()
	...
	|	""ВнутреннееПотреблениеЛокализация_249"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстСписаниеТоваровНаПрочиеАктивы()
	...
	|	""ВнутреннееПотреблениеЛокализация_250"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстВключениеИсключениеНДСВСтоимостьПрочихАктивов()
	...
	|	""ВнутреннееПотреблениеЛокализация_251"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстВключениеИсключениеНДСВРасходы()
	...
	|	""ВнутреннееПотреблениеЛокализация_252"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстСписаниеТоваровКонтрагентов()
	...
	|	""ВнутреннееПотреблениеЛокализация_1693"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
