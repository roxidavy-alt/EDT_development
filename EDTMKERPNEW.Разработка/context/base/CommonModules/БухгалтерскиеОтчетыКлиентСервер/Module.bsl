...
Процедура НастроитьПоказателиНалогНаПрибыль(Отчет, ЭлементыПоказателей) Экспорт
	...
	Для Каждого ОписаниеЭлемента Из ЭлементыПоказателей Цикл
		...
		Если ОписаниеЭлемента.Ключ = "ПоказательНУ" Или ОписаниеЭлемента.Ключ = "ПоказательСверкаНУ" 
			Или ОписаниеЭлемента.Ключ = "ПоказательНУКорректировка" Или ОписаниеЭлемента.Ключ = "ПоказательНУсКорректировкой" Тогда
...
Процедура УправлениеВидимостьюВидПериода(Элемент, Отчет) Экспорт
	...
	БухгалтерскиеОтчетыКлиентСерверПереопределяемый.УправлениеВидимостьюВидПериода(Элемент, Отчет);
...
Функция НовыйУниверсальныеНастройки() Экспорт
	...
	Настройки.Вставить("ПоказательНУКорректировка",			Ложь);
	Настройки.Вставить("ПоказательНУсКорректировкой",		Ложь);
...
Функция ИнициализироватьПараметрыПроверкиАктуальности(Форма) Экспорт
	...
	//++ НЕ УТ
	ЭтапыЗакрытияМесяца.Добавить(ПредопределенноеЗначение("Справочник.ОперацииЗакрытияМесяца.ОтражениеДокументовВРегламентированномУчете"));
	ЭтапыЗакрытияМесяца.Добавить(ПредопределенноеЗначение("Справочник.ОперацииЗакрытияМесяца.ФормированиеРезервовПоСомнительнымДолгам"));
	ЭтапыЗакрытияМесяца.Добавить(ПредопределенноеЗначение("Справочник.ОперацииЗакрытияМесяца.РасчетКурсовыхРазниц"));
	ЭтапыЗакрытияМесяца.Добавить(ПредопределенноеЗначение("Справочник.ОперацииЗакрытияМесяца.ФормированиеФинансовогоРезультата"));
	//-- НЕ УТ
