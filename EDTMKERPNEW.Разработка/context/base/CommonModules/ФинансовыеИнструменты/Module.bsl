...
Процедура ДобавитьЭтап_НачисленияПоКредитамДепозитамИВыданнымЗаймам(ТаблицаЭтапов,ТекущийРодитель) Экспорт
	...
	НоваяСтрока.МультиязычноеНаименование = "ru = 'Начисления по кредитам депозитам и выданным займам (вручную)';
											|en = 'Credit, deposit and loan interest charge (manual)'"; // @НСтр-1
