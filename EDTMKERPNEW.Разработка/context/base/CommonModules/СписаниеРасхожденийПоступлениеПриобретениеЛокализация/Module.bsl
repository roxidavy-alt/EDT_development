...
#Область СписаниеНедопоставкиНаПрочиеРасходы  // (Дт 91 :: Кт 60.НП, 15)
	...
	|	""СписаниеРасхожденийПоступлениеПриобретениеЛокализация_1297"" КАК НомерФрагмента
	|
	|ИЗ
...
#Область СписаниеНедопоставкиПрочиеАктивы  // (Дт X :: Кт 60.НП, 15)
	...
	|	""СписаниеРасхожденийПоступлениеПриобретениеЛокализация_1298"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область СписаниеПерепоставкиНаПрочиеДоходы  // (Дт 60.НП, 15 :: Кт 91)
	...
	|	Операция.Дата			КАК Период,
	|	Операция.Организация	КАК Организация,
	|	ДвиженияПрочиеДоходы.ИдентификаторФинЗаписи	КАК ИдентификаторСтроки,
	|
	// Сумма
	...
	|	""СписаниеРасхожденийПоступлениеПриобретениеЛокализация_1299"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область СписаниеПерепоставкиНаПрочиеПассивы  // (Дт 60.НП, 15 :: Кт X)
	...
	|	""СписаниеРасхожденийПоступлениеПриобретениеЛокализация_1300"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область СписаниеНДСНаРасходы  // (Дт 91 :: Кт 19)
	...
	|	""СписаниеРасхожденийПоступлениеПриобретениеЛокализация_1301"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область СписаниеНДСНаПрочиеАктивы  // (Дт Х :: Кт 19)
	...
	|	""СписаниеРасхожденийПоступлениеПриобретениеЛокализация_1302"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.СписаниеРасхожденийПоступлениеПриобретение КАК Операция
