...
#КонецОбласти
	...
	#КонецОбласти
	РегламентированнаяОтчетностьУП.ЗаполнитьПоставляемыеПрофилиГруппДоступа(ОписанияПрофилей, ПараметрыОбновления);
...
//++ НЕ УТ
	...
	|Справочник.КорректировкиПрошлыхПериодовНУ.Чтение.Организации
	|Справочник.КорректировкиПрошлыхПериодовНУ.Изменение.Организации
	...
	|Справочник.ПереносРезервовМеждуСтатьямиФинансированияПрисоединенныеФайлы.Чтение.ГруппыФизическихЛиц
	|Справочник.ПереносРезервовМеждуСтатьямиФинансированияПрисоединенныеФайлы.Чтение.Организации
	|Справочник.ПереносРезервовМеждуСтатьямиФинансированияПрисоединенныеФайлы.Изменение.ГруппыФизическихЛиц
	|Справочник.ПереносРезервовМеждуСтатьямиФинансированияПрисоединенныеФайлы.Изменение.Организации
	...
	|Документ.ПереносРезервовМеждуСтатьямиФинансирования.Чтение.ГруппыФизическихЛиц
	|Документ.ПереносРезервовМеждуСтатьямиФинансирования.Чтение.Организации
	|Документ.ПереносРезервовМеждуСтатьямиФинансирования.Изменение.ГруппыФизическихЛиц
	|Документ.ПереносРезервовМеждуСтатьямиФинансирования.Изменение.Организации
	...
	|Документ.УведомлениеОСпецрежимахНалогообложения.Чтение.ВидыРегламентированныхУведомлений
	|Документ.УведомлениеОСпецрежимахНалогообложения.Чтение.Организации
	|Документ.УведомлениеОСпецрежимахНалогообложения.Изменение.ВидыРегламентированныхУведомлений
	...
	|РегистрСведений.БухучетРезервовПоОплатеТруда.Чтение.Организации
	|РегистрСведений.БухучетРезервовПоОплатеТруда.Изменение.Организации
	...
	|РегистрСведений.ДетализацияСебестоимостиПартийПродукции.Чтение.Организации
	...
	|РегистрСведений.ЗначенияПоказателейСреднегоЗаработкаСотрудников.Чтение.ГруппыФизическихЛиц
	|РегистрСведений.ЗначенияПоказателейСреднегоЗаработкаСотрудников.Чтение.Организации
	|РегистрСведений.ЗначенияПоказателейСреднегоЗаработкаСотрудников.Изменение.ГруппыФизическихЛиц
	|РегистрСведений.ЗначенияПоказателейСреднегоЗаработкаСотрудников.Изменение.Организации
	|РегистрСведений.ЗначенияПоказателейСреднегоЗаработкаСотрудниковИнтервальный.Чтение.ГруппыФизическихЛиц
	|РегистрСведений.ЗначенияПоказателейСреднегоЗаработкаСотрудниковИнтервальный.Чтение.Организации
	...
	|РегистрСведений.РасчетНалогаНаПрибыль.Чтение.Организации
	...
	|РегистрБухгалтерии.КорректировкиНалоговойБазы.Чтение.Организации
	|РегистрБухгалтерии.КорректировкиНалоговойБазы.Изменение.Организации
...
Процедура ПриЗаполненииОграниченияДоступа(Список, Ограничение) Экспорт
	...
	КонецЕсли;
	РегламентированнаяОтчетностьУП.ПриЗаполненииОграниченияДоступа(Список, Ограничение);
	//-- НЕ УТ
...
Процедура ЗаполнитьВидыДоступа(ВидыДоступа) Экспорт
	...
	РегламентированнаяОтчетностьУП.ПриЗаполненииВидовДоступа(ВидыДоступа);
...
Процедура ПриЗаполненииСписковСОграничениемДоступа(Списки) Экспорт
	...
	// Интеграция БРО
	РегламентированнаяОтчетностьУП.ПриЗаполненииСписковСОграничениемДоступа(Списки);
	...
	Списки.Вставить(Метаданные.РегистрыСведений.ДетализацияСебестоимостиПартийПродукции, Истина);
	...
	Списки.Вставить(Метаданные.РегистрыСведений.РасчетНалогаНаПрибыль, Истина);
	...
	Списки.Вставить(Метаданные.Справочники.ТранспортнаяНакладнаяПрисоединенныеФайлы, Истина);
	Списки.Вставить(Метаданные.Справочники.КорректировкиПрошлыхПериодовНУ, Истина);	

	Списки.Вставить(Метаданные.РегистрыБухгалтерии.КорректировкиНалоговойБазы, Истина);
...
Процедура ДобавитьРолиБухгалтераРеглУчетаНаИзменение(ОписаниеПрофиля) Экспорт
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеСведенийПоКонтрактамГОЗ");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеСтатейРКМ");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеДанныхОПоставкахВРазрезеДОПП");
	//-- НЕ УТ
...
Процедура ДобавитьРолиЭкономистПроизводства(ОписаниеПрофиля) Экспорт
	...
	ОписаниеПрофиля.Роли.Добавить("ЧтениеДанныхСотрудниковРасширенная");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеКадровогоСостоянияРасширенная");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеБезПросмотраЗначенийТарифов");
	ОписаниеПрофиля.Роли.Добавить("ЧтениеДвиженийПоАкцизам");
