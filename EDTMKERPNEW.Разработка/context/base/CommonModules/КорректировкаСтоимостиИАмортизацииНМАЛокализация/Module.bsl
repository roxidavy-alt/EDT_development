		...
		Если Форма.СлужебныеПараметрыФормы.ВариантУчетаОтложенногоНалога = ПредопределенноеЗначение("Перечисление.ВариантыУчетаОтложенногоНалога.БалансовыйМетод") Тогда
			...
			Для Каждого ДанныеСтроки Из Объект.НМА Цикл
				...
				Если ДанныеСтроки.СтоимостьПР <> 0
					ИЛИ ДанныеСтроки.АмортизацияПР <> 0 Тогда
					
					Элементы.НМАПоказатьПР.Пометка = Истина;
					Прервать;
				КонецЕсли;
	...
	Если СтруктураИзмененныхРеквизитов.Свойство("Дата")
		...
		Если НЕ Форма.СлужебныеПараметрыФормы.ПлательщикНалогаНаПрибыль 
			...
			Элементы.НМАСтоимостьУУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Стоимость (УУ)';
																			|en = 'Cost (MA)'"), ВалютаУпрПредставление);
			
			Элементы.НМААмортизацияУУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Амортизация (УУ)';
																			|en = 'Depreciation (MA)'"), ВалютаУпрПредставление);
			
			Элементы.НМАПервоначальнаяСтоимостьУУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Первоначальная стоимость (УУ)';
																			|en = 'Initial cost (mgmt)'"), ВалютаУпрПредставление);
			
			Элементы.НМАСтоимостьБУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Стоимость (БУ)';
																			|en = 'Cost (LA)'"), ВалютаРеглПредставление);
			
			Элементы.НМААмортизацияБУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Амортизация (БУ)';
																			|en = 'Depreciation (LA)'"), ВалютаРеглПредставление);
			
			Элементы.НМАПервоначальнаяСтоимостьБУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Первоначальная стоимость (БУ)';
																			|en = 'Initial cost (local)'"), ВалютаРеглПредставление);
			
		Иначе
			
			Элементы.НМАСтоимостьУУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Стоимость';
																			|en = 'Cost'"), ВалютаУпрПредставление);
			
			Элементы.НМААмортизацияУУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Амортизация';
																			|en = 'Depreciation'"), ВалютаУпрПредставление);
			
			Элементы.НМАПервоначальнаяСтоимостьУУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Первоначальная стоимость';
																			|en = 'Initial cost'"), ВалютаУпрПредставление);
			
			Элементы.НМАСтоимостьБУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Стоимость';
																			|en = 'Cost'"), ВалютаРеглПредставление);
			
			Элементы.НМААмортизацияБУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Амортизация';
																			|en = 'Depreciation'"), ВалютаРеглПредставление);
			
			Элементы.НМАПервоначальнаяСтоимостьБУ_Отдельно.Заголовок = 
				ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Первоначальная стоимость';
																			|en = 'Initial cost'"), ВалютаРеглПредставление);

		КонецЕсли;
			
		Элементы.НМАСтоимостьНУ.Заголовок = 
			ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'НУ';
																		|en = 'TA'"), ВалютаРеглПредставление);
		
		Элементы.НМАСтоимостьПР.Заголовок = 
			ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'ПР';
																		|en = 'PD'"), ВалютаРеглПредставление);
		
		Элементы.НМАСтоимостьЦФ.Заголовок = 
		...
		Элементы.НМААмортизацияНУ.Заголовок = 
			ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'НУ';
																		|en = 'TA'"), ВалютаРеглПредставление);
		
		Элементы.НМААмортизацияПР.Заголовок = 
			ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'ПР';
																		|en = 'PD'"), ВалютаРеглПредставление);
		
		Элементы.НМААмортизацияЦФ.Заголовок = 
		...
		Элементы.НМААмортизацияНаНачалоГодаЦФ.Заголовок = 
			ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'Амортизация на начало года (целевое финансирование)';
																		|en = 'Depreciation as of year start (target financing)'"), ВалютаРеглПредставление);
		
		Элементы.НМАПервоначальнаяСтоимостьНУ.Заголовок = 
			ВнеоборотныеАктивыКлиентСервер.ДобавитьКСтрокеВалюту(НСтр("ru = 'НУ';
																		|en = 'TA'"), ВалютаРеглПредставление);
...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_543"" КАК НомерФрагмента
	|ИЗ
	...
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_544"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	
	|	""Увеличение стоимости"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_545"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	
	|	""Увеличение стоимости ЦФ"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_546"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_547"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_548"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрочиеРасходы КАК СтрокиДт
	...
	|	
	|	""Уменьшение стоимости"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_549"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	
	|	""Уменьшение стоимости ЦФ"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_550"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_551"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	
	|	""Уменьшение стоимости (сторно)"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_552"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьНМА КАК СтрокиДт
	...
	|	
	|	""Уменьшение стоимости (сторно)"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_553"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	
	|	""Уменьшение стоимости (сторно)"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_554"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_1753"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрочиеРасходы КАК СтрокиДт
	...
	|	КОНЕЦ КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_1754"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрочиеРасходы КАК СтрокиДт
	...
	|		ИНАЧЕ ""Увеличение амортизации"" 
	|	КОНЕЦ КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_1755"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|		ИНАЧЕ ""Увеличение амортизации ЦФ"" 
	|	КОНЕЦ КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_1756"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	КОНЕЦ КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_1757"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	КОНЕЦ КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_1758"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|		ИНАЧЕ ""Уменьшение амортизации"" 
	|	КОНЕЦ КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_1759"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|		ИНАЧЕ ""Уменьшение амортизации ЦФ"" 
	|	КОНЕЦ КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_1760"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	КОНЕЦ КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_1761"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрочиеРасходы КАК СтрокиДт
	...
	|	КОНЕЦ КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_1762"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрочиеРасходы КАК СтрокиДт
	...
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_555"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	
	|	""Увеличение доходов ЦФ"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_556"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_557"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	
	|	""Уменьшение доходов ЦФ"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_558"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	
	|	""Уменьшение доходов ЦФ"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_559"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
	...
	|	
	|	""Уменьшение доходов ЦФ"" КАК Содержание,
	|	""КорректировкаСтоимостиИАмортизацииНМАЛокализация_560"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.КорректировкаСтоимостиИАмортизацииНМА КАК ДанныеДокумента
