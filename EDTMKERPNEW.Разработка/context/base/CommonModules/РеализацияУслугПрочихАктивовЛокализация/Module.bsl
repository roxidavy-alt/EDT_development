...
Функция ТекстЗадолженностьПокупателяЗаУслугиДоПереходаПрава()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1181"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	-ЕСТЬNULL(Суммы.СуммаБезНДСРегл, Строки.СуммаСНДС - Строки.СуммаНДС) КАК СуммаВРКт,
	|	""Задолженность покупателя до перехода права собственности"" КАК Содержание,
	|	""РеализацияУслугПрочихАктивовЛокализация_1182"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстЗадолженностьПокупателяЗаУслугиПослеПереходаПрава()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1183"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	ЕСТЬNULL(Суммы.СуммаБезНДСРегл, Строки.СуммаСНДС - Строки.СуммаНДС) КАК СуммаВРКт,
	|	""Задолженность покупателя после перехода права собственности"" КАК Содержание,
	|	""РеализацияУслугПрочихАктивовЛокализация_1184"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Задолженность покупателя после перехода права собственности"" КАК Содержание,
	|	""РеализацияУслугПрочихАктивовЛокализация_1185"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстНачислениеНДСЗаУслуги()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1186"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстНачислениеНДСЗаУслугиДоПереходаПрав()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1187"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстНачислениеНДСЗаУслугиПослеПереходаПрав()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1188"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстРасходыОтСписанияАктива()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1189"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1190"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстПередачаАктиваДоПереходаПраваСобственности22()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1191"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстРасходыОтСписанияАктиваДоПереходаПраваСобственности22()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1192"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстРасходыОтСписанияАктиваПослеПереходаПраваСобственности22()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1193"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстВосстановлениеАмортизационнойПремии()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1194"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстЗадолженностьПокупателяЗаУслуги()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1195"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстУменьшениеЧистойСтоимостиИнвестицииВАренду()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1196"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстРеализацияУслугПоАрендеНУ()
	...
	|	СтрокиКт.Период      КАК Период,
	|	СтрокиКт.Организация КАК Организация,
	|	СтрокиДоходов.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|	
	|	0 КАК Сумма,
	|	0 КАК СуммаУУ,
	|	
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1197"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстНачислениеНДСПоАренде()
	...
	|	""РеализацияУслугПрочихАктивовЛокализация_1198"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Процедура ЗаполнитьПоДокументуПодготовкаКПередачеОС(Объект, ДанныеЗаполнения)
	...
	|			&Дата,
	|			Статья = ЗНАЧЕНИЕ(ПланВидовХарактеристик.СтатьиАктивовПассивов.УпрБалансОсновныеСредства)
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ЗНАЧЕНИЕ(ПланВидовХарактеристик.СтатьиАктивовПассивов.УпрБалансОсновныеСредства) КАК СтатьяАктивовПассивов,
...
Процедура ЗаполнитьПоДокументуПодготовкаКПередачеНМА(Объект, ДанныеЗаполнения)
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ЗНАЧЕНИЕ(ПланВидовХарактеристик.СтатьиАктивовПассивов.УпрБалансНематериальныеАктивы) КАК СтатьяАктивовПассивов,
