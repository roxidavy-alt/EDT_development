...
//		* Ссылка - ПланСчетовСсылка.Международный -
//		* Наименование - Строка -
//		* НаименованиеМеждународное - Строка -
//		* Описание - Строка -
//		* Рекласс - Булево -
//		* ИсключитьИзРасчетаКурсовыхРазниц - Булево -
//		* Код - Строка -
//		* Родитель - ПланСчетовСсылка.Международный -
//		* Вид - ВидСчета -
//		* Забалансовый - Булево -
//		* ЗапретитьИспользоватьВПроводках - Булево
//		* Валютный - Булево -
//		* Количественный - Булево -
//		* УчетПоПодразделениям - Булево - 
//		* УчетПоНаправлениямДеятельности - Булево -
//		* КоличествоСубконто - Число -
//		* ПланСчетов - СправочникСсылка.ПланыСчетовМеждународногоУчета -
//		* ВариантФормированияПроводок - ПеречислениеСсылка.ВариантыФормированияПроводок -
//		* ВидСубконто1 - Неопределено, ПланВидовХарактеристикСсылка.ВидыСубконтоМеждународные -
//		* ВидСубконто1Наименование - Неопределено, Строка -
//		* ВидСубконто1ТипЗначения - Неопределено, ОписаниеТипов -
//		* ВидСубконто1ТолькоОбороты - Булево -
//		* ВидСубконто2 - Неопределено, ПланВидовХарактеристикСсылка.ВидыСубконтоМеждународные -
//		* ВидСубконто2Наименование - Неопределено, Строка -
//		* ВидСубконто2ТипЗначения - Неопределено, ОписаниеТипов -
//		* ВидСубконто2ТолькоОбороты - Булево -
//		* ВидСубконто3 - Неопределено, ПланВидовХарактеристикСсылка.ВидыСубконтоМеждународные -
//		* ВидСубконто3Наименование - Неопределено, Строка -
//		* ВидСубконто3ТипЗначения - Неопределено, ОписаниеТипов -
//		* ВидСубконто3ТолькоОбороты - Булево -
//
Функция СвойстваСчета(Знач Счет) Экспорт
	...
	ДанныеСчета.Вставить("Вид", ВидСчета.АктивноПассивный);
	...
	ДанныеСчета.Вставить("ВидСубконто1", Неопределено);
	ДанныеСчета.Вставить("ВидСубконто1Наименование", Неопределено);
	ДанныеСчета.Вставить("ВидСубконто1ТипЗначения", Неопределено);
	ДанныеСчета.Вставить("ВидСубконто1ТолькоОбороты", Ложь);
	
	ДанныеСчета.Вставить("ВидСубконто2", Неопределено);
	ДанныеСчета.Вставить("ВидСубконто2Наименование", Неопределено);
	ДанныеСчета.Вставить("ВидСубконто2ТипЗначения", Неопределено);
	ДанныеСчета.Вставить("ВидСубконто2ТолькоОбороты", Ложь);
	
	ДанныеСчета.Вставить("ВидСубконто3", Неопределено);
	ДанныеСчета.Вставить("ВидСубконто3Наименование", Неопределено);
	ДанныеСчета.Вставить("ВидСубконто3ТипЗначения", Неопределено);
	ДанныеСчета.Вставить("ВидСубконто3ТолькоОбороты", Ложь);
