...
Функция ТекстСписаниеТоваровПоНалоговомуУчету()
	...
	|	""ПересортицаТоваровЛокализация_1781"" КАК НомерФрагмента
	|ИЗ
...
Функция ТекстВключениеИсключениеНДСВСтоимость()
	...
	|	""ПересортицаТоваровЛокализация_870"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Включение/исключение НДС в стоимость товара"" КАК Содержание,
	|	""ПересортицаТоваровЛокализация_871"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Включение/исключение НДС в стоимость товара"" КАК Содержание,
	|	""ПересортицаТоваровЛокализация_872"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
