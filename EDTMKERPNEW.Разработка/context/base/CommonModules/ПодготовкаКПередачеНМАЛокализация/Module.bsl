...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	""ПодготовкаКПередачеНМАЛокализация_874"" КАК НомерФрагмента
	|ИЗ
	...
	|	
	|	""Перенос начисленной амортизации НМА"" КАК Содержание,
	|	""ПодготовкаКПередачеНМАЛокализация_875"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.АмортизацияНМА КАК Строки
	|		ПО ДокументыКОтражению.Ссылка = Строки.Регистратор
	...
	|	""ПодготовкаКПередачеНМАЛокализация_876"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	...
	|	""ПодготовкаКПередачеНМАЛокализация_877"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	""ПодготовкаКПередачеНМАЛокализация_878"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
