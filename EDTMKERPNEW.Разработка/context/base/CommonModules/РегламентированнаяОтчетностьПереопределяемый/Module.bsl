...
Функция ПолучитьСведенияОПоказателяхОтчета(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета = Неопределено) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетКосвенныеНалогиТамСоюз" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаОтчета2023Кв3" Тогда
			...
			РегламентированнаяОтчетностьУП.ПолучитьСведенияОПоказателяхОтчетаКосвенныеНалогиПриИмпортеФормаОтчета2023Кв3_Акцизы(ПоказателиОтчета);
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтатистикаФормаУчетаПеремещенияТоваровТС" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаАналогЛК" Тогда
			...
			РегламентированнаяОтчетностьУП.ПолучитьСведенияОПоказателяхОтчетаСтатистикаФормаУчетаПеремещенияТоваровТСФормаАналогЛК(ПоказателиОтчета);
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетАкцизыАлкоголь" Тогда
		
		Если ИДРедакцииОтчета = "ФормаОтчета2025Кв1" Тогда
			РегламентированнаяОтчетностьУП.ПолучитьСведенияОПоказателяхОтчетаАкцизыАлкогольФормаОтчета2025Кв1(ПоказателиОтчета);
		КонецЕсли;
		
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетАкцизыГСМ" Тогда
		
		Если ИДРедакцииОтчета = "ФормаОтчета2025Кв2" Тогда
			РегламентированнаяОтчетностьУП.ПолучитьСведенияОПоказателяхОтчетаАкцизыГСМФормаОтчета2025Кв2(ПоказателиОтчета);
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2023Кв1" Тогда
			РегламентированнаяОтчетностьУП.ПолучитьСведенияОПоказателяхОтчетаАкцизыГСМФормаОтчета2023Кв1(ПоказателиОтчета);
		КонецЕсли;
		
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеДокументОПредстоящейПоставке" Тогда
		
		Если ИДРедакцииОтчета = "Форма2026_1" Тогда
			РегламентированнаяОтчетностьУП.ПолучитьСведенияОПоказателяхДокументОПредстоящейПоставке(ПоказателиОтчета);
		КонецЕсли;
...
Процедура ЗаполнитьОтчет(ИДОтчета, ИДРедакцииОтчета, ПараметрыОтчета, Контейнер) Экспорт
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетКосвенныеНалогиТамСоюз" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаОтчета2023Кв3" Тогда
			...
			РегламентированнаяОтчетностьУП.ЗаполнитьОтчетКосвенныеНалогиПриИмпортеФормаОтчета2023Кв3_Акцизы(ПараметрыОтчета, Контейнер);
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетПрибыль" Тогда
		...
		Иначе
			...
			Если ИДРедакцииОтчета <> "ФормаОтчета2015Кв1" Тогда
				ПараметрыКонтекстаРасчета.НомерКорректировки = ПараметрыОтчета.НомерКорректировки;
			КонецЕсли;
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетСтатистикаФормаУчетаПеремещенияТоваровТС" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаАналогЛК" Тогда
			...
			РегламентированнаяОтчетностьУП.ЗаполнитьОтчетСтатистикаФормаУчетаПеремещенияТоваровТСФормаАналогЛК(ПараметрыОтчета, Контейнер);
	...
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетАкцизыАлкоголь" Тогда
		...
		Если ИДРедакцииОтчета = "ФормаОтчета2025Кв1" Тогда
			РегламентированнаяОтчетностьУП.ЗаполнитьОтчетАкцизыАлкогольФормаОтчета2025Кв1(ПараметрыОтчета, Контейнер);
		КонецЕсли;
		
	ИначеЕсли ИДОтчета = "РегламентированныйОтчетАкцизыГСМ" Тогда
		
		Если ИДРедакцииОтчета = "ФормаОтчета2025Кв2" Тогда
			РегламентированнаяОтчетностьУП.ЗаполнитьОтчетАкцизыГСМФормаОтчета2025Кв2(ПараметрыОтчета, Контейнер);
		ИначеЕсли ИДРедакцииОтчета = "ФормаОтчета2023Кв1" Тогда
			РегламентированнаяОтчетностьУП.ЗаполнитьОтчетАкцизыГСМФормаОтчета2023Кв1(ПараметрыОтчета, Контейнер);
		КонецЕсли;
		
	ИначеЕсли ИДОтчета = "РегламентированноеУведомлениеДокументОПредстоящейПоставке" Тогда
		
		Если ИДРедакцииОтчета = "Форма2026_1"Тогда
			РегламентированнаяОтчетностьУП.ЗаполнитьУведомлениеОПредстоящейПоставке(ПараметрыОтчета, Контейнер);
		КонецЕсли;
...
Функция ПолучитьСписокРегламентированныхОтчетов() Экспорт
	...
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетГОЗФорма4");
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетГОЗФорма5");
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетГОЗФорма6");
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетГОЗФорма7");
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетГОЗФорма9");
	СписокРегламентированныхОтчетов.Добавить("РегламентированныйОтчетГОЗФорма20д");
...
Процедура ЗаписьОбъектовРегламентированнойОтчетности(Ссылка, Отказ, СтандартнаяОбработка) Экспорт
	...
	НалогНаПрибыльКорректировки.ЗаписьОбъектовРегламентированнойОтчетности(Ссылка, Отказ, СтандартнаяОбработка);
