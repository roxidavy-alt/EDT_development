...
Функция ТекстОшибкиНеЗагруженКлассификаторПоВидуПродукции(ВидПродукции) Экспорт
	...
	Если ТипЗнч(ВидПродукции) = Тип("Массив") Тогда
		...
		Возврат
			СтрШаблон(НСтр("ru = 'Не загружены данные классификатора по товарным группам: ""%1"".';
							|en = 'Не загружены данные классификатора по товарным группам: ""%1"".'"), СписокВидовПродукции);
		
	Иначе
		
		Возврат
			СтрШаблон(НСтр("ru = 'Не загружены данные классификатора по товарной группе: ""%1"".';
							|en = 'Не загружены данные классификатора по товарной группе: ""%1"".'"), ВидПродукции);
