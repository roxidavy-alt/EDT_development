...
Процедура ДобавитьЭтап_ФормированиеРезервовПоСомнительнымДолгам(ТаблицаЭтапов, ТекущийРодитель) Экспорт
	...
	НоваяСтрока = ЗакрытиеМесяцаСервер.ДобавитьЭтапВТаблицу(ТаблицаЭтапов, ТекущийРодитель,
		Справочники.ОперацииЗакрытияМесяца.ФормированиеРезервовПоСомнительнымДолгам);
	
	НоваяСтрока.МультиязычноеНаименование = "ru = 'Формирование резервов по сомнительным долгам';
											|en = 'Generate loss allowance'"; // @НСтр-1
...
//  * Операция - СправочникСсылка.ОперацииЗакрытияМесяца - всегда ФормированиеРезервовПоСомнительнымДолгам
...
Функция ТекстЗапросаЗаданийКЗакрытиюМесяцаПриИзмененииРасчетов(ИмяТаблицыДействующиеУчетныеПолитики) Экспорт
	...
	|	ЗНАЧЕНИЕ(Справочник.ОперацииЗакрытияМесяца.ФормированиеРезервовПоСомнительнымДолгам) КАК Операция,
...
#Область ОрганизацииОтраженные
	...
	ТекстЗапроса = СтрШаблон(ШаблонЗапроса, ТекстЗапроса);
	ТекстыЗапроса.Добавить(ТекстЗапроса);     
...
#Область ОрганизацииКОтражению
	...
	|ИЗ
	|	вт_ОрганизацииСРезервами КАК Организации
	|		ЛЕВОЕ СОЕДИНЕНИЕ вт_ОрганизацииОтраженные КАК ОрганизацииОтраженные
	|		ПО Организации.Ссылка = ОрганизацииОтраженные.Организация
	|ГДЕ
