...
Процедура СброситьНедопустимыеДляСчетаПоказатели(Счет, Настройки)
	...
	Если НЕ СвойстваСчета.НалоговыйУчет Тогда
		...
		Если Настройки.Свойство("ПоказательНУКорректировка") Тогда
			Настройки.ПоказательНУКорректировка = Ложь;
		КонецЕсли;
		Если Настройки.Свойство("ПоказательНУсКорректировкой") Тогда
			Настройки.ПоказательНУсКорректировкой = Ложь;
		КонецЕсли;
	КонецЕсли;
