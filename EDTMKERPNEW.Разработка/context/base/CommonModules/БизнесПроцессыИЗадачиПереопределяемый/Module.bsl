...
Процедура ПриОпределенииБизнесПроцессов(ПодключенныеБизнесПроцессы) Экспорт
	...
	//++ НЕ УТКА
	ПодключенныеБизнесПроцессы.Вставить(Метаданные.БизнесПроцессы.СогласованиеРазрешенийНаЗаменуМатериалов.ПолноеИмя(), "");
	//-- НЕ УТКА
...
Процедура ПриНачальномЗаполненииРолейИсполнителей(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	МультиязычностьСервер.ЗаполнитьМультиязычныйРеквизит(Элемент, "Наименование", "ru = 'Согласующий разрешения на замену материалов';
																					|en = 'Engineering change order approver'", КодыЯзыков); // @НСтр-2
