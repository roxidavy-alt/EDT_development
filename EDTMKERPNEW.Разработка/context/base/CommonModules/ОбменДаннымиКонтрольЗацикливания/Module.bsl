		...
		Если Выборка.ОбновитьРеквизиты Тогда
			...
			Исключение
				...
				Событие = НСтр("ru = 'Контроль зацикливания.Обновление реквизитов записи контура синхронизации';
								|en = 'Loop control.Update attributes of the synchronization circuit record'", ОбщегоНазначения.КодОсновногоЯзыка());
		...
		ИначеЕсли Выборка.УдалитьУзелИзКонтура Тогда
			...
			Исключение
				...
				Событие = НСтр("ru = 'Контроль зацикливания.Удаление записи контура синхронизации';
								|en = 'Loop control.Delete the synchronization circuit record'", ОбщегоНазначения.КодОсновногоЯзыка());
		...
		ИначеЕсли Выборка.УстановитьПоследнееОбновление Тогда
			...
			Исключение
				...
				Событие = НСтр("ru = 'Контроль зацикливания.Очистка устаревшей версии';
								|en = 'Loop control.Clear the outdated version'", ОбщегоНазначения.КодОсновногоЯзыка());
			...
			Для Каждого КоррУзелКонтура Из УзлыКонтура[0].Строки Цикл
				...
				Исключение
					...
					Событие = НСтр("ru = 'Контроль зацикливания.Обновление контура синхронизации';
									|en = 'Loop control.Update the synchronization circuit'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			Событие = НСтр("ru = 'Контроль зацикливания.Замена префиксов';
							|en = 'Loop control.Replace the prefix'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			Событие = НСтр("ru = 'Контроль зацикливания.Изменение признака зацикливание';
							|en = 'Loop control.Change the looping flag'", ОбщегоНазначения.КодОсновногоЯзыка());
	...
	Пока Выборка.Следующий() Цикл
		...
		Исключение
			...
			Событие = НСтр("ru = 'Контроль зацикливания.Удаление записи';
							|en = 'Loop control.Delete the record'", ОбщегоНазначения.КодОсновногоЯзыка());
