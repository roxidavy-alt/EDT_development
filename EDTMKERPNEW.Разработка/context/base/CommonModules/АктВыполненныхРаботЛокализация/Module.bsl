...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	ТекстыОтражения.Добавить(РеглУчетВыборкиСерверПовтИсп.ТекстВыручкаОтРеализации()); // Отражение задолженности покупателя (Дт 62.01 :: Кт 90.01)
	ТекстыОтражения.Добавить(РеглУчетВыборкиСерверПовтИсп.ТекстНачислениеНДССВыручки()); // Начислен НДС (Дт 90.03 :: Кт 68.02)
	ТекстыОтражения.Добавить(РеглУчетВыборкиСерверПовтИсп.ТекстСебестоимостьПродаж()); // Выпуск работ (Дт 90.02 :: Кт 20)
...
Функция ТекстНеПодтверждениеНулевойСтавкиНДС()
	...
	|	""АктВыполненныхРаботЛокализация_15"" КАК НомерФрагмента
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстПродажаАгентскихУслуг()
	...
	|	""АктВыполненныхРаботЛокализация_16"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстВключениеИсключениеНДСВСтоимость()
	...
	|	""АктВыполненныхРаботЛокализация_17"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
