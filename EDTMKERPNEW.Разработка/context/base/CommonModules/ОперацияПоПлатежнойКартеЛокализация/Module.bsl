...
#Область ПоступлениеОплатыОтКлиента
	...
	|	""ОперацияПоПлатежнойКартеЛокализация_626"" КАК НомерФрагмента
	|
	|ИЗ
...
#Область ПоступлениеАвансаОтКлиента
	...
	|	""ОперацияПоПлатежнойКартеЛокализация_627"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВозвратДСКлиенту
	...
	|	""ОперацияПоПлатежнойКартеЛокализация_628"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВозвратКлиентуАвансаПогашениеДолга
	...
	|	""ОперацияПоПлатежнойКартеЛокализация_1771"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#КонецОбласти
	...
	|	""ОперацияПоПлатежнойКартеЛокализация_629"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
