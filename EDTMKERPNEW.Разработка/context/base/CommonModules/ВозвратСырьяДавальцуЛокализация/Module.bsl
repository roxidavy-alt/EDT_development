...
#Область ВозвратнаяТара // (Дт 76.09 :: Кт 41.01)
	...
	|	""ВозвратСырьяДавальцуЛокализация_253"" КАК НомерФрагмента
	|ИЗ
...
#Область ВозвратнаяТараСкладПроизводства // (Дт 76.09 :: Кт 20)
	...
	|	0 КАК СуммаВРКт,
	|	""Возврат многооборотной тары"" КАК Содержание,
	|	""ВозвратСырьяДавальцуЛокализация_254"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область РасходыВОтклоненииВСтоимости // (Дт 44.01 :: Кт 41.01)
	...
	|	""ВозвратСырьяДавальцуЛокализация_255"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область РасходыВОтклоненииВСтоимостиСкладПроизводства // (Дт 44.01 :: Кт 20)
	...
	|	ЕСТЬNULL(Стоимости.СуммаВР, Строки.СуммаВР) КАК СуммаВРКт,
	|	""Отклонение в стоимости возвратной тары на расходы"" КАК Содержание,
	|	""ВозвратСырьяДавальцуЛокализация_256"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ДоходыВОтклоненииВСтоимости // (Дт 41.01 :: Кт 91.01)
	...
	|	""ВозвратСырьяДавальцуЛокализация_257"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ДоходыВОтклоненииВСтоимостиСкладПроизводства // (Дт 20 :: Кт 91.01)
	...
	|	ЕСТЬNULL(-Стоимости.СуммаВР, Строки.СуммаВР) КАК СуммаВРКт,
	|	""Отклонение в стоимости возвратной тары в доходы"" КАК Содержание,
	|	""ВозвратСырьяДавальцуЛокализация_258"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
