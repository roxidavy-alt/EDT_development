...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	""АмортизацияНМАЛокализация_22"" КАК НомерФрагмента
	|ИЗ
	...
	|	
	|	""Начисление амортизации"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_23"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	
	|	""Начисление амортизации"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_24"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.АмортизацияНМА КАК Строки
	...
	|	
	|	""Начисление амортизации"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_25"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.АмортизацияНМА КАК Строки
	...
	|	
	|	""Начисление амортизации"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_26"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.АмортизацияНМА КАК Строки
	...
	|	""АмортизацияНМАЛокализация_27"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	
	|	""Начисление амортизации"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_28"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	
	|	""Списание расходов на НИОКР"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_29"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьНМА КАК Строки
	...
	|	
	|	""Списание расходов на НИОКР"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_30"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьНМА КАК Строки
	...
	|	""АмортизацияНМАЛокализация_31"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.АмортизацияНМА КАК Строки
	...
	|	
	|	""Корректировка обесценения"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_32"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.АмортизацияНМА КАК Строки
	...
	|	
	|	""Корректировка обесценения"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_33"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьНМА КАК Строки
	...
	|	
	|	""Корректировка обесценения"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_34"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьНМА КАК Строки
	...
	|	""АмортизацияНМАЛокализация_35"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	
	|	""Сторно обесценения"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_36"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	
	|	""Сторно обесценения"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_37"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	""АмортизацияНМАЛокализация_38"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	
	|	""Признание доходов от целевого финансирования"" КАК Содержание,
	|	""АмортизацияНМАЛокализация_39"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьНМА КАК Строки
...
Процедура ДополнитьТекстЗапросаСписокВсехНМА(СписокЗапросов, ПараметрыРасчета) Экспорт
	...
	|	УчетнаяПолитика.МетодПереоценкиНМА КАК МетодПереоценкиНМА,
	|	УчетнаяПолитика.ПорядокНачисленияАмортизацииНМА КАК ПорядокНачисленияАмортизацииНМА,
	|	УчетнаяПолитика.ПрименяетсяФСБУ14 КАК ПрименяетсяФСБУ14
	|
	...
	|			И УчетнаяПолитикаБУ.Период = &КонецПредыдущегоМесяца
	|
	|ГДЕ
	...
	|			ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВключениеРасходовВСтоимостьНМА))
	|
	...
	|
	|ИМЕЮЩИЕ
	|	СУММА(СтоимостьНМА.СтоимостьРегл + СтоимостьНМА.СтоимостьЦФ - СтоимостьНМА.ПредварительнаяСтоимостьРегл) <> 0
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	НематериальныйАктив,
	|	Организация";
	...
	|		ПО ПринятиеКУчетуНМА.Ссылка = ПорядокУчетаНМА.Регистратор
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ Документ.УлучшениеНМА КАК УлучшениеНМА
	|		ПО УлучшениеНМА.Ссылка = ПорядокУчетаНМА.Регистратор
	|
	|ГДЕ
	...
	|	И (ТИПЗНАЧЕНИЯ(ПорядокУчетаНМА.Регистратор) = ТИП(Документ.ПринятиеКУчетуНМА2_4)
	|			И ЕСТЬNULL(ПринятиеКУчетуНМА.ОтражатьВБУ, ЛОЖЬ)
	|		ИЛИ ТИПЗНАЧЕНИЯ(ПорядокУчетаНМА.Регистратор) = ТИП(Документ.УлучшениеНМА)
	|			И ЕСТЬNULL(УлучшениеНМА.ОтражатьВБУ, ЛОЖЬ))
	|
	|	И (ПорядокУчетаНМА.Организация, ПорядокУчетаНМА.НематериальныйАктив) В
	|				(ВЫБРАТЬ
	|					СписокНМА.Организация,
...
Процедура ЗарегистрироватьОшибкиРасчетаАмортизации(Выборка, ПараметрыРасчета) Экспорт
	...
	Если Выборка.НеУказанаАмортизационнаяГруппа Тогда
		...
		ВнеоборотныеАктивыСлужебный.ЗарегистрироватьПроблемуВыполненияРасчета(
			Справочники.ОперацииЗакрытияМесяца.НачислениеАмортизацииНМА, 
...
Процедура ДополнитьТекстЗапросаПараметрыРасчетаАмортизации(СписокЗапросов, ПараметрыРасчета) Экспорт
	...
	|				И УчетнаяПолитикаБухУчета.Период = &КонецМесяца
	|
	|	) КАК ВложенныйЗапрос
	|
	|СГРУППИРОВАТЬ ПО
	...
	|	МАКСИМУМ(ПервоначальныеСведенияНМА_Последнее.Период) КАК ПервоначальныеСведенияНМА_ПоследнееПериод,
	...
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПервоначальныеСведенияНМА_ИзмененияБУ КАК ПервоначальныеСведенияНМА_Последнее
	...
	|			И (ПервоначальныеСведенияНМА_Последнее.Период <= ТаблицаИзменений.Период)
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПараметрыАмортизацииНМАБУ_Изменения КАК ПараметрыАмортизацииНМАБУ_Последнее
	...
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПорядокУчетаНМА_ИзмененияБУ КАК ПорядокУчетаНМА_Последнее
	...
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПорядокУчетаНМАБУ_Изменения КАК ПорядокУчетаНМАБУ_Последнее
	...
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ МестоУчетаНМА_ИзмененияБУ КАК МестоУчетаНМА_Последнее
	...
	|
	|	ПараметрыАмортизацииНМАБУ_Последнее.ДатаПоследнегоИзменения КАК ДатаПоследнегоИзменения,
	|	ПараметрыАмортизацииНМАБУ_Последнее.СрокИспользования КАК СрокИспользования,
	|	ПараметрыАмортизацииНМАБУ_Последнее.ОбъемНаработки КАК ОбъемНаработки,
	|	ПараметрыАмортизацииНМАБУ_Последнее.КоэффициентБУ КАК КоэффициентБУ,
	|	ПараметрыАмортизацииНМАБУ_Последнее.ЛиквидационнаяСтоимость КАК ЛиквидационнаяСтоимость,
	|
	|	ПервоначальныеСведенияНМА_Последнее.МетодНачисленияАмортизацииБУ КАК МетодНачисленияАмортизацииБУ,
	|
	|	ПорядокУчетаНМА_Последнее.ГруппаФинансовогоУчета КАК ГруппаФинансовогоУчета,
	|	ПорядокУчетаНМА_Последнее.НаправлениеДеятельности КАК НаправлениеДеятельности,
	|
	|	ПорядокУчетаНМАБУ_Последнее.СостояниеБУ КАК СостояниеБУ,
	|	ПорядокУчетаНМАБУ_Последнее.НачислятьАмортизациюБУ КАК НачислятьАмортизациюБУ,
	|	ПорядокУчетаНМАБУ_Последнее.СпособОтраженияАмортизацииБУ КАК СпособОтраженияАмортизацииБУ,
	|	ПорядокУчетаНМАБУ_Последнее.СтатьяРасходовБУ КАК СтатьяРасходовБУ,
	|	ПорядокУчетаНМАБУ_Последнее.АналитикаРасходовБУ КАК АналитикаРасходовБУ,
	...
	|	ПорядокУчетаНМАБУ_Последнее.ПередаватьРасходыВДругуюОрганизацию КАК ПередаватьРасходыВДругуюОрганизацию,
	|	ПорядокУчетаНМАБУ_Последнее.ОрганизацияПолучательРасходов КАК ОрганизацияПолучательРасходов,
	|
	|	МестоУчетаНМА_Последнее.Подразделение КАК Подразделение
	|
	...
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПервоначальныеСведенияНМА_ИзмененияБУ КАК ПервоначальныеСведенияНМА_Последнее
	|			ЛЕВОЕ СОЕДИНЕНИЕ ПервоначальныеСведенияНМА_ИзмененияБУ КАК ПервоначальныеСведенияНМА_Следующее
	|			ПО (ПервоначальныеСведенияНМА_Следующее.Организация = ПервоначальныеСведенияНМА_Последнее.Организация)
	|				И (ПервоначальныеСведенияНМА_Следующее.НематериальныйАктив = ПервоначальныеСведенияНМА_Последнее.НематериальныйАктив)
	|				И (ПервоначальныеСведенияНМА_Следующее.НачалоМесяца = ПервоначальныеСведенияНМА_Последнее.НачалоМесяца)
	|				И (ПервоначальныеСведенияНМА_Следующее.Период = ПервоначальныеСведенияНМА_Последнее.Период)
	|				И (ПервоначальныеСведенияНМА_Следующее.МоментВремени > ПервоначальныеСведенияНМА_Последнее.МоментВремени)
	|		ПО (ПервоначальныеСведенияНМА_Последнее.Организация = ТаблицаИзменений.Организация)
	|			И (ПервоначальныеСведенияНМА_Последнее.НематериальныйАктив = ТаблицаИзменений.НематериальныйАктив)
	|			И (ПервоначальныеСведенияНМА_Последнее.НачалоМесяца = ТаблицаИзменений.НачалоМесяца)
	|			И (ПервоначальныеСведенияНМА_Последнее.Период = ТаблицаИзменений.ПервоначальныеСведенияНМА_ПоследнееПериод)
	|			И (ПервоначальныеСведенияНМА_Следующее.Регистратор ЕСТЬ NULL)
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПараметрыАмортизацииНМАБУ_Изменения КАК ПараметрыАмортизацииНМАБУ_Последнее
	|			ЛЕВОЕ СОЕДИНЕНИЕ ПараметрыАмортизацииНМАБУ_Изменения КАК ПараметрыАмортизацииНМАБУ_Следующее
	|			ПО (ПараметрыАмортизацииНМАБУ_Следующее.Организация = ПараметрыАмортизацииНМАБУ_Последнее.Организация)
	|				И (ПараметрыАмортизацииНМАБУ_Следующее.НематериальныйАктив = ПараметрыАмортизацииНМАБУ_Последнее.НематериальныйАктив)
	|				И (ПараметрыАмортизацииНМАБУ_Следующее.НачалоМесяца = ПараметрыАмортизацииНМАБУ_Последнее.НачалоМесяца)
	|				И (ПараметрыАмортизацииНМАБУ_Следующее.Период = ПараметрыАмортизацииНМАБУ_Последнее.Период)
	|				И (ПараметрыАмортизацииНМАБУ_Следующее.МоментВремени > ПараметрыАмортизацииНМАБУ_Последнее.МоментВремени)
	|		ПО (ПараметрыАмортизацииНМАБУ_Последнее.Организация = ТаблицаИзменений.Организация)
	|			И (ПараметрыАмортизацииНМАБУ_Последнее.НематериальныйАктив = ТаблицаИзменений.НематериальныйАктив)
	|			И (ПараметрыАмортизацииНМАБУ_Последнее.НачалоМесяца = ТаблицаИзменений.НачалоМесяца)
	|			И (ПараметрыАмортизацииНМАБУ_Последнее.Период = ТаблицаИзменений.ПараметрыАмортизацииНМАБУ_ПоследнееПериод)
	|			И (ПараметрыАмортизацииНМАБУ_Следующее.Регистратор ЕСТЬ NULL)
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПорядокУчетаНМА_ИзмененияБУ КАК ПорядокУчетаНМА_Последнее
	|			ЛЕВОЕ СОЕДИНЕНИЕ ПорядокУчетаНМА_ИзмененияБУ КАК ПорядокУчетаНМА_Следующее
	|			ПО (ПорядокУчетаНМА_Следующее.Организация = ПорядокУчетаНМА_Последнее.Организация)
	|				И (ПорядокУчетаНМА_Следующее.НематериальныйАктив = ПорядокУчетаНМА_Последнее.НематериальныйАктив)
	|				И (ПорядокУчетаНМА_Следующее.НачалоМесяца = ПорядокУчетаНМА_Последнее.НачалоМесяца)
	|				И (ПорядокУчетаНМА_Следующее.Период = ПорядокУчетаНМА_Последнее.Период)
	|				И (ПорядокУчетаНМА_Следующее.МоментВремени > ПорядокУчетаНМА_Последнее.МоментВремени)
	|		ПО (ПорядокУчетаНМА_Последнее.НематериальныйАктив = ТаблицаИзменений.НематериальныйАктив)
	|			И (ПорядокУчетаНМА_Последнее.НачалоМесяца = ТаблицаИзменений.НачалоМесяца)
	|			И (ПорядокУчетаНМА_Последнее.Период = ТаблицаИзменений.ПорядокУчетаНМА_ПоследнееПериод)
	|			И (ПорядокУчетаНМА_Следующее.Регистратор ЕСТЬ NULL)
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПорядокУчетаНМАБУ_Изменения КАК ПорядокУчетаНМАБУ_Последнее
	|			ЛЕВОЕ СОЕДИНЕНИЕ ПорядокУчетаНМАБУ_Изменения КАК ПорядокУчетаНМАБУ_Следующее
	|			ПО (ПорядокУчетаНМАБУ_Следующее.Организация = ПорядокУчетаНМАБУ_Последнее.Организация)
	|				И (ПорядокУчетаНМАБУ_Следующее.НематериальныйАктив = ПорядокУчетаНМАБУ_Последнее.НематериальныйАктив)
	|				И (ПорядокУчетаНМАБУ_Следующее.НачалоМесяца = ПорядокУчетаНМАБУ_Последнее.НачалоМесяца)
	|				И (ПорядокУчетаНМАБУ_Следующее.Период = ПорядокУчетаНМАБУ_Последнее.Период)
	|				И (ПорядокУчетаНМАБУ_Следующее.МоментВремени > ПорядокУчетаНМАБУ_Последнее.МоментВремени)
	|		ПО (ПорядокУчетаНМАБУ_Последнее.Организация = ТаблицаИзменений.Организация)
	|			И (ПорядокУчетаНМАБУ_Последнее.НематериальныйАктив = ТаблицаИзменений.НематериальныйАктив)
	|			И (ПорядокУчетаНМАБУ_Последнее.НачалоМесяца = ТаблицаИзменений.НачалоМесяца)
	|			И (ПорядокУчетаНМАБУ_Последнее.Период = ТаблицаИзменений.ПорядокУчетаНМАБУ_ПоследнееПериод)
	|			И (ПорядокУчетаНМАБУ_Следующее.Регистратор ЕСТЬ NULL)
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ МестоУчетаНМА_ИзмененияБУ КАК МестоУчетаНМА_Последнее
	|			ЛЕВОЕ СОЕДИНЕНИЕ МестоУчетаНМА_ИзмененияБУ КАК МестоУчетаНМА_Следующее
	|			ПО (МестоУчетаНМА_Следующее.Организация = МестоУчетаНМА_Последнее.Организация)
	|				И (МестоУчетаНМА_Следующее.НематериальныйАктив = МестоУчетаНМА_Последнее.НематериальныйАктив)
	|				И (МестоУчетаНМА_Следующее.НачалоМесяца = МестоУчетаНМА_Последнее.НачалоМесяца)
	|				И (МестоУчетаНМА_Следующее.Период = МестоУчетаНМА_Последнее.Период)
	|				И (МестоУчетаНМА_Следующее.МоментВремени > МестоУчетаНМА_Последнее.МоментВремени)
	|		ПО (МестоУчетаНМА_Последнее.Организация = ТаблицаИзменений.Организация)
	|			И (МестоУчетаНМА_Последнее.НематериальныйАктив = ТаблицаИзменений.НематериальныйАктив)
	|			И (МестоУчетаНМА_Последнее.НачалоМесяца = ТаблицаИзменений.НачалоМесяца)
	|			И (МестоУчетаНМА_Последнее.Период = ТаблицаИзменений.МестоУчетаНМА_ПоследнееПериод)
	|			И (МестоУчетаНМА_Следующее.Регистратор ЕСТЬ NULL)
	|
	...
	|	ЕСТЬNULL(ПредварительнаяСтоимостьНМА.ПредварительнаяСтоимостьПревышаетФактическуюБУ, ЛОЖЬ) КАК ПредварительнаяСтоимостьПревышаетФактическую,
	|	СписокНМА.НематериальныйАктив КАК НематериальныйАктив,
	...
	|
	|			ТОГДА ЕСТЬNULL(ПредварительнаяСтоимостьНМА.СтоимостьБУ, 0)
	|
	...
	|		КОГДА НАЧАЛОПЕРИОДА(ДатыПоследнегоИзменения.Дата, МЕСЯЦ) = СписокНМА.НачалоМесяца
	|			ТОГДА ВЫРАЗИТЬ(ВЫРАЗИТЬ(РАЗНОСТЬДАТ(ДатыПоследнегоИзменения.Дата, ЕСТЬNULL(ДОБАВИТЬКДАТЕ(ПериодИзменения_БУ.Период, ДЕНЬ, -1), СписокНМА.КонецМесяца), ДЕНЬ) + 1 КАК ЧИСЛО(15,9))
	|					/ ВЫРАЗИТЬ(ДЕНЬ(СписокНМА.КонецМесяца) КАК ЧИСЛО(15,9)) КАК ЧИСЛО(31,9))
	|	
			// Если это доначисление то Дата документа / ВсегоДнейВМесяце
	|		КОГДА СписокНМА.ЭтоДоначисление
	|
	|			ТОГДА ВЫРАЗИТЬ(ВЫРАЗИТЬ(РАЗНОСТЬДАТ(СписокНМА.Период, ЕСТЬNULL(ДОБАВИТЬКДАТЕ(ПериодИзменения_БУ.Период, ДЕНЬ, -1), СписокНМА.КонецМесяца), ДЕНЬ) + 1 КАК ЧИСЛО(15,9))
	|					/ ВЫРАЗИТЬ(ДЕНЬ(СписокНМА.КонецМесяца) КАК ЧИСЛО(15,9)) КАК ЧИСЛО(31,9))
	|
			// В остальных случаях КоличествоДнейДоПервогоИзмененияПараметров/ВсегоДнейВМесяце
	|		ИНАЧЕ ВЫРАЗИТЬ(ВЫРАЗИТЬ(РАЗНОСТЬДАТ(СписокНМА.НачалоМесяца, ЕСТЬNULL(ДОБАВИТЬКДАТЕ(ПериодИзменения_БУ.Период, ДЕНЬ, -1), СписокНМА.КонецМесяца), ДЕНЬ) + 1 КАК ЧИСЛО(15,9))
	|					/ ВЫРАЗИТЬ(ДЕНЬ(СписокНМА.КонецМесяца) КАК ЧИСЛО(15,9)) КАК ЧИСЛО(31,9))
	|
	...
	|				+ РАЗНОСТЬДАТ(НАЧАЛОПЕРИОДА(ДОБАВИТЬКДАТЕ(ДатыПоследнегоИзменения.Дата, МЕСЯЦ, 1), МЕСЯЦ), СписокНМА.КонецМесяца, МЕСЯЦ) КАК ЧИСЛО(31,9))
	|
	...
	|					ИЛИ СписокНМА.ЭтоДоначисление)
	|
	|			ТОГДА ЕСТЬNULL(ПредварительнаяСтоимостьНМА.СтоимостьПР, 0)
	|
	...
	|					ИЛИ СписокНМА.ЭтоДоначисление)
	|
	|			ТОГДА ЕСТЬNULL(ПредварительнаяСтоимостьНМА.СтоимостьБУ, 0) * ЕСТЬNULL(ПредварительнаяСтоимостьНМА.ДоляЦФ, 0)
	|
	...
	|		ИЛИ ЕСТЬNULL(ПорядокУчетаНМАБУ_НаНачалоМесяца.СостояниеБУ, ЗНАЧЕНИЕ(Перечисление.СостоянияНМА.НеПринятКУчету)) = ЗНАЧЕНИЕ(Перечисление.СостоянияНМА.ПринятКУчету))
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	НематериальныйАктив,
	|	Организация";
	...
	|				КОНЕЦ
	|		ИНАЧЕ 1
	|	КОНЕЦ КАК ЧИСЛО(15,9)) * ВЫРАЗИТЬ(Изменения_БУ.СрокДействия КАК ЧИСЛО(15,9)) / ВЫРАЗИТЬ(ДЕНЬ(Изменения_БУ.КонецМесяца) КАК ЧИСЛО(15,9)) КАК ЧИСЛО(31,9)) КАК РесурсВыработанныйЗаТекущийПериод,
	|	  
	// РесурсВыработанныйЗаПрошлыйПериод
	|	ВЫБОР 
	...
	|			ТОГДА ВЫБОР
	|					КОГДА Изменения_БУ.НачалоМесяца = &НачалоПредыдущегоМесяца
	|						ТОГДА ВЫРАЗИТЬ(ЕСТЬNULL(ВыработкаНМА.ОбъемВыработкиНаНачалоПредыдущегоМесяца, 0) КАК ЧИСЛО(31,9))
	|					ИНАЧЕ ВЫРАЗИТЬ(ЕСТЬNULL(ВыработкаНМА.ОбъемВыработкиНаНачалоМесяца, 0) 
	|									- ЕСТЬNULL(ВыработкаНМА_НаДатуПоследнегоИзменения.ОбъемВыработкиБУ, 0) КАК ЧИСЛО(31,9))
	|				КОНЕЦ
	|
	|		ИНАЧЕ
	...
	|						+ РАЗНОСТЬДАТ(НАЧАЛОПЕРИОДА(ДОБАВИТЬКДАТЕ(ЕСТЬNULL(Изменения_БУ.ДатаПоследнегоИзменения, ПараметрыАмортизацииНМАБУ.ДатаПоследнегоИзменения), МЕСЯЦ, 1), МЕСЯЦ), Изменения_БУ.КонецМесяца, МЕСЯЦ) КАК ЧИСЛО(31,9))
	|	КОНЕЦ КАК РесурсВыработанныйЗаПрошлыйПериод,
	|
	// ОтработанныхМесяцевПолныхЛет
	|	ВЫБОР
...
Функция ТекстЗапросаВтНачисленнаяАмортизация() Экспорт
	...
	|	НачисленнаяАмортизация.ПериодРасчета КАК ПериодНачисления,
...
Процедура РассчитатьАмортизацию_ЗаПрошлыйМесяцБУ(ПараметрыРасчета)
	...
	|	РасчетАмортизации.ПервоначальнаяСтоимостьБУ КАК ПервоначальнаяСтоимостьБУ,
	|	РасчетАмортизации.СтоимостьРегл КАК СтоимостьРегл,
	|	РасчетАмортизации.СтоимостьЦФ КАК СтоимостьЦФ,
	|	РасчетАмортизации.СтоимостьПР КАК СтоимостьПР,
	|	РасчетАмортизации.СтоимостьПРЦФ КАК СтоимостьПРЦФ
	|
	...
	|	
	|ВЫБРАТЬ
	|	РасчетАмортизации.Период,
	|	РасчетАмортизации.Организация,
	|	РасчетАмортизации.Подразделение,
	|	РасчетАмортизации.ГруппаФинансовогоУчета,
	|	РасчетАмортизации.НаправлениеДеятельности,
	|	РасчетАмортизации.НематериальныйАктив,
	|	РасчетАмортизации.ВидОбъектаУчета КАК ВидОбъектаУчета,
	...
	|	РасчетАмортизации.СуммаПР КАК СуммаПР,
	|
	|	РасчетАмортизации.ПередаватьРасходыВДругуюОрганизацию,
	|	РасчетАмортизации.ОрганизацияПолучательРасходов,
	|	РасчетАмортизации.РесурсВыработанныйЗаПрошлыйПериод,
	|	РасчетАмортизации.РесурсВыработанныйЗаТекущийПериод,
	|	РасчетАмортизации.ВерсияМетодаНачисления КАК ВерсияМетодаНачисления,
	|
	|	ВЫБОР
	|		КОГДА РасчетАмортизации.ПредварительнаяСтоимостьПревышаетФактическую
...
Процедура РассчитатьАмортизацию_ЗаПрошлыйМесяц_БезИзмененийБУ(ПараметрыРасчета)
	...
	|	СписокНМА.ВариантПроводокПоОбесценениюВНА КАК ВариантПроводокПоОбесценениюВНА,
	|	СписокНМА.ПредварительнаяСтоимостьПревышаетФактическую КАК ПредварительнаяСтоимостьПревышаетФактическую,
	...
	|	СписокНМА.ВерсияМетодаНачисления КАК ВерсияМетодаНачисления,
	|
	...
	|
	|		ВЫБОР
	|			КОГДА СписокНМА.МетодНачисленияАмортизацииБУ = ЗНАЧЕНИЕ(Перечисление.СпособыНачисленияАмортизацииНМА.УменьшаемогоОстатка)
	|				ТОГДА 1
	|			ИНАЧЕ 0
...
Процедура РассчитатьАмортизацию_ЗаПрошлыйМесяц_СУчетомИзмененийБУ(ПараметрыРасчета)
	...
	|
	|ИЗ
	|	РасчетАмортизацииЗаПрошлыйМесяц_БезИзменений_БУ КАК СписокНМА
	|
	|ГДЕ
	...
	АмортизацияИзменений = Документы.АмортизацияНМА2_4.РассчитатьАмортизациюПриИзмененииПараметров(РезультатЗапроса.Выгрузить());
	...
	|
	|	ВЫБОР
	|		КОГДА РасчетАмортизации.МетодНачисленияАмортизации = ЗНАЧЕНИЕ(Перечисление.СпособыНачисленияАмортизацииНМА.УменьшаемогоОстатка)
	|			ТОГДА 1
	|		ИНАЧЕ 0
	|	КОНЕЦ КАК ВерсияМетодаНачисления
	|
...
Процедура РассчитатьАмортизацию_ЗаТекущийМесяц_БезИзмененийБУ(ПараметрыРасчета)
	...
	|		КОГДА СписокНМА.ОстаточнаяСтоимостьПР = 0
	|				ИЛИ СписокНМА.ОстаточнаяСтоимостьРегл = 0
	|				ИЛИ СписокНМА.ВариантПроводокПоОбесценениюВНА = &ДоначислятьКорректировкуОбесценения
	|					И СписокНМА.СуммаБУ + СписокНМА.ОбесценениеБУ = 0
	|				ИЛИ СписокНМА.ВариантПроводокПоОбесценениюВНА <> &ДоначислятьКорректировкуОбесценения
	...
	|					И СписокНМА.СуммаБУ + СписокНМА.ОбесценениеБУ = СписокНМА.ОстаточнаяСтоимостьРегл
	|				ИЛИ СписокНМА.ВариантПроводокПоОбесценениюВНА <> &ДоначислятьКорректировкуОбесценения
	|					И СписокНМА.СуммаБУ = СписокНМА.ОстаточнаяСтоимостьРегл
	| 
	|			ТОГДА СписокНМА.ОстаточнаяСтоимостьПР
	|
	|		КОГДА СписокНМА.ВариантПроводокПоОбесценениюВНА = &ДоначислятьКорректировкуОбесценения
	|
	|			ТОГДА ВЫРАЗИТЬ(ВЫРАЗИТЬ(СписокНМА.ОстаточнаяСтоимостьПР КАК ЧИСЛО (25, 9))
	|				* (ВЫРАЗИТЬ(СписокНМА.СуммаБУ + СписокНМА.ОбесценениеБУ КАК ЧИСЛО (25, 9)) / ВЫРАЗИТЬ(СписокНМА.ОстаточнаяСтоимостьРегл КАК ЧИСЛО (25, 9))) КАК ЧИСЛО (31, 2))
	|
	|		ИНАЧЕ ВЫРАЗИТЬ(ВЫРАЗИТЬ(СписокНМА.ОстаточнаяСтоимостьПР КАК ЧИСЛО (25, 9))
	|				* (ВЫРАЗИТЬ(СписокНМА.СуммаБУ КАК ЧИСЛО (25, 9)) / ВЫРАЗИТЬ(СписокНМА.ОстаточнаяСтоимостьРегл КАК ЧИСЛО (25, 9))) КАК ЧИСЛО (31, 2))
	|
	|	КОНЕЦ КАК СуммаПР
	|
	...
	|
	|		ВЫБОР 
	|			КОГДА (СписокНМА.ОстаточнаяСтоимостьРегл - СписокНМА.ЛиквидационнаяСтоимость - СписокНМА.ОбесценениеБУ - СписокНМА.СуммаБУ) < &МинимальнаяОстаточнаяСтоимостьРегл
	|					И СписокНМА.СуммаБУ > 0
	...
	|			СписокНМА.ОстаточнаяСтоимостьЦФ КАК ОстаточнаяСтоимостьЦФ,
	|			СписокНМА.ОстаточнаяСтоимостьПР - ЕСТЬNULL(Доначисление.СуммаПР, 0) КАК ОстаточнаяСтоимостьПР,
	|			СписокНМА.ОстаточнаяСтоимостьПРЦФ КАК ОстаточнаяСтоимостьПРЦФ, 
	|			СписокНМА.ОстатокОбесцененияРегл КАК ОстатокОбесцененияРегл,
	|			СписокНМА.ПервоначальнаяСтоимостьБУ КАК ПервоначальнаяСтоимостьБУ,
	|			СписокНМА.НачислятьАмортизациюБУ КАК НачислятьАмортизациюБУ,
	...
	|
	|			ВЫБОР
	|				КОГДА (СписокНМА.ОстатокОбесцененияРегл - (&ОбесценениеБУ)) < &МинимальнаяОстаточнаяСтоимостьРегл
	|					ТОГДА СписокНМА.ОстатокОбесцененияРегл
	|				ИНАЧЕ &ОбесценениеБУ
	|			КОНЕЦ КАК ОбесценениеБУ,
	|
	|			ВЫБОР 
	|				КОГДА (СписокНМА.ОстаточнаяСтоимостьРегл - СписокНМА.ЛиквидационнаяСтоимость - ЕСТЬNULL(Доначисление.СуммаБУ, 0) - (&СуммаАмортизацииБУ)) < &МинимальнаяОстаточнаяСтоимостьРегл
	|
	|					ТОГДА СписокНМА.ОстаточнаяСтоимостьРегл - СписокНМА.ЛиквидационнаяСтоимость - ЕСТЬNULL(Доначисление.СуммаБУ, 0)
	|
...
Процедура РассчитатьАмортизацию_ЗаТекущийМесяц_СУчетомИзмененийБУ(ПараметрыРасчета)
	...
	|	СписокНМА.ОстаточнаяСтоимостьПР КАК ОстаточнаяСтоимостьПР,
	|	СписокНМА.ОстаточнаяСтоимостьПРЦФ КАК ОстаточнаяСтоимостьПРЦФ, 
	|	СписокНМА.ОстатокОбесцененияРегл КАК ОбесценениеРегл,
	|	0 КАК ОбесценениеУпр,
	|
	...
	|
	|ИЗ
	|	РасчетАмортизации_ЗаТекущийМесяц_БезИзмененийБУ КАК СписокНМА
	|
	|		ЛЕВОЕ СОЕДИНЕНИЕ РасчетАмортизации_ЗаПрошлыйМесяцБУ_Сгруппированная КАК Доначисление
	|		ПО Доначисление.НематериальныйАктив = СписокНМА.НематериальныйАктив
	|
	...
	|	РасчетАмортизации.СтоимостьДляВычисленияАмортизацииРегл КАК СтоимостьДляВычисленияАмортизации,
	|
	|	РасчетАмортизации.СтоимостьДляВычисленияАмортизацииРегл КАК ОстаточнаяСтоимостьРегл,
	|	РасчетАмортизации.СтоимостьДляВычисленияАмортизацииРегл * РасчетАмортизации.КоэффициентЦФБУ КАК ОстаточнаяСтоимостьЦФ,
	|
	|	РасчетАмортизации.ОстаточнаяСтоимостьПР КАК ОстаточнаяСтоимостьПР,
	|	РасчетАмортизации.ОстаточнаяСтоимостьПРЦФ КАК ОстаточнаяСтоимостьПРЦФ, 
	|                       
...
Процедура ОбъединитьРасчетАмортизации(ПараметрыРасчета)
	...
	|		МАКСИМУМ(СписокНМА.ВерсияМетодаНачисленияБУ) КАК ВерсияМетодаНачисленияБУ,
...
Функция ТекстЗапросаСуммаАмортизацииБУ(ПараметрыТекстаЗапроса)
	...
	|			И СписокНМА.МетодНачисленияАмортизацииБУ = ЗНАЧЕНИЕ(Перечисление.СпособыНачисленияАмортизацииНМА.УменьшаемогоОстатка) 
	|   
	|		ТОГДА ВЫРАЗИТЬ(ВЫРАЗИТЬ(&ОстаточнаяСтоимость - &СуммаДоначисления - &ЛиквидационнаяСтоимость - &ОстатокОбесценения КАК ЧИСЛО(20,8))
	|					* ВЫРАЗИТЬ(СписокНМА.РесурсВыработанныйЗаТекущийПериод КАК ЧИСЛО(20,8))
	|					* ВЫРАЗИТЬ(СписокНМА.КоэффициентБУ КАК ЧИСЛО(20,8))
	|					/ ВЫРАЗИТЬ(СписокНМА.РесурсНазначенный - СписокНМА.РесурсВыработанныйЗаПрошлыйПериод + СписокНМА.КоэффициентБУ - 1 КАК ЧИСЛО(20,8)) КАК ЧИСЛО(31,2))
	|
		// Линейный
	|	КОГДА НЕ СписокНМА.АмортизацияНачисляетсяПоСтандартамМУ
...
Функция ТекстЗапросаСуммаОбесценения()
	...
	|			И СписокНМА.МетодНачисленияАмортизацииБУ = ЗНАЧЕНИЕ(Перечисление.СпособыНачисленияАмортизацииНМА.УменьшаемогоОстатка) 
	|
	|		ТОГДА ВЫРАЗИТЬ(ВЫРАЗИТЬ(СписокНМА.ОстатокОбесцененияРегл КАК ЧИСЛО(20,8))
	|					* ВЫРАЗИТЬ(СписокНМА.РесурсВыработанныйЗаТекущийПериод КАК ЧИСЛО(20,8))
	|					* ВЫРАЗИТЬ(СписокНМА.КоэффициентБУ КАК ЧИСЛО(20,8))
	|					/ ВЫРАЗИТЬ(СписокНМА.РесурсНазначенный - СписокНМА.РесурсВыработанныйЗаПрошлыйПериод + СписокНМА.КоэффициентБУ - 1 КАК ЧИСЛО(20,8)) КАК ЧИСЛО(31,2))
	|
