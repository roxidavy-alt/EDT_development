	...
	Если ДокументОбъект.ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВводОстатковОтгруженныхТоваров
		...
		Если Выборка.Следующий() Тогда
			...
			ТекстСообщения = СтрШаблон(НСтр("ru = 'На основании документа %1 уже были введены начальные остатки:
				|%2.';
				|en = 'Based on the %1 document, the opening balances are already entered:
				|%2.'"),
...
Функция ОписаниеХозяйственныхОперацийВводаОстатковТоваров()
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьОтветственноеХранениеВПроцессеЗакупки") Тогда
		...
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента            = НСтр("ru = 'Ввод начальных остатков принятых на хранение товаров %1';
																				|en = 'OB entry: VMI in our warehouse %1'");
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьОтгрузкуБезПереходаПраваСобственности2_5") Тогда
		...
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента            = НСтр("ru = 'Ввод остатков товаров, отгруженных клиентам %1';
																				|en = 'OB entry: goods shipped to customers %1'");
...
Функция ОписаниеХозяйственныхОперацийВводаОстатковВНА(УчитыватьФО)
	...
	Если УчитыватьФО И ПолучитьФункциональнуюОпцию("ИспользуетсяПередачаВАрендуСубарендуПоФСБУ25") Тогда
		...
		ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков инвестиции в аренду %1';
																		|en = 'OB: assets for rental investment %1'");
		ОписаниеХозяйственнойОперации.ПорядокВДереве           = ПорядокВДереве;
		ПорядокВДереве = ПорядокВДереве + 1;
	КонецЕсли;
	...
	ОписаниеХозяйственнойОперации.ШаблонЗаголовкаДокумента = НСтр("ru = 'Ввод начальных остатков вложений во внеоборотные активы %1';
																	|en = 'OB entry: cost of fixed and intangible assets %1'");
	ОписаниеХозяйственнойОперации.ПорядокВДереве           = ПорядокВДереве;
	ПорядокВДереве = ПорядокВДереве + 1;
