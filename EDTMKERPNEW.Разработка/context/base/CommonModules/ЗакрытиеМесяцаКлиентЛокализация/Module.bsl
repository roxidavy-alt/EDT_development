...
Процедура ВыполнитьКомандуЛокализации(Команда, Форма) Экспорт
	...
	//++ НЕ УТ
	Если Команда.Имя = "ОткрытьЗаданияКПогашениюСтоимостиТМЦ" Тогда
		
		ОткрытьФорму(
			"РегистрСведений.ЗаданияКПогашениюСтоимостиТМЦВЭксплуатации.ФормаСписка",
			ПараметрыФормыРегистраЗаданий(Форма));
		
	ИначеЕсли Команда.Имя = "ОткрытьЗаданияКДоначислениюНалогаНаИмущество" Тогда
		
		ОткрытьФорму(
			"РегистрСведений.ЗаданияКДоначислениюНалогаНаИмущество.ФормаСписка",
			ПараметрыФормыРегистраЗаданий(Форма));
