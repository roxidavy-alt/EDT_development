...
//  Структура - Новый описание коллекции сумм:
// * НаборыСумм - Структура. 
// * ЗначенияПоУмолчанию - Структура. 
// * ИменаВсехСвойствСтрокой - Строка.
// * ИменаСвойств - Массив. 
// * ИменаСвойствСтрокой - Строка. 
// * ИменаПеременныхНаборовСумм - Массив. 
// Пример:
...
//
// Параметры:
//  ОписаниеКоллекции - Структура - см. КоллекцииСумм.НовыйОписаниеКоллекцииСумм().
...
// Возвращаемое значение:
//  Структура - Новый коллекция сумм
...
//
// Параметры:
//  Коллекция         - Структура - коллекция сумм, доли которых надо рассчитать; должна соответствовать ОписаниеКоллекций.
//
//  ОписаниеКоллекции - Структура - см. КоллекцииСумм.НовыйОписаниеКоллекцииСумм().
//
//  Числитель         - Число
...
//
// Возвращаемое значение:
//  Структура - сконструированная функцией НовыйКоллекцияСумм(), содержит доли от переданных сумм.
// 
