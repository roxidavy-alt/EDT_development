...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	ОписаниеВарианта.Описание = НСтр("ru = 'Анализ расхождений по данными первичных документов.
		...
		|en = 'Analysis of discrepancies based on data from source documents.
		|It will show pairs of documents with detected discrepancies: dates, document numbers, amounts, and VAT.'");
	#КонецОбласти
