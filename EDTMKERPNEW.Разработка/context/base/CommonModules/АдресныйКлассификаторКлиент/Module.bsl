...
Процедура АнализДоступностиФайловКлассификатораВКаталогеЗавершение(ИндексРегиона, ДополнительныеПараметры) Экспорт
	...
	Иначе // окончание цикла
		...
		Для каждого ОтсутствующийФайл Из ДополнительныеПараметры.ОтсутствующиеФайлы Цикл
			...
			|Загрузите актуальную версию с сайта <a href=https://its.1c.ru/download/gar>https://its.1c.ru/download/gar</a>';
			|en = 'Address classifier file %2 is unavailable for %1.
			|Get the latest classifier version from <a href=https://its.1c.ru/download/gar>https://its.1c.ru/download/gar</a>'"), Представление, ОтсутствующийФайл.Значение);
