...
Функция ТекстСписаниеТоваровНаРасходы()
	...
	|	""ОтчетОСписанииТоваровСХраненияЛокализация_1775"" КАК НомерФрагмента
	|ИЗ
...
Функция ТекстСписаниеТоваровНаСтатьиАктивовПассивов()
	...
	ТекстЗапроса = СтрЗаменить(ТекстЗапроса, "РеглУчетВыборкиСерверПовтИсп_1865", "ОтчетОСписанииТоваровСХраненияЛокализация_1906");
...
Функция ТекстВозмещениеУбытковПоклажедателяНаРасходы()
	...
	|	""ОтчетОСписанииТоваровСХраненияЛокализация_716"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстВозмещениеУбытковПоклажедателяНаСтатьиАктивовПассивов()
	...
	|	""ОтчетОСписанииТоваровСХраненияЛокализация_717"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РасчетыСПоставщикамиНоваяАрхитектура КАК Расчеты
