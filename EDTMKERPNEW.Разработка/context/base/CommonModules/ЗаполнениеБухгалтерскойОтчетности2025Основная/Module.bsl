...
Функция АлгоритмыБО2025Кв1_Баланс(ПараметрыАлгоритмов)
	...
	ЗаполнениеБухгалтерскойОтчетностиПереопределяемый.ДополнитьАлгоритмыБО2025Кв1Баланс(Алгоритмы, ПараметрыАлгоритмов);
...
Процедура ЗаполнитьАлгоритмыБО2025Кв1_Баланс_Раздел2(Алгоритмы, ПараметрыЗаполнения)
	...
	АлгоритмСтроки.Составляющие.Добавить(Составляющая("+ СКД 68.91"));
	...
	АлгоритмДопСтроки.Составляющие.Добавить(Составляющая("+ СКД 68.91"));
...
Процедура ЗаполнитьАлгоритмыБО2025Кв1_Баланс_Раздел5(Алгоритмы, ПараметрыЗаполнения)
	...
	АлгоритмСтроки.Составляющие.Добавить(Составляющая("+ СКК 68.91"));
