...
//  КэшПредставлений - Соответствие из КлючИЗначение - Соответствие, где ключ - вид аналитики или строка - имя измерения. Значение - представление пустого значения, например <Прочие организации>.
...
Функция ПредставлениеСмещения(Форма, ЗначениеПустое = Ложь) Экспорт
	...
	Иначе
		...
		ПредставлениеПериод = РаботаСПериодамиКлиентСервер.ПериодЦифрамиПериодичностьПрописью(Период, Периодичность);
...
// Возвращает массив периодичностей, упорядоченных по возрастанию
//
// Возвращаемое значение:
//  Массив из ПеречислениеСсылка.Периодичность
//
...
//
// Параметры:
// 	Периодичности - Массив из ПеречислениеСсылка.Периодичность - Периодичности, из которых надо найти минимальную.
// 
// Возвращаемое значение:
