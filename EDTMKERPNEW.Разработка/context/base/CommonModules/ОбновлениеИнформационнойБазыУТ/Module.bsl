		...
		Если ЗначенияКонстант.Свойство(Источник.Метаданные().Имя, НайденноеЗначение) Тогда 
			Если Источник.Значение <> НайденноеЗначение Тогда
				ТекстСообщения = НСтр("ru = 'Значение служебной константы не соответствует ожидаемому. Запись отменена.';
										|en = 'The value of the internal constant does not match the expected one. Saving is canceled.'");
...
#Область КоличествоПотоковНеоперативнойОчередиЗаданий
	...
	Обработчик.Комментарий = НСтр("ru = 'Устанавливает количество потоков неоперативной очереди заданий';
									|en = 'Sets the number of backdate job queue threads'");
...
#Область УстановитьКонстантуПорядокРаботыПриВыполненииЗаданияВМРМК
	...
	Обработчик.Комментарий = НСтр("ru = 'Устанавливает значение константы ""Порядок работы при выполнении задания в МРМК"".';
									|en = 'Устанавливает значение константы ""Порядок работы при выполнении задания в МРМК"".'");
...
#Область АктуализироватьВидыКонтактнойИнформации
	...
	Обработчик.Комментарий = НСтр("ru = 'Обновление свойств предопределенных элементов видов контактной информации для справочника ""Помещения и территории"".';
									|en = 'Обновление свойств предопределенных элементов видов контактной информации для справочника ""Помещения и территории"".'");
