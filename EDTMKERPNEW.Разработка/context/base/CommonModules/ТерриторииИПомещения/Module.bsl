...
Процедура ПриНачальномЗаполненииЭлементов(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	ОбновлениеБЗК.ОписаниеПредопределенного(КодыЯзыков, Элементы, "СправочникТерриторииИПомещения",
		"ru = 'Контактная информация справочника ""Помещения и территории""';
		|en = '""Territories and premises"" catalog contact information'", РеквизитыГруппы);
