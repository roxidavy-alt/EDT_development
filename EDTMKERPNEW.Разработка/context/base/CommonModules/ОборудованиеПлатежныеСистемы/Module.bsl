...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = '1С:Эквайринговые терминалы Сбербанк 2.Х';
								|en = '1C:POS terminals Sberbank 2.X'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ИНПАС:Эквайринговые терминалы UNIPOS (ФЗ-491) версия 2.0';
								|en = 'INPAS:UNIPOS POS terminals (491-FZ) version 2.0'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ПБФ:Эквайринговые терминалы';
								|en = 'PBF:POS terminals'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Надекс:Эквайринговые терминалы';
								|en = 'Nadeks:POS terminals'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
