...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	""ОтчетКомитентуЛокализация_675"" КАК НомерФрагмента
	|
	|ИЗ
	...
	|	""ОтчетКомитентуЛокализация_676"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""ОтчетКомитентуЛокализация_677"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""ОтчетКомитентуЛокализация_678"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""ОтчетКомитентуЛокализация_679"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	ТекстыОтражения.Добавить(РеглУчетВыборкиСерверПовтИсп.ТекстВыручкаОтРеализации()); // Комиссионное вознаграждение (Дт 62.01 :: Кт 90.01)
	ТекстыОтражения.Добавить(РеглУчетВыборкиСерверПовтИсп.ТекстНачислениеНДССВыручки()); // НДС с комиссионного вознаграждения (Дт 62.01 :: Кт 90.01)
