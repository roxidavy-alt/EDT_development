...
Процедура ИсправитьПроблемыВДвиженияхИДокументах(ПараметрыРасчета)
	...
	РасшифровкаКодовОшибок.Вставить(8, НСтр("ru = 'Аналитика учета партий не содержит вида ценности';
											|en = 'Dimension (Lot accounting) does not contain an asset tax class'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(9, НСтр("ru = 'Кор. аналитика учета партий не содержит вида ценности';
											|en = 'Dimension (Lot accounting) does not contain asset tax class'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(14, НСтр("ru = 'Не заполнен вид деятельности НДС у приходных движений с типом записи ""Партия""';
											|en = 'VAT activity type is not specified for receipt records with the ""Lot"" record type'", ОбщегоНазначения.КодОсновногоЯзыка()));
	//++ НЕ УТ
	...
	РасшифровкаКодовОшибок.Вставить(20, НСтр("ru = 'Не заполнена кор. аналитика учета партий приходных движений с типом записи ""Партия"" или ""Корректировка приобретения"" для организаций с методом оценки, отличным от ""ФИФО (скользящая)""';
											|en = 'Corr. dimension (Lot accounting) of receipt record with the ""Lot"" or ""Purchase adjustment"" record type is not filled in for companies using an evaluation method different form ""FIFO (rolling valuation)""'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(21, НСтр("ru = 'Не заполнен период продажи для операции ""Возврат товаров от клиента прошлых периодов""';
											|en = 'Sale period is required for the ""Sales return of previous periods"" operation'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(25, НСтр("ru = 'Не заполнена кор. аналитика учета партий в приходных движениях с типом записей ""Доп. расходы (не указана партия)"" и ""Доп. расходы (указана партия)""';
											|en = 'Corr. dimension (Lot accounting) is required for receipt movements with the ""Add. expenses (lot is not specified)"" and ""Add. expenses (lot is specified)"" record types'", ОбщегоНазначения.КодОсновногоЯзыка()));
	//++ НЕ УТ
	РасшифровкаКодовОшибок.Вставить(26, НСтр("ru = 'В движениях по распределению материалов в отчете переработчика заполнен реквизит ""Группа продукции"".';
											|en = '""Inventory group"" attribute is filled in material allocation movements in ""Subcontracting services notification received"".'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(27, НСтр("ru = 'В движениях по выпуску продукции отличается заполнение реквизитов ""Аналитика финансового учета"" и ""Группа продукции"".';
											|en = 'In product release movements, the ""Financial accounting dimension"" and ""Inventory group"" attributes are filled in differently.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	//-- НЕ УТ
	...
	РасшифровкаКодовОшибок.Вставить(30, НСтр("ru = 'Не корректно заполнен кор. вид деятельности НДС для документа ""Таможенная декларация на импорт"".';
											|en = 'The cor VAT activity type is filled incorrectly for the ""Customs declaration for import"" document.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(39, НСтр("ru = 'Неправильный вид движения документа ""Отражение прочих доходов и расходов"".';
											|en = 'Wrong kind of register records of the ""Non-operating income and expenses"" document.'"));
	РасшифровкаКодовОшибок.Вставить(40, НСтр("ru = 'Неправильный раздел учета для товаров на хранении с правом продажи.';
											|en = 'Incorrect accounting section for goods at storage with the right of sale.'"));
	...
	РасшифровкаКодовОшибок.Вставить(44, НСтр("ru = 'Вид деятельности НДС в приходном движении не соответствует партии производства.';
											|en = 'VAT activity type in receipt record does not match production lot.'"));
	//-- НЕ УТ
	...
	РасшифровкаКодовОшибок.Вставить(49, НСтр("ru = 'Неправильный раздел учета ""Товары в пути (отгрузка без перехода права собственности)"" для комиссионных товаров.';
											|en = 'Incorrect accounting section ""Goods in transit (shipment with deferred transfer of title of goods)"" for consignment goods.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	//++ НЕ УТ
	РасшифровкаКодовОшибок.Вставить(51, НСтр("ru = 'Не правильный раздел учета в движениях списания комиссионного товара.';
											|en = 'Incorrect accounting section in the consigned goods write-off records.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	//-- НЕ УТ
	...
	РасшифровкаКодовОшибок.Вставить(55, НСтр("ru = 'Неправильный раздел учета для товаров в пути от поставщиков.';
											|en = 'Incorrect accounting section for the goods in transit from vendors.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(59, НСтр("ru = 'Не корректно заполнен кор. вид деятельности НДС в расходном движении ""Реализация (только регл. учет)"".';
											|en = 'The cor. VAT activity type in the ""Sales (only local accounting)"" expense record is filled in incorrectly.'"));
	...
	РасшифровкаКодовОшибок.Вставить(62, НСтр("ru = 'Неправильный знак у количества для операции ""Возврат товаров от клиента прошлых периодов""';
											|en = 'Invalid quantity sign for the ""Sales return of previous periods"" operation'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(63, НСтр("ru = 'Не заполнена аналитика учета партий в движениях документа ""Корректировка приобретения"".';
											|en = 'Dimension (Lot accounting) of register records of the ""Purchase adjustment"" document is not filled.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(66, НСтр("ru = 'Не заполнена операция учета себестоимости в движениях себестоимости товаров.';
											|en = 'Cost accounting transaction is not filled in inventory cost register records.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(70, НСтр("ru = 'Не заполнен вид деятельности НДС при возврате от клиента по указанной стоимости';
											|en = 'The VAT activity type is not filled upon sales return at the specified cost'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(72, НСтр("ru = 'Не правильная хозяйственная операция для выпуска по фикс. стоимости в регистре ""Прочие расходы"".';
											|en = 'Incorrect business transaction for product release at fixed cost in the ""Other expenses"" register.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(75, НСтр("ru = 'Не правильный тип записи для сторно движения фактуровки поставки в регистре ""Себестоимость товаров"".';
											|en = 'Incorrect record type for the storno record for the invoice entry in the ""Inventory cost"" register.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(82, НСтр("ru = 'Не корректно заполнено место хранения в регистре ""Отклонения в стоимости товаро"".';
											|en = 'Storage location is filled incorrectly in the ""Goods cost variances"" register.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(83, НСтр("ru = 'Не корректно заполнен период отклонений для корректировки приобретения прошлого периода в регистре ""Отклонения в стоимости товаров"".';
											|en = 'Variance period for the previous period purchase adjustment is filled incorrectly in the ""Goods cost variances"" register.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(91, НСтр("ru = 'Не заполнен реквизит ""Документ движения"" в движениях отчета давальцу между организациями.';
											|en = 'The ""Transfer record"" attribute is required for records of Intercompany consumption report — Subcontracting services delivered.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(92, НСтр("ru = 'Не заполнен идентификатор строки в движениях документа ""Таможенная декларация на импорт"".';
											|en = 'The line ID in the ""Customs import declaration"" document register records is not filled in.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(93, НСтр("ru = 'Не заполнен реквизит ""Период отклонения"" в сторно движениях по регистру ""Себестоимость товаров"".';
											|en = 'The ""Variance period"" attribute is not filled in storno records of the ""Cost of goods sold"" register.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(94, НСтр("ru = 'Не заполнен реквизит ""Период отклонения"" в сторно движениях по регистру ""Прочие расходы"".';
											|en = 'The ""Variance period"" attribute is not filled in storno records of the ""Other expenses"" register.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(95, НСтр("ru = 'Не заполнен реквизит ""Период отклонения"" в сторно движениях по регистру ""Партии прочих расходов"".';
											|en = 'The ""Variance period"" attribute is not filled in storno records of the ""Material overheads for allocation"" register.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(96, НСтр("ru = 'Не корректно заполнен кор. вид деятельности НДС в расходном движении ""Реализация (товары в пути)"".';
											|en = 'The cor. VAT activity type in the ""Customer invoice — Goods-in-transit"" expense record is filled in incorrectly.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(97, НСтр("ru = 'Не корректно заполнен вид деятельности НДС в движениях документа ""Возврат товаров поставщику"".';
											|en = 'The VAT activity type in the ""Return of goods to vendor"" document register records is filled in incorrectly.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(98, НСтр("ru = 'Заполнены различные коды строк в аналитике учета партии приходного документа при одинаковых аналитиках в строках документа';
											|en = 'Different line codes are filled in the lot accounting dimension of the incoming document for the same dimensions in the document lines'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(99, НСтр("ru = 'Не заполнен реквизит ""Заказ клиента"" в движениях реализации товаров и услуг.';
											|en = 'The ""Sales order"" attribute is not filled in the customer invoice register records.'", ОбщегоНазначения.КодОсновногоЯзыка()));
...
//-- НЕ УТ
	...
	РасчетСебестоимостиПрикладныеАлгоритмы.ПерепровестиДокументыПоОтдельнымРегистрамНакопления(
		...
		НСтр("ru = 'некорректное заполнение сумм упр. учета';
			|en = 'amounts, mgmt are filled in incorrectly'", ОбщегоНазначения.КодОсновногоЯзыка()));
...
//-- НЕ УТКА
	...
	РасшифровкаКодовОшибок.Вставить(1, НСтр("ru = 'Неправильная операция учета себестоимости в движениях документа ""Корректировка приобретения"".';
											|en = 'Incorrect cost accounting transaction in the ""Purchase adjustment"" document register records'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(3, НСтр("ru = 'Лишние движения по регистру ""Движения Прочие активы и пассивы"" у документа ""Корректировка приобретения"".';
											|en = 'Extra records of the ""Purchase adjustment"" document in the ""Other assets and liabilities records"" register.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(1, НСтр("ru = 'Некорректные движения по документу ""Корректировка реализации"" в регистре ""Прочие расходы""';
											|en = 'incorrect register records in the ""Sales adjustment"" document of the ""Other expenses"" register'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(1, НСтр("ru = 'Неправильное движение в документе ""Производство без заказа"".';
											|en = 'Incorrect register record in the ""Backflush production"" document.'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	//++ НЕ УТ
	РасшифровкаКодовОшибок.Вставить(3, НСтр("ru = 'Неправильное движение возврата на другой склад в документе ""Возврат давальцу"".';
	...
	РасшифровкаКодовОшибок.Вставить(2, НСтр("ru = 'Отражение статей с вариантом распределения ""На себестоимость товаров"" в регистре ""Партии прочих расходов"" не соответствует учетной политике организации';
											|en = 'Recording items with allocation option ""To inventory cost"" in the ""Material overheads for allocation"" register does not correspond to the company accounting policy'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(3,
		НСтр("ru = 'Отличаются суммы в движения по регистру ""Отклонения в стоимости товаров"" от регистра ""Закупки""';
			|en = 'Amounts in the ""Goods cost variances"" register records differ from amounts in the ""Purchases"" register records'",
			ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(1,
		НСтр("ru = 'Отличаются суммы в движениях по регистру ""Себестоимость товаров"" от регистра ""Движения по акцизам""';
			|en = 'Amounts in the ""Inventory cost"" register records differ from amounts in the ""Register records by excises"" register records'",
			ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(2,
		НСтр("ru = 'Отличаются суммы в движения по регистру ""Отклонения в стоимости товаров"" от регистра ""Движения по акцизам""';
			|en = 'Amounts in the ""Goods cost variances"" register records differ from amounts in the ""Register records by excises"" register records'",
			ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасчетСебестоимостиПрикладныеАлгоритмы.ПерепровестиДокументыПоОтдельнымРегистрамНакопления(
		...
		НСтр("ru = 'исправление движений на сумму акциза по регистру ""Себестоимость товаров"".';
			|en = 'correct records for the excise amount in the ""Inventory cost"" register.'",
			ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасшифровкаКодовОшибок.Вставить(1,
		НСтр("ru = 'Сформированы некорректные движения по регистру ""Отклонения в стоимости товаров""';
			|en = 'Incorrect records are created in the ""Goods cost variances"" register'", ОбщегоНазначения.КодОсновногоЯзыка()));
	РасшифровкаКодовОшибок.Вставить(2,
		НСтр("ru = 'Движения по регистру ""Отклонения в стоимости товаров"" не требуются для используемой учетной политики';
			|en = 'The accounting policy does not require the ""Goods cost variances"" register records'", ОбщегоНазначения.КодОсновногоЯзыка()));
	...
	РасчетСебестоимостиПрикладныеАлгоритмы.ПерепровестиДокументыПоОтдельнымРегистрамНакопления(
		...
		НСтр("ru = 'исправление движений документов по регистру ""Отклонения в стоимости товаров"".';
			|en = 'Adjusting document records in the ""Goods cost variances"" register.'",
			ОбщегоНазначения.КодОсновногоЯзыка()));
