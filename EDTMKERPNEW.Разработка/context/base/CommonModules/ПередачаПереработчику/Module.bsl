...
Функция ТекстЗапросаЗаполненияНаОснованияЗаказа() Экспорт
	...
	|ИЗ
	|	РегистрНакопления.РаспоряженияНаОтгрузкуИВозврат.Обороты(,,, Распоряжение = &ДокументОснование) КАК РаспоряженияНаОтгрузкуОбороты";
...
//  
Процедура ЗаполнитьПризнакЦеховаяКладоваяВТаблице(Объект, Строки = Неопределено) Экспорт
...
Функция СформироватьГиперссылкуКОформлению(Параметры) Экспорт
	...
	ЕстьПраваНаЧтение = ПравоДоступа("Чтение", Метаданные.РегистрыНакопления.РаспоряженияНаОтгрузкуИВозврат)
