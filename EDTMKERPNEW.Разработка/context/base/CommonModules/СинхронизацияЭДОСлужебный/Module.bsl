...
Процедура ОтправитьЭлектронныеДокументыПоРасписанию() Экспорт
	...
	Исключение
		...
		Операция = НСтр("ru = 'Регламентная отправка оформленных электронных документов.';
						|en = 'Scheduled sending of registered electronic documents.'");
...
#Область РегистрыСведений_СертификатыУчетныхЗаписейЭДО_ОбработатьДанныеДляПереходаНаНовуюВерсию
	...
	Обработчик.Комментарий = НСтр("ru = '1С:Обмен с контрагентами:  заполнение должностей сотрудников использующих сертификаты.';
									|en = '1С:Обмен с контрагентами:  заполнение должностей сотрудников использующих сертификаты.'");
