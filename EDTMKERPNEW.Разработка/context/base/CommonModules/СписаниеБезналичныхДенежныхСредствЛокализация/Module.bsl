...
Процедура ПередЗаписью(Объект, Отказ, РежимЗаписи, РежимПроведения) Экспорт
	...
	Если НЕ Объект.ПлатежиПо275ФЗ Тогда
		НеиспользуемыеРеквизиты.Добавить("ТипПлатежаФЗ275");
	КонецЕсли;
	//-- НЕ УТ
...
#Область ТекстОплатаАвансаПоставщикуДругойОрганизации // Дт 60.22 :: Кт 52, Дт 60.02 :: Кт 51
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1867"" КАК НомерФрагмента
	|
	|ИЗ
...
#Область ТекстОплатаДолгаПоставщикуДругойОрганизации // Дт 60.21 :: Кт 52, Дт 60.01 :: Кт 51
	...
	|	КОНЕЦ КАК Содержание,
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1868"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВозвратКлиентуАвансаПогашениеДолга
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1869"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВозвратКлиентуДС
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1870"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстСнятиеНаличныхВБанке
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1264"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПеречислениеДСНаДругойСчет
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1265"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВозвратОплатыПоЭквайрингу // (Дт 57.03 :: Кт 52, 51)
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1266"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстКомиссияПоОперациямЭквайринга
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1267"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстКонвертацияВалюты
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1268"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПлатежСКонвертациейВалюты
	...
	|	0 КАК СуммаВРКт,
	|	""Конвертация валюты"" КАК Содержание,
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1269"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПлатежСКонвертациейПрочиеДоходы    // (Дт 57:: Кт 91.1)
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1270"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПлатежСКонвертациейПрочиеРасходы   // (Дт 91.2 :: Кт 57)
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1271"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВнутренняяПередачаДС
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1272"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПеречислениеНалогов
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1273"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПеречислениеНДСВБюджетПоОтдельнымОперациям
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1274"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстНалогиОбособленногоПодразделения
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1275"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Перечисление налога (обособленное подразделение)"" КАК Содержание,
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1276"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстНДСВБюджетОбособленногоПодразделения
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1277"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Перечисление НДС в бюджет (обособленное подразделение)"" КАК Содержание,
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1278"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область РасчетыПоКредитамЗаймам // (Дт 66.01, 66.02, 76.09 :: Кт 51)
	...
	|	КОНЕЦ КАК Содержание,
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1871"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПереводНаДепозит           // (Дт 55.03 :: Кт 51)
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1279"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыдачаЗайма                     // (Дт 58.03 :: Кт 51)
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1280"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыдачаЗаймаСотруднику           // (Дт 73.01 :: Кт 51)
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1281"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВозвратКлиентуЗалогаЗаТару
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1282"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВыдачаПодотчетникуЧерезДСВПути // Дт 57.21 :: Кт 52, Дт 57.01 :: Кт 51
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1283"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВыдачаПодотчетнику // Дт 71.21 :: Кт 52, Дт 71.01 :: Кт 51
	...
	|	0 КАК СуммаВРКт,
	|	""Выдача подотчетнику"" КАК Содержание,
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1284"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВыплатаЗарплатыНаЛицевыеСчета // (Дт 70 :: Кт 51)
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1285"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВыплатаЗарплатыПоЗарплатномуПроекту // (Дт 70 :: Кт 51)
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1286"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВыплатаЗарплатыПоЗарплатномуПроектуЧерезПереводыВПути // (Дт 57.01 :: Кт 51)
	...
	|	0 КАК СуммаВРКт,
	|	""Выплата зарплаты по зарплатному проекту"" КАК Содержание,
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1287"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПрочиеРасходы
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1288"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПрочееСписание
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1289"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОплатаАрендодателю
	...
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1290"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Процедура ЗаполнитьРеквизитыЗначениямиПоУмолчанию(Объект)
	...
	Если Не ЗначениеЗаполнено(Объект.БанковскийСчет) Тогда
		...
		Объект.БанковскийСчет = ДенежныеСредстваСервер.ПолучитьБанковскийСчетОрганизацииПоУмолчанию(
			СтруктураПараметров, , Перечисления.ФормыОплаты.Безналичная);
...
// 
// Параметры:
//  Объект - ДокументОбъект.СписаниеБезналичныхДенежныхСредств - Этот объект
...
Процедура ПроверитьПлатежныеСсылкиЗаявок(Объект, Отказ)
	...
	Если Не Запрос.Выполнить().Пустой() Тогда
		...
		ТекстСообщения = НСтр("ru = 'Различные платежные ссылки СБП в заявках';
								|en = 'Different FPS payment links in requests'");
...
Функция ТекстОплатаДолгаАвансаПоставщикуДругойОрганизацииМежФилиальная()
	...
	|		ИНАЧЕ ""Оплата аванса поставщику""
	|	КОНЕЦ КАК Содержание,
	|	""СписаниеБезналичныхДенежныхСредствЛокализация_1872"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
