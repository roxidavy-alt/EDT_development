...
Функция ЗаголовокРеквизитаПартнерВЗависимостиОтХозяйственнойОперации(ХозяйственнаяОперация, ОбратнаяОперация = Ложь) Экспорт
	...
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПроизводствоИзДавальческогоСырья2_5 Тогда
		ЗаголовокПартнер = НСтр("ru = 'Давалец';
								|en = 'Material provider'");
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ПроизводствоПродукцииИзДавальческогоСырья2_5 Тогда
		ЗаголовокПартнер = НСтр("ru = 'Давалец';
								|en = 'Material provider'");
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.РемонтПродукцииИзДавальческогоСырья2_5 Тогда
		ЗаголовокПартнер = НСтр("ru = 'Давалец';
								|en = 'Material provider'");
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВыполнениеРаботСИспользованиемДавальческогоСырья2_5 Тогда
		ЗаголовокПартнер = НСтр("ru = 'Давалец';
								|en = 'Material provider'");
	ИначеЕсли ХозяйственнаяОперация = Перечисления.ХозяйственныеОперации.ВыполнениеРемонтныхРаботСИспользованиемДавальческогоСырья2_5 Тогда
		ЗаголовокПартнер = НСтр("ru = 'Давалец';
								|en = 'Material provider'");
