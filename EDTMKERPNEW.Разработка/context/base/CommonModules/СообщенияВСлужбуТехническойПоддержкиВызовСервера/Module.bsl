	...
	Если Ошибки.Количество() > 0 Тогда
		...
		СообщенияВСлужбуТехническойПоддержки.ЗаписатьИнформациюВЖурналРегистрации(
			СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(
				...
				|%1';
				|en = 'В служебный метод СообщенияВСлужбуТехническойПоддержкиВызовСервера.ПодготовитьСообщение переданы вложения с видом данных ИмяФайла.
				|Вложения с недопустимым видом:
				|%1'"),
		...
		Результат.Вставить(
			...
			НСтр("ru = 'Передано недопустимое вложение. Подробности см. в журнале регистрации.';
				|en = 'Передано недопустимое вложение. Подробности см. в журнале регистрации.'"));
