...
Процедура ДобавитьГруппуОператоровСтроковыеФункции(СписокОператоров)
	...
	ДобавитьОператорВГруппу(Группа, "Лев", НСтр("ru = 'Строка слева';
												|en = 'Left string'"), Тип, Истина);
	ДобавитьОператорВГруппу(Группа, "Прав", НСтр("ru = 'Строка справа';
												|en = 'Right string'"), Тип, Истина);
	...
	ДобавитьОператорВГруппу(Группа, "Сред", НСтр("ru = 'Часть строки';
												|en = 'String part'"), Тип, Истина);
