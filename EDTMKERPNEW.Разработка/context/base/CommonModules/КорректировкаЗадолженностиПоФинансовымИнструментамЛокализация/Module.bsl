...
#Область ТекстРезервыПоСомнительнымДолгам
	...
	|	""КорректировкаЗадолженностиПоФинансовымИнструментамЛокализация_434"" КАК НомерФрагмента
	|
	|ИЗ
...
#Область ТекстДебиторскаяЗадолженность
	...
	|	""КорректировкаЗадолженностиПоФинансовымИнструментамЛокализация_435"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстДебиторскаяЗадолженностьНаСтатьиАктивовПассивов
	...
	|	""КорректировкаЗадолженностиПоФинансовымИнструментамЛокализация_436"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстКредиторскаяЗадолженность
	...
	|	0 КАК СуммаВРКт,
	|	""Списание задолженности"" КАК Содержание,
	|	""КорректировкаЗадолженностиПоФинансовымИнструментамЛокализация_437"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстКредиторскаяЗадолженностьНаСтатьиАктивовПассивов
	...
	|	0 КАК СуммаВРКт,
	|	""Списание задолженности на активы/пассивы"" КАК Содержание,
	|	""КорректировкаЗадолженностиПоФинансовымИнструментамЛокализация_438"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстСписаниеВУбытокЗадолженностиЗабаланс
	...
	|	""КорректировкаЗадолженностиПоФинансовымИнструментамЛокализация_439"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
