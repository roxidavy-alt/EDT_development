...
#Область ТекстРеализацияКомисионногоТовара       // (Дт 62.01 :: Кт 76.ОК)
	...
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_785"" КАК НомерФрагмента
	|
	|ИЗ
...
#Область ТекстПередачаНаКомиссию                 // (Дт 45 :: Кт 41)
	...
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_786"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПередачаНаКомиссиюСкладПроизводства // (Дт 45 :: Кт 20)
	...
	|	ЕСТЬNULL(Стоимости.СуммаВР, Строки.СуммаВР) КАК СуммаВРКт,
	|	""Передача товаров на комиссию"" КАК Содержание,
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_787"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПередачаНаСубкомиссию              // (Дт 004.02 :: Кт 004.01)
	...
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_788"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПоступлениеУслуг                   // (Дт 44 :: Кт 60, 76)
	...
	|	Операция.Дата КАК Период,
	|	Расчеты.Организация КАК Организация,
	|	Операция.ОбъектРасчетовПолучателя.УникальныйИдентификатор КАК ИдентификаторСтроки,
	|
	...
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_789"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Поступление услуг"" КАК Содержание,
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_790"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПоступлениеТоваров                 // (Дт 41 :: Кт 60, 76)
	...
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_791"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПоступлениеТоваровСоСписаниемНаРасходы    // (Дт 2Х, 44, 91 :: Кт 60, 76)
	...
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_792"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПоступлениеТоваровСкладПроизводства // (Дт 20 :: Кт 60, 76)
	...
	|	0 КАК СуммаВРКт,
	|	""Поступление товаров"" КАК Содержание,
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_793"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПоступлениеУслугНДС         // (Дт 19.4 :: Кт 60, 76)
	...
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_794"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""НДС при приобретении"" КАК Содержание,
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_795"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""НДС при приобретении"" КАК Содержание,
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_796"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПоступлениеТоваровНДС         // (Дт 19.3 :: Кт 60, 76)
	...
	|	0 КАК СуммаВРКт,
	|	""НДС при приобретении"" КАК Содержание,
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_797"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВключениеИсключениеНДСВСтоимость   // (Дт 90.02.1 :: Кт 19.03)
	...
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_798"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстПродажаАгентскихУслуг   // (Дт 62.01 :: Кт 76.09)
	...
	|	""ПередачаТоваровМеждуОрганизациямиЛокализация_799"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#КонецОбласти
	...
	ТекстыОтражения.Добавить(РеализацияТоваровУслугЛокализация.ТекстНачислениеАкцизов()); // Начисление акцизов (Дт 90.04 :: Кт 68.03)
	ТекстыОтражения.Добавить(РеглУчетВыборкиСерверПовтИсп.ТекстВыручкаОтРеализации()); // Задолженность покупателя (Дт 62.01 :: Кт 90.01)
	ТекстыОтражения.Добавить(РеглУчетВыборкиСерверПовтИсп.ТекстНачислениеНДССВыручки()); // Начисление НДС по товарам (Дт <90.3, 91.2> :: Кт <68.2>)
	ТекстыОтражения.Добавить(РеглУчетВыборкиСерверПовтИсп.ТекстСебестоимостьПродаж()); // Себестоимость товаров (Дт 90.02 :: Кт 41.01, 20)
