...
Функция ВидКонтролирующегоОрганаПоИмениФормы(Знач ИмяФормыОтчета) Экспорт
	...
	Исключение
		ЗаписьЖурналаРегистрации(
			НСтр("ru = 'Ошибка при получении вида контролирующего органа для отчета: %1';
				|en = 'Ошибка при получении вида контролирующего органа для отчета: %1'", ОбщегоНазначения.КодОсновногоЯзыка()),
			УровеньЖурналаРегистрации.Ошибка, ,
			ИмяФормыОтчета,
