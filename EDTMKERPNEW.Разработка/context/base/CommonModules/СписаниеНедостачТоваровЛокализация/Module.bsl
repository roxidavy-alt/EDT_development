...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	ТекстыОтражения.Добавить(СписаниеАкцизовНаРасходы()); // Списание акцизов на прочие расходы (Дт 91.02 :: Кт 68.03)
...
Функция ТекстВключениеИсключениеНДСВСтоимостьРасходовАктивовПассивов()
	...
	|	""СписаниеНедостачТоваровЛокализация_1873"" КАК НомерФрагмента
	|ИЗ
...
// Функция возвращает текст фрагмента списания акцизов на расходы.
//
// Возвращаемое значение:
//	Строка - сформированный текст запроса.
//
Функция СписаниеАкцизовНаРасходы() Экспорт
	
	ТекстЗапроса = "
	|////////////////////////////////////////////////////////////////////////////////////////////////////
	|// Списание акцизов на расходы (Дт 91.02 :: Кт 68.03)
	|ВЫБРАТЬ
	...
	|	0 КАК СуммаПРКт,
	|	0 КАК СуммаВРКт,
	|	""Списание акцизов на расходы"" КАК Содержание,
	|	""СписаниеНедостачТоваровЛокализация_1940"" КАК НомерФрагмента
	|ИЗ
	|
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|		И ЕСТЬNULL(СтрокиДт.АналитикаУчетаНоменклатуры.Номенклатура, СтрокиКт.Номенклатура) = СтрокиКт.Номенклатура
