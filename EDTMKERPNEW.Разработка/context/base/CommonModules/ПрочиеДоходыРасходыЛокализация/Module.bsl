...
#Область РегистрацияПрочихРасходов
	...
	|	""ПрочиеДоходыРасходыЛокализация_1021"" КАК НомерФрагмента
	|ИЗ
...
#Область СписаниеПрочихРасходов
	...
	|	""ПрочиеДоходыРасходыЛокализация_1022"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область СторнированиеПрочихРасходов
	...
	|	""ПрочиеДоходыРасходыЛокализация_1023"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область РегистрацияПрочихДоходов
	...
	|	""ПрочиеДоходыРасходыЛокализация_1024"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область СторнированиеПрочихДоходов
	...
	|	""ПрочиеДоходыРасходыЛокализация_1025"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область РеклассификацияРасходов
	...
	|	""ПрочиеДоходыРасходыЛокализация_1026"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область РеклассификацияДоходов
	...
	|	""ПрочиеДоходыРасходыЛокализация_1027"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	Строки.ВременнаяРазница КАК СуммаВРКт,
	|	""Реклассификация доходов"" КАК Содержание,
	|	""ПрочиеДоходыРасходыЛокализация_1028"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ПеремещениеРасходовМеждуФилиалами
	...
	|	""ПрочиеДоходыРасходыЛокализация_1029"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
