...
Процедура СохранитьДвиженияСформированныеОтложенно(НаборЗаписей, Замещение, ВидИсточника, ИсключитьНастройкиХО = Неопределено) Экспорт
	...
	Если РежимЗамещенияЗаписей = РежимЗамещения.Слияние Тогда
		ТекстОшибки = СтрШаблон(НСтр("ru = 'В процедуре не поддерживается режим записи ""%1""';
									|en = 'The ""%1"" record mode is not supported in this procedure'"), РежимЗамещенияЗаписей);
...
Функция УчетныеМеханизмыКонфигурации() Экспорт
	...
	//++ НЕ УТКА
	МеханизмыКонфигурации.Вставить("СостоянияЗаявокНаКонтрольКачества", "РегистрыСведений.СостоянияЗаявокНаКонтрольКачества");
	//-- НЕ УТКА
...
Процедура ПриДобавленииОбработчиковОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр("ru = 'Очищает кэш запросов проведения документов.';
									|en = 'Clears the cache of document posting queries.'");
