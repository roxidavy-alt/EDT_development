...
// Дополняет список команд ЭДО легкого интерфейса командами других подсистем БЭД.
//
// Параметры:
//  КомандыЭДО - См. ПодключаемыеКомандыЭДОСлужебный.СоздатьКоллекциюКомандЭДО
//
Процедура ПриОпределенииСпискаКомандЭДОЛегкогоИнтерфейса(КомандыЭДО) Экспорт
	ЛегкийИнтерфейсДокументовЭДО.ПриОпределенииСпискаКомандЭДО(КомандыЭДО);
КонецПроцедуры
