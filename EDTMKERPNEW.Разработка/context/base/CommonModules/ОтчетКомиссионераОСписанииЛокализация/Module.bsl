...
#Область ТекстСписаниеКомиссионныхТоваров
	...
	|	""ОтчетКомиссионераОСписанииЛокализация_668"" КАК НомерФрагмента
	|
	|ИЗ
...
#Область ТекстОтражениеВзаиморасчетовПоКомиссионномуТовару
	...
	|	""ОтчетКомиссионераОСписанииЛокализация_669"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОтражениеПрочихДоходов
	...
	|	""ОтчетКомиссионераОСписанииЛокализация_670"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстСписаниеСебестоимостиТовара
	...
	|	""ОтчетКомиссионераОСписанииЛокализация_671"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВключениеИсключениеНДСВСтоимостьРасходов // (Дт 25, 26, 44 :: Кт 19.03)
	...
	|	""ОтчетКомиссионераОСписанииЛокализация_672"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
