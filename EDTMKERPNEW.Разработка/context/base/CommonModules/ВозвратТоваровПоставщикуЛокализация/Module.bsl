...
Функция ТекстЗапросаТаблицаОперацииСПрослеживаемымиТоварамиРасширенный(Запрос, ТекстыЗапроса, Регистры)
	...
	|	ВЫБОР
	|		КОГДА ВЫРАЗИТЬ(ТаблицаВидыЗапасов.ДокументПоступления КАК Документ.ПриобретениеТоваровУслуг).ХозяйственнаяОперация В (&ХозОперацииЗакупкаВСтранахЕАЭС)
...
Функция ТекстВозвратСебестоимостиПретензииСтарыеВзаиморасчеты()
	...
	|	""ВозвратТоваровПоставщикуЛокализация_319"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстВозвратСебестоимостиПретензииНовыеВзаиморасчеты()
	...
	|	Строки.СуммаВР КАК СуммаВРКт,
	|	""Возврат себестоимости"" КАК Содержание,
	|	""ВозвратТоваровПоставщикуЛокализация_320"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстВозвратНДСПретензииСтарыеВзаиморасчеты()
	...
	|	""ВозвратТоваровПоставщикуЛокализация_321"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстВозвратНДСПретензииНовыеВзаиморасчеты()
	...
	|	0 КАК СуммаВРКт,
	|	""Возврат НДС"" КАК Содержание,
	|	""ВозвратТоваровПоставщикуЛокализация_322"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстПереносПретензииНаРасчетыСтарыеВзаиморасчеты()
	...
	|	""ВозвратТоваровПоставщикуЛокализация_323"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	""ВозвратТоваровПоставщикуЛокализация_324"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстПереносПретензииНаРасчетыНовыеВзаиморасчеты() Экспорт
	...
	|	""ВозвратТоваровПоставщикуЛокализация_1705"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстОтклонениеВСтоимостиРасходы()
	...
	|	""ВозвратТоваровПоставщикуЛокализация_325"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстОтклонениеВСтоимостиДоходы()
	...
	|	""ВозвратТоваровПоставщикуЛокализация_326"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстВключениеИсключениеНДСВСтоимость()
	...
	|	""ВозвратТоваровПоставщикуЛокализация_327"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстВозвратНеСобственногоТовара()
	...
	|	КОНЕЦ КАК Содержание,
	|	""ВозвратТоваровПоставщикуЛокализация_1706"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
