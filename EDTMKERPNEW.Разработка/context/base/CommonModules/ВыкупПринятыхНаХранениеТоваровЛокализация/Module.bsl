...
Функция ТекстВыкупТоваров()
	...
	|	""ВыкупПринятыхНаХранениеТоваровЛокализация_1707"" КАК НомерФрагмента
	|
	|ИЗ
...
Функция ТекстВыкупТоваровПереданныхНаХранение()
	...
	|		ИНАЧЕ ""Выкуп товаров на склад""
	|	КОНЕЦ КАК Содержание,
	|	""ВыкупПринятыхНаХранениеТоваровЛокализация_1708"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстВыкупТоваровЗаБалансом()
	...
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	|	КОНЕЦ КАК Содержание,
	|	""ВыкупПринятыхНаХранениеТоваровЛокализация_1709"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстВходящийНДС()
	...
	|	""ВыкупПринятыхНаХранениеТоваровЛокализация_341"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
