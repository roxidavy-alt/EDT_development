	...
	Иначе // пробросим таблицы данных для последующего отражения после записи движений документа
		...
		Если ПолучитьФункциональнуюОпцию("ФормироватьПроводкиМеждународногоУчетаПоДаннымРегламентированного") Тогда
			...
			Если ТаблицыДляДвижений.Свойство("ТаблицаВыборочнойРегистрацииКОтражению") Тогда
				Движения.ОтражениеДокументовВМеждународномУчете.ДополнительныеСвойства.Вставить(
					"ТаблицаВыборочнойРегистрацииКОтражениюМеждународныйУчет",
		...
		Если ТаблицыДляДвижений.Свойство("ТаблицаВыборочнойРегистрацииКОтражениюМеждународныйУчет") Тогда
			Движения.ОтражениеДокументовВМеждународномУчете.ДополнительныеСвойства.Вставить(
				"ТаблицаВыборочнойРегистрацииКОтражениюМеждународныйУчет",
				ТаблицыДляДвижений.ТаблицаВыборочнойРегистрацииКОтражениюМеждународныйУчет);
		КонецЕсли;
...
Процедура ЗарегистрироватьКОтражению(Объект, ДополнительныеСвойства, Движения, Отказ = Ложь) Экспорт
	...
	ТаблицаВыборочнойРегистрации = ТаблицаВыборочнойРегистрацииКОтражению();
	Если ДвиженияОтражениеДокументовВМеждународномУчете.ДополнительныеСвойства.Свойство("ТаблицаВыборочнойРегистрацииКОтражениюМеждународныйУчет") Тогда
		ВыборочнаяРегистрация = Истина;
		ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(
			ДвиженияОтражениеДокументовВМеждународномУчете.ДополнительныеСвойства.ТаблицаВыборочнойРегистрацииКОтражениюМеждународныйУчет,
	...
	МеждународныйУчетПоДаннымРеглУчета.ДополнитьТаблицыРегистрацииКОтражению(
		Объект, ДополнительныеСвойства, ДвиженияОтражениеДокументовВМеждународномУчете.ДополнительныеСвойства, ТаблицаРегистрации);
...
Процедура ЗаписатьНовыйСтатусОтражения(МассивДокументов, НовыйСтатусОтражения, СтарыеСтатусыОтражения) Экспорт
	...
	Попытка
		...
		|	КОНЕЦ КАК Статус,
		|	ОтражениеДокументовВМеждународномУчете.НастройкаФормированияПроводок,
...
Процедура ВыполнитьОффлайновыеРасчеты(Знач Организации = Неопределено, Знач ДатаОкончания = Неопределено, Знач Документы = Неопределено) Экспорт
	...
	Если ДокументыКРасчету.Количество() > 0 Тогда
		...
		ПараметрыВыполнения.ВидЗадания = Справочники.ВидыНеоперативныхЗаданий.ОтражениеВМеждународномУчете;
