...
// Возвращает список команд ЭДО легкого интерфейса.
//
// Возвращаемое значение:
//  См. ПодключаемыеКомандыЭДОСлужебный.КомандыЭДОФормы
//
Функция КомандыЭДОЛегкогоИнтерфейса() Экспорт
	Возврат ПодключаемыеКомандыЭДОСлужебный.КомандыЭДОЛегкогоИнтерфейса();
КонецФункции
