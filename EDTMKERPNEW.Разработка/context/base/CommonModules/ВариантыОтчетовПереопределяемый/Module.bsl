...
Процедура ОпределитьОбъектыСКомандамиОтчетов(Объекты) Экспорт
	...
	//++ НЕ УТКА
	Объекты.Добавить(Метаданные.БизнесПроцессы.СогласованиеРазрешенийНаЗаменуМатериалов);
	//-- НЕ УТКА
	...
	Объекты.Добавить(Метаданные.Документы.ИсследованиеКачестваТоваров);
	...
	Объекты.Добавить(Метаданные.Документы.РегистраторОборотовБюджетов);
	...
	Объекты.Добавить(Метаданные.Документы.УстановкаНачальныхОстатковРасчетныхПоказателей);
