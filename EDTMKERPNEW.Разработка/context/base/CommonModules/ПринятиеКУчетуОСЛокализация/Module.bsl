...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|
	|	""ПринятиеКУчетуОСЛокализация_936"" КАК НомерФрагмента
	|ИЗ
	...
	|	""ПринятиеКУчетуОСЛокализация_937"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьОС КАК Строки
	...
	|	""ПринятиеКУчетуОСЛокализация_938"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьОС КАК Строки
	...
	|	""ПринятиеКУчетуОСЛокализация_939"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПринятиеКУчетуОС2_4 КАК Операция
	...
	|	""ПринятиеКУчетуОСЛокализация_940"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьОС КАК Строки
	...
	|	Строки.СтоимостьНУ КАК СуммаНУДт,
	|	Строки.СтоимостьПР КАК СуммаПРДт,
	|	Строки.СтоимостьБУ - Строки.СтоимостьНУ - Строки.СтоимостьПР КАК СуммаВРДт,
	|	
	|	// Кт ///////////////////////////////////////////////////////////////////////////////////////////
	|	
	...
	|	Строки.СтоимостьБУ - Строки.СтоимостьНУ - Строки.СтоимостьПР КАК СуммаВРКт,
	|
	|	""Принятие к учету самортизированного ОС"" КАК Содержание,
	|	""ПринятиеКУчетуОСЛокализация_941"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПринятиеКУчетуОС2_4 КАК Операция
	...
	|	""ПринятиеКУчетуОСЛокализация_942"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПринятиеКУчетуОС2_4 КАК Операция
	...
	|	""ПринятиеКУчетуОСЛокализация_943"" КАК НомерФрагмента
	|ИЗ
	...
	|	""ПринятиеКУчетуОСЛокализация_1993"" КАК НомерФрагмента
	|ИЗ
	...
	|	0 КАК СуммаВРКт,
	|	""Применение инвестиционного налогового вычета"" КАК Содержание,
	|	""ПринятиеКУчетуОСЛокализация_1994"" КАК НомерФрагмента
	|ИЗ
	|	РазрезыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьОС КАК Строки
	...
	|	0 КАК СуммаВРКт,
	|	""Применение инвестиционного налогового вычета"" КАК Содержание,
	|	""ПринятиеКУчетуОСЛокализация_1984"" КАК НомерФрагмента
	|ИЗ
	|	РазрезыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьОС КАК Строки
...
Функция ТекстЗапросаТаблицаАмортизацияОС(Запрос, ТекстыЗапроса) Экспорт
	...
	|	ВЫБОР 
	|		КОГДА ДанныеДокумента.ПорядокУчетаБУ = ЗНАЧЕНИЕ(Перечисление.ПорядокПогашенияСтоимостиОС.АмортизацияНачислена)
	|			ТОГДА ТаблицаОС.СтоимостьБУ - ТаблицаОС.СтоимостьНУ - ТаблицаОС.СтоимостьПР
	|		ИНАЧЕ 0
...
Функция ТекстЗапросаТаблицаВтИсходныеПрочиеРасходы(Запрос, ТекстыЗапроса, ДопПоля) Экспорт
	...
	СписокЗапросовОбъединение.Добавить(ВнеоборотныеАктивыСлужебный.ТекстЗапросаТаблицаОтражениеНачисленнойАмортизацииВПрочихРасходах(ДопПоля));
	
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаПрочиеРасходыПринятияКУчету(СписокЗапросовОбъединение);
	ВнеоборотныеАктивыСлужебный.ТекстЗапросаПрочиеРасходыНеПриниматьКУчетуВключитьВРасходы(СписокЗапросовОбъединение);
