...
#Область ТекстОстаткиСобственныхТоваров                    // (Дт 41 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_75"" КАК НомерФрагмента
	|ИЗ
...
#Область ТекстОстаткиСобственныхТоваровНаПроизводстве                    // (Дт 20 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_76"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиКомиссионныхТоваров                   // (Дт 004.01 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_77"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиПереданныхТоваров                     // (Дт 45 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_78"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиПолученныхАвансов                     // (Дт 000 :: Кт 62.02)
	...
	|	""ВводОстатковЛокализация_79"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстРасчетыМеждуОрганизациямиПоАвансам           // (Дт 000 :: Кт 62.02)
	...
	|	""ВводОстатковЛокализация_80"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки авансов, полученных от других организаций"" КАК Содержание,
	|	""ВводОстатковЛокализация_81"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстРасчетыМеждуОрганизациямиПоРеализациям       // (Дт 62.01 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_82"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки задолженности по реализациям другим организациям"" КАК Содержание,
	|	""ВводОстатковЛокализация_83"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиЗадолженностиКлиентов                 // (Дт 62.01 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_84"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиЗадолженностьПередПоставщиками        // (Дт 000 :: Кт 60.01)
	...
	|	""ВводОстатковЛокализация_85"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиАвансовПоставщикам                    // (Дт 60.02 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_86"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиВКассах                               // (Дт 50.01 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_87"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиВКассахККМ                            // (Дт 50.02 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_88"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиВКассахККМКОформлениюОтчетовОПродажах // (Дт 000 :: Кт 50.02)
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки наличных денежных средств"" КАК Содержание,
	|	""ВводОстатковЛокализация_89"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиНаБанковскихСчетах                    // (Дт 51, 52 :: Кт 000
	...
	|	""ВводОстатковЛокализация_90"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиРасчетовПоЭквайрингу                  // (Дт 57 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_91"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки расчетов по эквайрингу"" КАК Содержание,
	|	""ВводОстатковЛокализация_92"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиУПодотчетныхЛиц                       // (Дт 71 :: Кт 000)
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки наличных денежных средств"" КАК Содержание,
	|	""ВводОстатковЛокализация_93"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстПерерасходыПодотчетныхЛиц                    // (Дт 000 :: Кт 71)
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки наличных денежных средств"" КАК Содержание,
	|	""ВводОстатковЛокализация_94"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиНДСНеПринятогоКВычету        // (Дт 19.03 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_95"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПодарочныеСертификаты                        // (Дт 000 :: Кт 76.09)
	...
	|	""ВводОстатковЛокализация_96"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПрочиеРасходы                                // (Дт 25, 26, 44, 20, 23 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_97"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПрочиеОперации    // (Дт ХХ :: Кт 000)
	...
	|	""ВводОстатковЛокализация_98"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстТоварыПереданныеВПроизводство                 // (Дт 20, 2Х, 44, 91.02 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_99"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстТоварыПереданныеПереработчику                // (Дт 10.07 :: Кт 000)
	...
	|	""ВводОстатковЛокализация_100"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиПоКредитамЗаймам                      // Дт 000 :: Кт 66.01
	...
	|	""ВводОстатковЛокализация_101"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиВыплатПоКредитамЗаймам                // Дт 66.01 :: Кт 000
	...
	|	""ВводОстатковЛокализация_102"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиВыплаченныхПроцентовПоКредитам        // Дт 66.02 :: Кт 000
	...
	|	""ВводОстатковЛокализация_103"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиНачисленныхПроцентовПоКредитам        // Дт 000 :: Кт 66.02
	...
	|	""ВводОстатковЛокализация_104"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиВыплаченнойКомиссииПоКредитам         // Дт 76.09 :: Кт 000
	...
	|	""ВводОстатковЛокализация_105"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиНачисленийКомиссииПоКредитам         // Дт 000 :: Кт 76.09
	...
	|	""ВводОстатковЛокализация_106"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиПоДепозитам                           // Дт 55.03 :: Кт 000
	...
	|	""ВводОстатковЛокализация_107"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиПроцентовПоДепозитам                  // Дт 76.09 :: Кт 000
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки по депозитам"" КАК Содержание,
	|	""ВводОстатковЛокализация_108"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиПолученныхДенегПоДепозитам            // Дт 000 :: Кт 55.03
	...
	|	""ВводОстатковЛокализация_109"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиПолученныхДенегПоПроцентамДепозитов   // Дт 000 :: Кт 76.09
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки полученных денег по депозитам"" КАК Содержание,
	|	""ВводОстатковЛокализация_110"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиОсновногоДолгаПоЗаймамВыданным        // Дт 58.03 :: Кт 000
	...
	|	""ВводОстатковЛокализация_111"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиПолученныхДенегОсновногоДолгаПоЗаймаВыданным // Дт 000 :: Кт 58.03
	...
	|	""ВводОстатковЛокализация_112"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиПроцентовПоЗаймамВыданным               // Дт 76.09 :: Кт 000
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки по займам выданным"" КАК Содержание,
	|	""ВводОстатковЛокализация_113"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиПолученныхДенегПроцентовПоЗаймаВыданным // Дт 000 :: Кт 76.09
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки полученных процентов по займам выданным"" КАК Содержание,
	|	""ВводОстатковЛокализация_114"" КАК НомерФрагмента
	|
	|ИЗ 	
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПередачаВЭксплуатацию                                 // Дт 10.11.Х :: Кт 000
	...
	|	""ВводОстатковЛокализация_115"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстПередачаВЭксплуатациюПриПередаче                      // Дт 10.11.Х :: Кт 000
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки ТМЦ в эксплуатации"" КАК Содержание,
	|	""ВводОстатковЛокализация_116"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстПередачаВЭксплуатациюЗаБаланс                         // Дт МЦ.0Х :: Кт ---
	...
	|	""ВводОстатковЛокализация_117"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиВКассах                               // (Дт 50.01 :: Кт 000)
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки наличных денежных средств"" КАК Содержание,
	|	""ВводОстатковЛокализация_118"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиВКассахККМ                            // (Дт 50.02 :: Кт 000)
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки наличных денежных средств в кассах ККМ"" КАК Содержание,
	|	""ВводОстатковЛокализация_119"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиВКассахККМКОформлениюОтчетовОПродажах // (Дт 000 :: Кт 50.02)
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки наличных денежных средств"" КАК Содержание,
	|	""ВводОстатковЛокализация_120"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиНаБанковскихСчетах                    // (Дт 51, 52 :: Кт 000
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки безналичных денежных средств"" КАК Содержание,
	|	""ВводОстатковЛокализация_121"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиПолученныхАвансов                     // (Дт 000 :: Кт 62.02)
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки авансов, полученных от клиентов"" КАК Содержание,
	|	""ВводОстатковЛокализация_122"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки авансов, полученных от клиентов"" КАК Содержание,
	|	""ВводОстатковЛокализация_123"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиЗадолженностиКлиентов                 // (Дт 62.01 :: Кт 000)
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки задолженности клиентов"" КАК Содержание,
	|	""ВводОстатковЛокализация_124"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки задолженности клиентов"" КАК Содержание,
	|	""ВводОстатковЛокализация_125"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиПремийКлиентам                        // (Дт 000 :: Кт 62.02)
	...
	|	""ВводОстатковЛокализация_1678"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	&Содержание КАК Содержание,
	|	""ВводОстатковЛокализация_1679"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиЗадолженностьПередПоставщиками        // (Дт 000 :: Кт 60.01)
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки задолженности перед поставщиками"" КАК Содержание,
	|	""ВводОстатковЛокализация_126"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки задолженности перед поставщиками"" КАК Содержание,
	|	""ВводОстатковЛокализация_127"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиАвансовПоставщикам                    // (Дт 60.02 :: Кт 000)
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки авансов поставщикам"" КАК Содержание,
	|	""ВводОстатковЛокализация_128"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки авансов поставщикам"" КАК Содержание,
	|	""ВводОстатковЛокализация_129"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстОстаткиПремийПоставщиков                     // (Дт 60.02 :: Кт 000)
	...
	|	0 КАК СуммаВРКт,
	|	&Содержание КАК Содержание,
	|	""ВводОстатковЛокализация_1680"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	&Содержание КАК Содержание,
	|	""ВводОстатковЛокализация_1681"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ТекстОстаткиПроцентовПоДисконтированию                    // (Дт 76.хх :: Кт 000)
	...
	|	""ВводОстатковЛокализация_130"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ВводОстатковНДСПредъявленногоТекстОтраженияВРеглУчете() Экспорт
	...
	ТекстОтражения = "ВЫБРАТЬ // Остатки НДС не принятого к вычету (Дт 19.03 :: Кт 000)
		...
		|	0 КАК СуммаВРКт,
		|	""Остатки НДС не принятого к вычету"" КАК Содержание,
		|	""ВводОстатковЛокализация_131"" КАК НомерФрагмента
		|
		|ИЗ
		|	ДокументыКОтражению КАК ДокументыКОтражению
		|	
...
Функция ВводОстатковОПродажахЗаПрошлыеПериодыТекстОтраженияВРеглУчете() Экспорт
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки авансов от розничного клиента"" КАК Содержание,
	|	""ВводОстатковЛокализация_132"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ВводОстатковПоФинансовымИнструментамТекстОтраженияВРеглУчете() Экспорт
	...
	|	
	|	""Остатки по кредитам и займам"" КАК Содержание,
	|	""ВводОстатковЛокализация_133"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки выплат по кредитам и займам"" КАК Содержание,
	|	""ВводОстатковЛокализация_134"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки выплаченных процентов по кредитам"" КАК Содержание,
	|	""ВводОстатковЛокализация_135"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки начисленных процентов по кредитам"" КАК Содержание,
	|	""ВводОстатковЛокализация_136"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки выплаченной комиссии по кредитам"" КАК Содержание,
	|	""ВводОстатковЛокализация_137"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки начисленной комиссии по кредитам"" КАК Содержание,
	|	""ВводОстатковЛокализация_138"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки по депозитам"" КАК Содержание,
	|	""ВводОстатковЛокализация_139"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#КонецОбласти
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки по депозитам"" КАК Содержание,
	|	""ВводОстатковЛокализация_140"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки полученных денег по депозитам"" КАК Содержание,
	|	""ВводОстатковЛокализация_141"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки полученных денег по депозитам"" КАК Содержание,
	|	""ВводОстатковЛокализация_142"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки по займам выданным"" КАК Содержание,
	|	""ВводОстатковЛокализация_143"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки полученных процентов по займам выданным"" КАК Содержание,
	|	""ВводОстатковЛокализация_144"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки по займам выданным"" КАК Содержание,
	|	""ВводОстатковЛокализация_145"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки полученных процентов по займам выданным"" КАК Содержание,
	|	""ВводОстатковЛокализация_146"" КАК НомерФрагмента
	|
	|ИЗ 	
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ВводОстатковПрочиеРасходыТекстОтраженияВРеглУчете() Экспорт
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки прочих расходов "" КАК Содержание,
	|	""ВводОстатковЛокализация_147"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки прочих активов"" КАК Содержание,
	|	""ВводОстатковЛокализация_148"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ВводОстатковРасчетовПоЭквайрингуТекстОтраженияВРеглУчете() Экспорт
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки расчетов по эквайрингу"" КАК Содержание,
	|	""ВводОстатковЛокализация_149"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки расчетов по эквайрингу"" КАК Содержание,
	|	""ВводОстатковЛокализация_150"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ВводОстатковСПодотчетникамиТекстОтраженияВРеглУчете() Экспорт
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки наличных денежных средств"" КАК Содержание,
	|	""ВводОстатковЛокализация_151"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки наличных денежных средств"" КАК Содержание,
	|	""ВводОстатковЛокализация_152"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ВводОстатковТоваровТекстОтраженияВРеглУчете() Экспорт
	...
	|	""ВводОстатковЛокализация_1682"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	#Область ТекстОстаткиОтгруженныхТоваровПоДаннымДокумента                    // (Дт 45 :: Кт 000)
	ТекстОстаткиОтгруженныхТоваровПоДаннымДокумента = 
	"ВЫБРАТЬ // Остатки отгруженных товаров (Дт 45 :: Кт 000)
	|	Операция.Ссылка КАК Ссылка,
	|	Операция.Дата КАК Период,
	|	Операция.Организация КАК Организация,
	|	Строки.ИдентификаторСтроки КАК ИдентификаторСтроки,
	...
	|	0 КАК СуммаПРКт,
	|	0 КАК СуммаВРКт,
	|	""Остатки отгруженных товаров"" КАК Содержание,
	|	""ВводОстатковЛокализация_1916"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|ГДЕ
	|	НЕ Операция.ОтражатьСебестоимость
	|	И Операция.ХозяйственнаяОперация = ЗНАЧЕНИЕ(Перечисление.ХозяйственныеОперации.ВводОстатковОтгруженныхТоваров)
	|	И (Операция.ОтражатьВБУиНУ ИЛИ Операция.ОтражатьВУУ)";
	#КонецОбласти
	...
	|	КОНЕЦ КАК Содержание,
	|	""ВводОстатковЛокализация_1683"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	"" Остатки товаров, принятых на комиссию"" КАК Содержание,
	|	""ВводОстатковЛокализация_153"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки товаров, переданных на комиссию"" КАК Содержание,
	|	""ВводОстатковЛокализация_154"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	""ВводОстатковЛокализация_155"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки товаров, переданных на комиссию 2.5"" КАК Содержание,
	|	""ВводОстатковЛокализация_156"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	""ВводОстатковЛокализация_157"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки товаров, переданных на ответ. хранение"" КАК Содержание,
	|	""ВводОстатковЛокализация_158"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	""ВводОстатковЛокализация_159"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки товаров, переданных в производство"" КАК Содержание,
	|	""ВводОстатковЛокализация_160"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки товаров, переданных переработчику"" КАК Содержание,
	|	""ВводОстатковЛокализация_161"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	КОНЕЦ КАК Содержание,
	|	""ВводОстатковЛокализация_1684"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	""ВводОстатковЛокализация_162"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Остатки НДС не принятого к вычету"" КАК Содержание,
	|	""ВводОстатковЛокализация_163"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	КОНЕЦ КАК Содержание,
	|	""ВводОстатковЛокализация_1685"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#КонецОбласти
	...
	|		ИНАЧЕ ""Остатки товаров, принятых на хранение""
	|	КОНЕЦ КАК Содержание,
	|	""ВводОстатковЛокализация_1686"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#КонецОбласти
	...
	|		ТОГДА ""Остатки собственных товаров в производстве""
	|		КОГДА Строки.РазделУчета = ЗНАЧЕНИЕ(Перечисление.РазделыУчетаСебестоимостиТоваров.ТоварыВПути)
	|		ТОГДА ""Остатки отгруженных товаров""
	|		ИНАЧЕ ""Остатки собственных товаров""
	|	КОНЕЦ КАК Содержание,
	|	""ВводОстатковЛокализация_1687"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#КонецОбласти
	...
	|	""ВводОстатковЛокализация_164"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	""ВводОстатковЛокализация_165"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|
	...
	ТекстыОтражения.Добавить(ТекстОстаткиОтгруженныхТоваровПоДаннымДокумента);
...
Функция ВводДанныхПоНалогуНаПрибыльТекстОтраженияВРеглУчете() Экспорт
	...
	|	""ВводОстатковЛокализация_166"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Налог на прибыль"" КАК Содержание,
	|	""ВводОстатковЛокализация_167"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Налог на прибыль"" КАК Содержание,
	|	""ВводОстатковЛокализация_168"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	""ВводОстатковЛокализация_169"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	0 КАК СуммаВРКт,
	|	""Списание убытков прошлых лет"" КАК Содержание,
	|	""ВводОстатковЛокализация_170"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
// Текст отражения в регл учете отложенные доходы расходы.
// 
// Возвращаемое значение:
//  Строка - Текст отражения в регл учете отложенные доходы расходы
Функция ТекстОтраженияВРеглУчетеОтложенныеДоходыРасходы() Экспорт
	...
	|	""ВводОстатковЛокализация_171"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	""ВводОстатковЛокализация_172"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
