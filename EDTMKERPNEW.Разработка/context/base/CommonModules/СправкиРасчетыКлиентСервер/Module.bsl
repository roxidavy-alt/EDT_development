...
Функция НаборСуммовыхПоказателейВключаетБухгалтерскийУчет(НомерНабораСуммовыхПоказателей) Экспорт
	...
	Возврат НомерНабораСуммовыхПоказателей <> НомерНабораСуммовыхПоказателейНалоговыйУчет()
		И НомерНабораСуммовыхПоказателей <> НомерНабораСуммовыхПоказателейНалоговыйУчетСКорректировкой();
...
Функция НазваниеНабораСуммовыхПоказателей(НомерНабораСуммовыхПоказателей) Экспорт
	...
	ИначеЕсли ЭтоНаборСуммовыхПоказателейНалоговыйУчетСКорректировкой(НомерНабораСуммовыхПоказателей) Тогда
		
		Возврат НСтр("ru = 'налоговый учет с корректировками';
					|en = 'tax accounting with adjustments'");
...
Функция НомерНабораСуммовыхПоказателейНалоговыйУчетСКорректировкой() Экспорт
	
	Возврат 5;
	
КонецФункции

Функция ЭтоНаборСуммовыхПоказателейНалоговыйУчетСКорректировкой(НомерНабораСуммовыхПоказателей) Экспорт
	Возврат НомерНабораСуммовыхПоказателей = НомерНабораСуммовыхПоказателейНалоговыйУчетСКорректировкой();
КонецФункции
...
Функция СоставНабораСуммовыхПоказателей(НомерНабораСуммовыхПоказателей) Экспорт
	...
	ИначеЕсли ЭтоНаборСуммовыхПоказателейНалоговыйУчетСКорректировкой(НомерНабораСуммовыхПоказателей) Тогда
		...
		СоставНабора.Добавить("НУсКорректировкой");
...
Функция ПредставленияНаборовСуммовыхПоказателей()
	...
	Представления.Вставить(
		НомерНабораСуммовыхПоказателейНалоговыйУчетСКорректировкой(),
		НСтр("ru = 'НУ с корректировкой (данные налогового учета с корректировкой)';
			|en = 'TA with adjustment (adjusted tax accounting data)'"));
