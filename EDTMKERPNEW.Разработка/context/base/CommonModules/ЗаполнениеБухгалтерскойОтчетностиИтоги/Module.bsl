...
Функция Счет(УсловныйКодСчета) Экспорт
	...
	ИначеЕсли УсловныйКодСчета = "68.91" Тогда
		Результат = ПС.ОбеспечительныйПлатежПриВвозеТоваровИзЕАЭС;
...
Функция СчетаСРеквизитами() Экспорт
	...
	ДобавитьПредопределенныйСчет(Матрикс, "68.91", "ОбеспечительныйПлатежПриВвозеТоваровИзЕАЭС");
