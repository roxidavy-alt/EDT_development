...
#Область ПередачаМатериаловВПроизводство // (Дт 20 :: Кт 20, 10, 76.ОК)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_345"" КАК НомерФрагмента
	|ИЗ
...
#Область ВключениеИсключениеНДСВСтоимостьТоваров // (Дт 25, 26, 44 :: Кт 19.03)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_346"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ВыпускПродукцииНаСкладПоПлановойСтоимости // (Дт 43, 21 :: Кт 40)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_347"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыпускПродукцииНаСкладОтклонение // (Дт 43, 21 :: Кт 40)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_348"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыпускПродукцииВКладовуюПоПлановойСтоимости // (Дт 20, 23 :: Кт 40)
	...
	|	Строки.СуммаВР КАК СуммаВРКт,
	|	""Выпуск продукции (плановая стоимость)"" КАК Содержание,
	|	""ДвижениеПродукцииИМатериаловЛокализация_349"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВыпускПродукцииВКладовуюОтклонение // (Дт 43, 21 :: Кт 40)
	...
	|	Стоимости.СуммаВР КАК СуммаВРКт,
	|	""Выпуск продукции (отклонение)"" КАК Содержание,
	|	""ДвижениеПродукцииИМатериаловЛокализация_350"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВключениеИсключениеНДСВСтоимость // (Дт 43, 21, 20, 23 :: Кт 19.03)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_351"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ВозвратТоваровНаСклад // (Дт 20.01 :: Кт 10.01 сторно)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_352"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ВозвратТоваровВКладовую // (Дт 20.01 :: Кт 20.01 сторно)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_353"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ВключениеИсключениеНДСВСтоимостьТовараПриВозврате // (Дт 10.1, 25, 26, 44 :: Кт 19.03)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_354"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ВключениеИсключениеНДСВСтоимостьАктивовПриВозврате // (Дт 08 :: Кт 19.03)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_355"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ВозвратПродукцииДавальцаБаланс // (Дт 20.01 :: Кт 20.01 сторно)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_356"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ПеремещениеСобственныхТоваров // (Дт 20, 23 :: Кт 20, 23)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_357"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ПеремещениеСобственныхТоваровСОбособленногоПодразделения // (Дт 79.02 :: Кт 20, 23)
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_358"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
#Область ПеремещениеСобственныхТоваровНаОбособленноеПодразделение // (Дт 20, 23 :: Кт 79.02)
	...
	|	0 КАК СуммаВРКт,
	|	""Перемещение собственных полуфабрикатов между филиалами"" КАК Содержание,
	|	""ДвижениеПродукцииИМатериаловЛокализация_359"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстСписаниеТоваровЗаБалансом()
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_1710"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстПередачаТоваровЗаБалансом()
	...
	|	КОНЕЦ КАК Содержание,
	|	""ДвижениеПродукцииИМатериаловЛокализация_1711"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстВыпускПродукции()
	...
	|		КОГДА Строки.КорРазделУчета = ЗНАЧЕНИЕ(Перечисление.РазделыУчетаСебестоимостиТоваров.НезавершенноеПроизводство)
	|		ТОГДА ЗНАЧЕНИЕ(Перечисление.ВидыСчетовРеглУчета.НезавершенноеПроизводство)
	|		КОГДА Строки.КорРазделУчета В (&ЗабалансовыеРазделыУчета, ЗНАЧЕНИЕ(Перечисление.РазделыУчетаСебестоимостиТоваров.ПроизводственныеЗатраты))
	|		ТОГДА ЗНАЧЕНИЕ(Перечисление.ВидыСчетовРеглУчета.МатериалыИРаботыВПодразделении)
	|		ИНАЧЕ ЗНАЧЕНИЕ(Перечисление.ВидыСчетовРеглУчета.НаСкладе)
	|	КОНЕЦ КАК ВидСчетаДт,
	|	ВЫБОР
	...
	|	КОНЕЦ КАК Содержание,
	|	""ДвижениеПродукцииИМатериаловЛокализация_1712"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстВыпускПродукцииСИспользованиемСчета40()
	...
	|	ВЫБОР
	|		КОГДА Строки.РазделУчета = ЗНАЧЕНИЕ(Перечисление.РазделыУчетаСебестоимостиТоваров.НезавершенноеПроизводство)
	|			ИЛИ Строки.КорРазделУчета В (&ЗабалансовыеРазделыУчета)
	|		ТОГДА ЗНАЧЕНИЕ(Перечисление.ВидыСчетовРеглУчета.НезавершенноеПроизводство)
	|		ИНАЧЕ ЗНАЧЕНИЕ(Перечисление.ВидыСчетовРеглУчета.МатериалыИРаботыВПодразделении)
	|	КОНЕЦ КАК ВидСчетаКт,
	...
	|	""ДвижениеПродукцииИМатериаловЛокализация_360"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ТекстВыпускПродукцииПоПлановойСтоимости()
	...
	|	Строки.СуммаВР КАК СуммаВРКт,
	|	""Выпуск продукции (плановая стоимость)"" КАК Содержание,
	|	""ДвижениеПродукцииИМатериаловЛокализация_361"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстВыпускПродукцииОтклонение()
	...
	|
	|	ВЫБОР
	|		КОГДА Стоимости.КорРазделУчета = ЗНАЧЕНИЕ(Перечисление.РазделыУчетаСебестоимостиТоваров.ПроизводственныеЗатраты)
	|			ИЛИ Стоимости.КорРазделУчета В (&ЗабалансовыеРазделыУчета)
	|		ТОГДА ЗНАЧЕНИЕ(Перечисление.ВидыСчетовРеглУчета.МатериалыИРаботыВПодразделении)
	...
	|	Стоимости.СуммаВР КАК СуммаВРКт,
	|	""Выпуск продукции (отклонение)"" КАК Содержание,
	|	""ДвижениеПродукцииИМатериаловЛокализация_362"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
