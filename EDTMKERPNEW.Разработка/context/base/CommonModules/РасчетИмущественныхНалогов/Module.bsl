...
// 
// Возвращаемое значение:
//  Структура - Получить расчет по транспортному налогу:
// * РезультатыРасчетаПоНалогу - Структура - :
// ** РасчетТранспортногоНалогаДо2020 - ТаблицаЗначений - Расчет налога до 2020 года
// ** РасчетТранспортногоНалога - ТаблицаЗначений - Расчет налога с 2020 года
// * Платон - ТаблицаЗначений - Расходы на Платон
...
// Возвращает таблицу видов и категорий транспортных средств.
// 
// Возвращаемое значение:
...
Функция ПолучитьДанныеДляРасчетаТранспортногоНалога(ПараметрыРасчета, ДополнительныеПараметры)
	...
	Замер = ОценкаПроизводительности.НачатьЗамерДлительнойОперации(
					"ОбщийМодуль.РасчетИмущественныхНалогов.ПолучитьИсходныеДанныеДляРасчетаТранспортногоНалога");
	...
	ОценкаПроизводительности.ЗакончитьЗамерДлительнойОперации(Замер, ДанныеДляРасчета.Количество());
...
Процедура ВыполнитьРасчетТранспортногоНалога(ТаблицаРасчетНалога, ПараметрыРасчета, ДанныеДляРасчета, ДополнительныеПараметры)
	...
	Замер = ОценкаПроизводительности.НачатьЗамерДлительнойОперации(
							"ОбщийМодуль.РасчетИмущественныхНалогов.ВыполнитьРасчетТранспортногоНалога");
...
Функция ПолучитьДанныеДляРасчетаТранспортногоНалогаДо2020(ПараметрыРасчета, ДополнительныеПараметры)
	Замер = ОценкаПроизводительности.НачатьЗамерДлительнойОперации(
				"ОбщийМодуль.РасчетИмущественныхНалогов.ПолучитьИсходныеДанныеДляРасчетаТранспортногоНалогаДо2020Года");
...
Функция ВыполнитьРасчетТранспортногоНалогаДо2020(ТаблицаРасчетНалога, ПараметрыРасчета, ДанныеДляРасчета, ДополнительныеПараметры)
	
	Замер = ОценкаПроизводительности.НачатьЗамерДлительнойОперации(
						"ОбщийМодуль.РасчетИмущественныхНалогов.ВыполнитьРасчетТранспортногоНалогаДо2020года");
	...
	ОценкаПроизводительности.ЗакончитьЗамерДлительнойОперации(Замер, ТаблицаРасчетНалога.Количество());
