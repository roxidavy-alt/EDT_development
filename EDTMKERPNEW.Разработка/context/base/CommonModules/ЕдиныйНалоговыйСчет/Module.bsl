...
Функция НеиспользуемыеВидыНалогов(Знач Период = '00010101') Экспорт
	...
	Возврат ЕдиныйНалоговыйСчетПовтИсп.НеиспользуемыеВидыНалогов(Период);
...
// Устарела. Следует использовать ИнтеграцияБЗК.ТекстЗапросаВидыСтраховыхВзносов
//
// Возвращаемое значение:
