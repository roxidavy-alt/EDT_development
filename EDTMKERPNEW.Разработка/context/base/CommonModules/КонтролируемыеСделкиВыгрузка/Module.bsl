...
// 
// Параметры:
//  ОсновныеСведенияВыгрузки      - Структура - основные сведения документации по контролируемым сделкам:
//  * ДатаВыгрузки                - Дата - дата выгрузки документации.
//  * ДокументацияУведомления     - ДокументСсылка.ДокументацияПоКонтролируемымСделкам - документация уведомления
//                                                                                       о контролируемых сделкам.
//  * ИдентификаторФайлаОснования - Строка - идентификатор файла уведомления о контролируемых сделках.
//  * КодНалоговогоОргана         - Строка - код налогового органа подачи документации.
//  * НомерКорректировки          - Число - номер корректировки документации.
//  * Организация                 - СправочникСсылка.Организации - организация, подающая документацию.
//  * ОтчетныйГод                 - Число - отчетный год, за который подается документация.
...
//  ДанныеДокументации            - Структура - данные по методам ценообразования и приложений к документации:
//  * МетодыЦенообразования       - ТаблицаЗначений - свойства методов ценообразования контролируемых сделок:
...
//    ** НаименованиеЛат          - Строка - ниаменование организации в латинской транслитерации.
//    ** НаименованиеРус          - Строка - наименование организации в русской транслитерации.
...
//  * Приложения - ТаблицаЗначений - свойства файлов, приложенных к документации по контролируемым сделкам:
//    ** ИмяФайла - Строка - имя файла документа приложения.
//    ** НаименованиеДокумента - Строка - наименование документа приложения.
//  УникальныйИдентификатор       - УникальныйИдентификатор - уникальный идентификатор формы клиентского приложения.
// 
...
// Формирует узел XML записи с данными о налогоплательщике.
// 
// Параметры:
//  КомпоновщикXML - ЗаписьXML - запись xml для формирования узла.
//  СведенияНП - Структура - сведения о налогоплательщике:
//  * ДатаВыгрузки - Дата - дата выгрузки документации.
//  * ИНН - Строка - ИНН организации, подающей документацию.
//  * КПП - Строка - КПП организации, подающей документацию.
//  * Наименование - Строка - наименование организации, подающей документацию.
// 
...
Функция ПредставлениеЗначения(ИсходноеЗначение, ОписаниеФормата)
	...
	Если ОписаниеТипаАтрибута[0] = "Д" Тогда
		ПредставлениеЗначения = Формат(ИсходноеЗначение, "ДЛФ=Д");
	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(НСтр("ru = 'Функция %1:
			...
			|en = 'Function %1:
			|Value presentation of ""%2"" type is not supported'"),
