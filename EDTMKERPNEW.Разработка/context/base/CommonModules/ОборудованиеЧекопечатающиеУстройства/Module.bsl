...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = 'АТОЛ:ККТ с передачей данных в ОФД 10.10.8.х';
								|en = 'ATOL:Cash register with data transfer to FDO 10.10.8.х'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ПОСЦЕНТР:ККТ с передачей данных в ОФД NG';
								|en = 'POSCENTER:Cash register with data transfer to FDO NG'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Мультисофт:Драйвер фискального ядра MSPOS';
								|en = 'Multisoft:MSPOS fiscal core driver'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ПОСЦЕНТР:ККТ с передачей данных в ОФД';
								|en = 'POSCENTER:Cash register with data transfer to FDO'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Дримкас:ККТ с передачей данных в ОФД';
								|en = 'Dreamkas:Cash register with data transfer to FDO'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Инкотекс:ККТ с передачей данных в ОФД';
								|en = 'Incotex:Cash register with data transfer to FDO'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Инкотекс:ККТ с передачей данных в ОФД серия М';
								|en = 'Incotex:Cash register with data transfer to FDO series M'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'НЕВА:ККТ с передачей данных в ОФД';
								|en = 'NEVA:Cash register with data transfer to FDO'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'РР-Электро:ККТ с передачей данных в ОФД';
								|en = 'RR-Electro:Cash register with data transfer to FDO'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Кассатка:ККТ с передачей данных Кассир-80Ф';
								|en = 'Kassatka:Cash register with data transfer Cashier-80F'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'Торговый Баланс:ККТ с передачей данных в ОФД';
								|en = 'Trade Balance:Cash register with data transfer to FDO'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
