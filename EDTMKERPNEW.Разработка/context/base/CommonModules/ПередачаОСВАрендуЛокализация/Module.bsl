...
Процедура ЗабалансовыйУчетАрендованныхОС(СписокЗапросов)
	...
	|	""ПередачаОСВАрендуЛокализация_764"" КАК НомерФрагмента
	|ИЗ
...
Процедура ТекстОтраженияВРеглУчетеДоходнойАренды(СписокЗапросов) Экспорт
	...
	|	""ПередачаОСВАрендуЛокализация_765"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""ПередачаОСВАрендуЛокализация_766"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""ПередачаОСВАрендуЛокализация_767"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	""ПередачаОСВАрендуЛокализация_768"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПередачаОСВАренду2_4 КАК Операция
	...
	|	""ПередачаОСВАрендуЛокализация_769"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ПередачаОСВАренду2_4 КАК Операция
