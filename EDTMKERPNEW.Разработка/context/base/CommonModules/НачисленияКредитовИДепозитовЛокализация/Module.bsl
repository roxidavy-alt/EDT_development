...
#Область РасчетыПоКредитам //(Дт 91.02 :: Кт 66.02, 76.09)
	...
	|	""НачисленияКредитовИДепозитовЛокализация_1765"" КАК НомерФрагмента
	|
	|ИЗ
...
#Область РасчетыПоКредитам //(Дт :: Кт 66.02, 76.09)
	...
	|		ИНАЧЕ ""Комиссия по кредитам полученным""
	|	КОНЕЦ КАК Содержание,
	|	""НачисленияКредитовИДепозитовЛокализация_1766"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПроцентыПоДепозитам //(Дт 76.09 :: Кт 91.01)
	...
	|	Операция.Организация КАК Организация,
	|	РасчетыПоДепозитам.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|
	...
	|	КОНЕЦ КАК Содержание,
	|	""НачисленияКредитовИДепозитовЛокализация_1767"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПроцентыПоДепозитам //(Дт 76.09 :: Кт )
	...
	|		ИНАЧЕ ""Комиссия по депозитам""
	|	КОНЕЦ КАК Содержание,
	|	""НачисленияКредитовИДепозитовЛокализация_1768"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область КапитализацияПроцентовПоДепозитам //(Дт 55.03 :: 76.09)
	...
	|	""НачисленияКредитовИДепозитовЛокализация_611"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область КапитализацияПроцентовПоДепозитам //(Дт 55.03 :: )
	...
	|	0 КАК СуммаВРКт,
	|	""Капитализация процентов по депозитам"" КАК Содержание,
	|	""НачисленияКредитовИДепозитовЛокализация_612"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПроцентыИКомиссияПоЗаймамВыданным //(Дт 76.09 :: Кт 91.01)
	...
	|	Операция.Организация КАК Организация,
	|	РасчетыПоЗаймам.ИдентификаторСтроки КАК ИдентификаторСтроки,
	|
	...
	|	""НачисленияКредитовИДепозитовЛокализация_613"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПроцентыИКомиссияПоЗаймамВыданным //(Дт 76.09 :: Кт )
	...
	|	0 КАК СуммаВРКт,
	|	""Начисление процентов и комиссии по займам выданным"" КАК Содержание,
	|	""НачисленияКредитовИДепозитовЛокализация_614"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
