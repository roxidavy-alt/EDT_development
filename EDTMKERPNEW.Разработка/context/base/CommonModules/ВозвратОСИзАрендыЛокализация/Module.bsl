...
Процедура ЗабалансовыйУчетАрендованныхОС(СписокЗапросов)
	...
	|	""ВозвратОСИзАрендыЛокализация_1694"" КАК НомерФрагмента
	|ИЗ
	...
	|	""ВозвратОСИзАрендыЛокализация_1909"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|		ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.СтоимостьОС КАК Строки
...
Процедура ТекстОтраженияВРеглУчетеДоходнойАренды(СписокЗапросов) Экспорт
	...
	|	""ВозвратОСИзАрендыЛокализация_1695"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""ВозвратОСИзАрендыЛокализация_1696"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ИнвестицииВАренду КАК СтрокиДт
	...
	|	""ВозвратОСИзАрендыЛокализация_1697"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	""ВозвратОСИзАрендыЛокализация_1698"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	...
	|	""ВозвратОСИзАрендыЛокализация_1699"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрочиеРасходы КАК СтрокиДт
	...
	|	""ВозвратОСИзАрендыЛокализация_1700"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
