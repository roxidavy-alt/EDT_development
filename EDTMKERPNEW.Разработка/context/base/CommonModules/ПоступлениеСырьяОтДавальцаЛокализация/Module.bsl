...
#Область ПоступлениеМатериаловОтДавальца // (Дт 003.01 :: Кт )
	...
	|	""ПоступлениеСырьяОтДавальцаЛокализация_919"" КАК НомерФрагмента
	|
	|ИЗ
...
#Область ПоступлениеВозвратнойТары // (Дт 10, 41 :: Кт 60, 71, 76)
	...
	|	""ПоступлениеСырьяОтДавальцаЛокализация_920"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПоступлениеМатериаловОтДавальцаНаСкладПроизводства // (Дт 003.02 :: Кт )
	...
	|	0 КАК СуммаВРКт,
	|	""Поступление материалов от давальца"" КАК Содержание,
	|	""ПоступлениеСырьяОтДавальцаЛокализация_921"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПоступлениеВозвратнойТарыНаСкладПроизводства // (Дт 20 :: Кт 60, 71, 76)
	...
	|	0 КАК СуммаВРКт,
	|	""Поступление возвратной тары"" КАК Содержание,
	|	""ПоступлениеСырьяОтДавальцаЛокализация_922"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
