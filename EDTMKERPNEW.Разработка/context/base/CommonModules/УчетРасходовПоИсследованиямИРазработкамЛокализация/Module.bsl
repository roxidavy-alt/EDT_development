...
#Область ТекстПрочиеРасходы 
	...
	|	""УчетРасходовПоИсследованиямИРазработкамЛокализация_1357"" КАК НомерФрагмента
	|ИЗ
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	|	РасходныеДвижения.ИдентификаторФинЗаписи КАК ИдентификаторФинЗаписи,
	...
	|ГДЕ
	|	РасходныеДвижения.СуммаРегл <> 0
	|	ИЛИ РасходныеДвижения.ПостояннаяРазница <> 0
	|	ИЛИ РасходныеДвижения.ВременнаяРазница <> 0
	|	ИЛИ РасходныеДвижения.СуммаУпр <> 0
	|
	|ИНДЕКСИРОВАТЬ ПО
	|	Ссылка";
