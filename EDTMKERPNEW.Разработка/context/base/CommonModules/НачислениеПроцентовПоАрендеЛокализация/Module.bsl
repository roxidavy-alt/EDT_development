...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	""НачислениеПроцентовПоАрендеЛокализация_595"" КАК НомерФрагмента
	|ИЗ
	...
	|	""НачислениеПроцентовПоАрендеЛокализация_596"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрочиеРасходы КАК СтрокиДт
	...
	|	""НачислениеПроцентовПоАрендеЛокализация_597"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
