...
Процедура ЗадатьВопросПересчетаЦеныПриИзмененииДаты(
	...
	ПоказатьВопрос(
		...
		?(ЗначениеЗаполнено(ТекстВопроса), ТекстВопроса, НСтр("ru = 'Перезаполнить цены по условиям продаж?';
																|en = 'Refill prices by sales terms and conditions?'")),
		ВариантыОтветов);
...
Процедура ЗадатьВопросПересчетаЦеныПриИзмененииСоглашения(Документ, ОповещениеОРезультате, ИмяТЧ="Товары") Экспорт
	...
	ПоказатьВопрос(ОповещениеОРезультате, НСтр("ru = 'Перезаполнить цены по условиям продаж?';
												|en = 'Refill prices by sales terms and conditions?'"), ВариантыОтветов);
