...
Процедура ЗаполнитьСведенияОбОперацияхПоБанковскимСчетам(Параметры, СведенияОбОперациях) Экспорт
	...
	СведенияОбОперациях.ЦифровойРубль.СчетУчета = ОтчетностьВБанкиСлужебный.ОбщиеНастройки().БанковскиеСчета.ЦифровойРубль;
	...
	Если ЗначениеЗаполнено(СведенияОбОперациях.ЦифровойРубль.СчетУчета) Тогда
...
Функция СчетаОСВПоСчетам() Экспорт
	...
	СписокСчетов =
		...
		|40, 41, 43, 44, 45, 50, 57, 58, 59, 60, 62, 63, 66, 67, 68, 69,
