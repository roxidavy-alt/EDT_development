...
Процедура ЗаполнитьОтчетТранспортныйНалогФормаОтчета2007Кв1(ПараметрыОтчета, Контейнер) Экспорт
	...
	Пока Период <= мДатаКонцаПериодаОтчета Цикл
		...
		|		ИНАЧЕ ПараметрыНачисленияТранспортногоНалогаСрезПоследних.КодПоОКАТОДо2014
		|	КОНЕЦ КодПоОКАТО,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.КодВидаТранспортногоСредстваДо2020 КАК КодВидаТранспортногоСредства,
		...
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.НалоговаяЛьготаДо2020 КАК НалоговаяЛьгота,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.КодНалоговойЛьготыДо2020 КАК КодНалоговойЛьготы,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.ЛьготнаяСтавка КАК ЛьготнаяСтавка,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.ПроцентУменьшенияДо2020 КАК ПроцентУменьшения,
...
Процедура ЗаполнитьОтчетТранспортныйНалогФормаОтчета2012Кв1(ПараметрыОтчета, Контейнер) Экспорт
	...
	Пока Период <= мДатаКонцаПериодаОтчета Цикл
		...
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.НалоговаяЛьготаДо2020 КАК НалоговаяЛьгота,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.КодНалоговойЛьготыДо2020 КАК КодНалоговойЛьготы,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.РегиональныйКодЛьготыДо2020 КАК РегиональныйКодЛьготы,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.ЛьготнаяСтавка КАК ЛьготнаяСтавка,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.ПроцентУменьшенияДо2020 КАК ПроцентУменьшения,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.СуммаУменьшения КАК СуммаУменьшения,
...
Процедура ЗаполнитьОтчетТранспортныйНалогФормаОтчета2012Кв4(ПараметрыОтчета, Контейнер) Экспорт
	...
	Пока Период <= мДатаКонцаПериодаОтчета Цикл
		...
		|		ИНАЧЕ 
		|			ПараметрыНачисленияТранспортногоНалогаСрезПоследних.КодПоОКАТОДо2014
		|	КОНЕЦ КодПоОКАТО,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.КодВидаТранспортногоСредстваДо2020 КАК КодВидаТранспортногоСредства,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.НалоговаяБаза КАК НалоговаяБаза,
		|	ПараметрыНачисленияТранспортногоНалогаСрезПоследних.ЕдиницаИзмеренияНалоговойБазы КАК ЕдиницаИзмеренияНалоговойБазы,
