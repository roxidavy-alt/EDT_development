...
// Возвращает общие настройки функционирования подсистемы "Отчетность в банки",
// переопределяемые в конфигурациях-потребителях.
// 
// Возвращаемое значение:
//  Структура:
//   * БанковскиеСчета - Структура - счета по по плану счетов, утвержденному Минфином России:
//    ** РасчетныеСчета - ПланСчетовСсылка, Неопределено - счет 51;
//    ** ВалютныеСчета - ПланСчетовСсылка, Неопределено - счет 52;
//    ** ЦифровойРубль - ПланСчетовСсылка, Неопределено - счет 53;
//    ** СпециальныеСчетаВБанках - ПланСчетовСсылка, Неопределено - счет 55.
// 
Функция ОбщиеНастройки() Экспорт
	
	Настройки = Новый Структура;
	
	Настройки.Вставить("БанковскиеСчета", Новый Структура);
	Настройки.БанковскиеСчета.Вставить("РасчетныеСчета");
	Настройки.БанковскиеСчета.Вставить("ВалютныеСчета");
	Настройки.БанковскиеСчета.Вставить("ЦифровойРубль");
	Настройки.БанковскиеСчета.Вставить("СпециальныеСчетаВБанках");
	
	ОтчетностьВБанкиСлужебныйПереопределяемый.ПриОпределенииНастроек(Настройки);
...
Процедура ВывестиУзел_ОперБанкСч(Компоновщик, ПараметрыВыгрузки)
	...
	Если ЗначениеЗаполнено(ОтчетностьВБанкиСлужебный.ОбщиеНастройки().БанковскиеСчета.ЦифровойРубль) Тогда
