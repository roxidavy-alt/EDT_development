...
//  Соответствие из КлючИЗначение - доступные типы аналитик статей бюджетов:
...
// 	 *ПоляРасшифровки - Структура
// 	 *ПоляРасшифровкиРодители - Структура
// 	 *ПараметрыДанных - Структура
// 	 *Отбор - Структура
// 	 *ОсновноеДействие - ДействиеОбработкиРасшифровкиКомпоновкиДанных -
//
Функция ДанныеРасшифровкиОтчета(Расшифровка, АдресДанныхРасшифровки) Экспорт
	...
	ОсновноеДействие = ЭлементРасшифровки.ОсновноеДействие; // ДействиеОбработкиРасшифровкиКомпоновкиДанных
...
//
// Возвращаемое значение:
// 	Массив из Произвольный - массив пустых ссылок.
//
...
// 	ЗаменяемыеЗначения - Массив из Произвольный - Массив значений, на которые будет проверяться значение в поле перед заменой.
