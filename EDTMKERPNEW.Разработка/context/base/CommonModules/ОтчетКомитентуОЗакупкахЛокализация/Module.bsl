...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	""ОтчетКомитентуОЗакупкахЛокализация_682"" КАК НомерФрагмента
	|
	|ИЗ
	...
	|	""ОтчетКомитентуОЗакупкахЛокализация_1917"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	|	Строки.ИдентификаторСтрокиВознаграждения КАК ИдентификаторСтроки,
	...
	|	Операция.Услуга,
	|	Строки.ИдентификаторСтрокиВознаграждения";
