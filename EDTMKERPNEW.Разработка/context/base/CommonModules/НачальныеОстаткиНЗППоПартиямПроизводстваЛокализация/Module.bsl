...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	""НачальныеОстаткиНЗППоПартиямПроизводстваЛокализация_1763"" КАК НомерФрагмента
	|ИЗ
	...
	|	""НачальныеОстаткиНЗППоПартиямПроизводстваЛокализация_1764"" КАК НомерФрагмента
	|ИЗ
...
Функция ТекстЗапросаВТОтраженияВРеглУчете() Экспорт
	...
	|	ПрочиеРасходыНЗП.ИдентификаторФинЗаписи				КАК ИдентификаторФинЗаписи,
	...
	|	ПрочиеРасходыНЗП.ИдентификаторФинЗаписи,
	...
	|	ТрудозатратыНЗП.ИдентификаторФинЗаписи						КАК ИдентификаторФинЗаписи,
