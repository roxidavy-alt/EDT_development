...
Функция СформироватьПечатнуюФормуКО1(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	//++ НЕ УТ
	МассивВидовСчетов = ОбщегоНазначенияКлиентСервер.ЗначениеВМассиве("ДенежныеСредства");
	...
	//++ НЕ УТ
	|		ЛЕВОЕ СОЕДИНЕНИЕ ПорядокОтраженияНаСчетахУчетаПоПериодуДействия КАК СчетаУчета
	...
	|			И ДанныеДокумента.Дата >= СчетаУчета.НачалоДействия
	|			И ДанныеДокумента.Дата < СчетаУчета.ОкончаниеДействия
	//-- НЕ УТ
	|ГДЕ
	...
	Если ИспользуетсяРеглУчет Тогда
		ВыборкаОшибок = МассивРезультатов[МассивРезультатов.ВГраница()].Выбрать();
...
#Область ПоступлениеИзБанка
	...
	|	""ПриходныйКассовыйОрдерЛокализация_963"" КАК НомерФрагмента
	|
	|ИЗ 
	...
	|	""ПриходныйКассовыйОрдерЛокализация_964"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПоступлениеИзКассыККМ
	...
	|	""ПриходныйКассовыйОрдерЛокализация_965"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВозвратОтПодотчетника
	...
	|	""ПриходныйКассовыйОрдерЛокализация_966"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПоступлениеАвансаОтКлиентаДругойОрганизации
	...
	|	""ПриходныйКассовыйОрдерЛокализация_1801"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПоступлениеОплатыОтКлиентаДругойОрганизации
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПриходныйКассовыйОрдерЛокализация_1802"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область КонвертацияВалюты
	...
	|	""ПриходныйКассовыйОрдерЛокализация_967"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстКонвертацияВалютыПрочиеДоходы // (Дт 52:: Кт 91.1)
	...
	|	""ПриходныйКассовыйОрдерЛокализация_968"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстКонвертацияВалютыПрочиеРасходы // (Дт 91.2 :: Кт 52)
	...
	|	""ПриходныйКассовыйОрдерЛокализация_969"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПоступлениеДСИзДругойКассы
	...
	|	""ПриходныйКассовыйОрдерЛокализация_970"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ВнутренняяПередачаДС
	...
	|	""ПриходныйКассовыйОрдерЛокализация_971"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПолучениеКредитаЗайма                   // (Дт 50 :: Кт 66.01)
	...
	|	""ПриходныйКассовыйОрдерЛокализация_972"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область РасчетыПоЗаймамВыданным            // (Дт 50 :: Кт 58.03, 76.09)
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПриходныйКассовыйОрдерЛокализация_1803"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПогашениеЗаймаСотрудником               // (Дт 50 :: Кт 73.01)
	...
	|	""ПриходныйКассовыйОрдерЛокализация_1804"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПоступлениеЗалогаЗаПереданнуюТару
	...
	|	""ПриходныйКассовыйОрдерЛокализация_973"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПрочиеДоходы
	...
	|	""ПриходныйКассовыйОрдерЛокализация_974"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область СторноПрочихРасходов
	...
	|	""ПриходныйКассовыйОрдерЛокализация_975"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ПрочиеПоступления
	...
	|	""ПриходныйКассовыйОрдерЛокализация_976"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВозвратОплатыОтАрендодателя     // (Дт <50, 50.21> :: Кт <76.В, 76.Л, 76.ОЛП>)
	...
	|	""ПриходныйКассовыйОрдерЛокализация_977"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстПоступлениеДолгаАвансаОтКлиентаДругойОрганизацииМежФилиальная()
	...
	|		ИНАЧЕ ""Поступление аванса от клиента""
	|	КОНЕЦ КАК Содержание,
	|	""ПриходныйКассовыйОрдерЛокализация_1805"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ВозвратАвансаПогашениеДолгаСтарыеВзаиморасчеты()
	...
	|	""ПриходныйКассовыйОрдерЛокализация_1806"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ВозвратДССтарыеВзаиморасчеты()
	...
	|	""ПриходныйКассовыйОрдерЛокализация_1807"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ВозвратАвансаНовыеВзаиморасчеты()
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПриходныйКассовыйОрдерЛокализация_1904"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ПогашениеДолгаНовыеВзаиморасчеты()
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПриходныйКассовыйОрдерЛокализация_1808"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ВозвратДСНовыеВзаиморасчеты()
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПриходныйКассовыйОрдерЛокализация_1809"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
