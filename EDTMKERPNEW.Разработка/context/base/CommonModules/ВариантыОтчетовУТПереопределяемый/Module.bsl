...
Процедура НастроитьВариантыОтчетов(Настройки) Экспорт
	...
	Отчеты.СостояниеГотовностиЗаказовНаПроизводство.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	...
	Отчеты.СравнениеПлановыхКалькуляций.НастроитьВариантыОтчета(Настройки);
	...
	//++ НЕ УТ
	Отчеты.ПроверкаСвязанныхОстатковИОборотовБюджетов.НастроитьВариантыОтчета(Настройки, ВыводитьВариантыОтчетов);
	...
	Отчеты.КонтрольЗаказаНаПроизводство.НастроитьВариантыОтчета(Настройки);
	Отчеты.РасшифровкаКонтроляЗаказаНаПроизводстваПоПартиямЗапуска.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТКА
	
	//++ НЕ УТ
	Отчеты.НачисленныеСуммыАкцизов.НастроитьВариантыОтчета(Настройки);
	//-- НЕ УТ
