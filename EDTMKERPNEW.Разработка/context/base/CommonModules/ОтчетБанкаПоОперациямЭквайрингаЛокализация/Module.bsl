...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	""ОтчетБанкаПоОперациямЭквайрингаЛокализация_635"" КАК НомерФрагмента
	|
	|ИЗ
...
Функция ТекстЗапросаТаблицаКУДиР(Запрос, ТекстыЗапроса, Регистры)
	...
	|		ТОГДА &СтавкаНДС * ЕСТЬNULL(СуммыДокументовВВалютахУчета.СуммаБезНДСРегл, ДанныеДокумента.СуммаКомиссии) / (100 + &СтавкаНДС) 
	|		ИНАЧЕ 0 
	|	КОНЕЦ) КАК НДС,
