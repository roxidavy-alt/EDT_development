	...
	Иначе
		...
		ВызватьИсключение СтрШаблон(
							НСтр("ru = 'Неизвестный тип данных ""%1"" универсальной очереди оперативных заданий.';
								|en = 'Unknown ""%1"" data type of the universal queue of real-time jobs.'"),
							ТипДанных);
...
//++ НЕ УТКА
	ДобавитьВложеннуюОчередь(
		...
		"Документы.ЭтапПроизводства2_2.ОбновитьГрафикДвиженияТоваров");
		
	ДобавитьВложеннуюОчередь(
		ТаблицаОчередей,
		Перечисления.ЗаданияУниверсальнойОчереди.ОбновлениеГрафикаДвиженияТоваровПоЗаказамНаПроизводство,
		"Документы.ЗаказНаПроизводство2_2.ОбновитьГрафикДвиженияТоваров");
	...
	ДобавитьВложеннуюОчередь(
		...
		"БюджетированиеСервер.СформироватьСвязанныеОборотыБюджетов");
//-- НЕ УТКА
