...
Процедура ДобавитьСтраницуРаздел5(Контейнер, НомерСтраницы, ДанныеЗаполнения, МакетыРасшифровкиПолей, ТаблицаРасшифровки, ПараметрыРасшифровки)
	...
	Иначе
		...
		ОписаниеОшибки = НСтр("ru = 'Неизвестное начало квартала.';
								|en = 'Unknown beginning of the quarter.'", ОбщегоНазначения.КодОсновногоЯзыка());
...
Процедура ЗаполнитьСтрокуСтраницыРаздел5(Страница, НомерСтрокиБезГруппировки, НомерСтраницы, ДанныеЗаполнения, МакетыРасшифровкиПолей, ТаблицаРасшифровки, ПараметрыРасшифровки)
	...
	ДобавитьЗначениеВОтбор(
		...
		НаименованиеПоказателя = НСтр("ru = 'Налоговая база по операциям, обоснованность применения налоговой ставки
					...
					|en = 'Tax base for the operations for which 0% tax rate
					|use is justified documentally in previous fiscal periods'");
	ЗаполнениеРасшифровкаРегламентированнойОтчетности.ДобавитьСтрокуРасшифровки(
		ТаблицаРасшифровки,
		ИдентификаторПоказателя,
		НаименованиеПоказателя,
	...
	ДополнительныеПараметрыИОтбор.ДополнительныеПараметры.Вставить("ДатаНачала", ПараметрыРасшифровки.НачалоПериодаОтчета); //ПараметрыРасшифровки.ДатаНачала); // ПараметрыРасшифровки.НачалоПериодаОтчета);
	...
	ДобавитьЗначениеВОтбор(
		...
		НаименованиеПоказателя = НСтр("ru = 'Налоговая база по операциям, обоснованность применения налоговой ставки
					...
					|en = 'Tax base for the operations for which 0% tax rate
					|use is not justified documentally in previous fiscal periods'");
	...
	НаимПоказателя = НСтр(
					...
					|en = 'Tax amount to be deducted for operations for which 0% tax rate
					|use is justified documentally
					|in previous fiscal periods, calculated
					|for reimbursement under Section 5'");
	...
	НаимПоказателя = НСтр(
					...
					|к возмещению по разделу 5';
					|en = 'Tax amount to be deducted for operations for which 0% tax rate
					|use is not justified documentally
					|in previous fiscal periods, calculated
					|for reimbursement under Section 5'");
