...
Процедура ОбновитьПоставляемыеДрайвера(ДрайвераОборудования) Экспорт
	...
	Драйвер.Наименование = НСтр("ru = 'CAS:Электронные весы 2.х';
								|en = 'CAS:Digital retail scales 2.x'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'МАС:Электронные весы';
								|en = 'MAS:Digital retail scales'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'AQSI:Электронные весы';
								|en = 'AQSI:Digital retail scale'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	...
	Драйвер.Наименование = НСтр("ru = 'ДатаПринт:Весы с печатью этикеток DP WASP';
								|en = 'ДатаПринт:Весы с печатью этикеток DP WASP'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
	Драйвер.ИдентификаторОбъекта = "DpNonPcDriver";   
	
	Драйвер = ДрайвераОборудования.Добавить();
	Драйвер.ТипОборудования = Перечисления.ТипыПодключаемогоОборудования.ВесыСПечатьюЭтикеток;
	Драйвер.ИмяДрайвера  = "ДрайверДатаПринтВесыCПечатьюЭтикетокDPFalcon";
	Драйвер.Наименование = НСтр("ru = 'ДатаПринт:Компьютерные весы с печатью этикеток DP';
								|en = 'ДатаПринт:Компьютерные весы с печатью этикеток DP'", ОбщегоНазначенияБПО.КодОсновногоЯзыка());
