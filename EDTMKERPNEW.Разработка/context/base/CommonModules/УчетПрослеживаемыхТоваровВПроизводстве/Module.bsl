...
// * Регистратор - ДокументСсылка - ссылка на документ, движения которого не должны уитываться при получении остатков.
//
Функция ПараметрыЗапросаОстатковРНПТМатериаловВПроизводстве() Экспорт
	...
	Параметры.Вставить("Регистратор",                   Неопределено);
