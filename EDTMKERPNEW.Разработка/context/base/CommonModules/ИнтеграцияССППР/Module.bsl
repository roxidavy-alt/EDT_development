...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	Вид.Имя = "ИнтеграцияССППР";
	Вид.ИмяПодменю = "ИнтеграцияССППР";
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Если НеТребуютсяКомандыИнтеграцииССППР(НастройкиФормы) Тогда
		Возврат;
	КонецЕсли;
	
	// В форме отчета команда размещается во всех действиях, иначе ее не видно
	ТолькоВоВсехДействиях = (Найти(НастройкиФормы.ИмяФормы, "Отчет.") <> 0);

	Команда = Команды.Добавить();
	Команда.Вид = "ИнтеграцияССППР";
	Команда.Идентификатор = "ФункциональнаяМодель";
	Команда.Представление = НСтр("ru = 'Функциональная модель';
								|en = 'Functional model'");
	Команда.Важность = "Обычное";
	Команда.ОтображениеКнопки = ОтображениеКнопки.Картинка;
	Команда.Картинка = БиблиотекаКартинок.ФункциональнаяМодель;
	Команда.Порядок = 50;
	Команда.ТолькоВоВсехДействиях = ТолькоВоВсехДействиях;
	Команда.РежимЗаписи = "НеЗаписывать";
	Команда.Обработчик = "ИнтеграцияССППРКлиент.ВыполнитьПодключаемуюКомандуИнтеграцииССППР";
