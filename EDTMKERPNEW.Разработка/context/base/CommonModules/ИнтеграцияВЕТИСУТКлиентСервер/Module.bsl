...
Процедура КомандыИсходящейТранспортнойОперации(Команды) Экспорт 
	...
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуОформить(Команды,"ВозвратСырьяДавальцу",              НСтр("ru = 'Возврат давальцу';
																												|en = 'Возврат давальцу'"),               "ИспользоватьПроизводствоИзДавальческогоСырья");
	//-- Устарело_Переработка24
	...
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(Команды,"ПередачаДавальцу",                  НСтр("ru = 'Передачу давальцу';
																												|en = 'Передачу давальцу'"),                    "ИспользоватьПроизводствоИзДавальческогоСырья");
	ПодключаемыеКомандыИСКлиентСервер.ДобавитьКомандуВыбрать(Команды,"ВозвратСырьяДавальцу",              НСтр("ru = 'Возврат давальцу';
																												|en = 'Возврат давальцу'"),               "ИспользоватьПроизводствоИзДавальческогоСырья");
	//-- Устарело_Переработка24
