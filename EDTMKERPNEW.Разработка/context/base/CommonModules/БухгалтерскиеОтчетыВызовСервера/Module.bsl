...
Процедура ДобавитьОтборДляПоказателяКонтроль(ПараметрыОтчета, КомпоновщикНастроек, ВПользовательскиеНастройки = Истина) Экспорт
	...
	БухгалтерскиеОтчетыПереопределяемый.ДополнительныеПоказателиБухгалтерскихОтчетов(МассивПоказателей, , Истина);
...
Функция ВсяДоступнаяАналитикаСчета(Счет, ВключатьПризнакиУчета = Истина)
	...
	БухгалтерскиеОтчетыПереопределяемый.ДополнитьАналитикуСчета(АналитикаСчета, СвойстваСчета, ВключатьПризнакиУчета, ПараметрыСтрокой);
