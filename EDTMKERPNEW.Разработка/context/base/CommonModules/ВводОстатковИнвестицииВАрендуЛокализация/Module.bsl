...
Процедура ТекстОтраженияВРеглУчетеДоходнойАренды(СписокЗапросов) Экспорт
	...
	|	""ВводОстатковИнвестицииВАрендуЛокализация_72"" КАК НомерФрагмента
	|ИЗ
	...
	|	""ВводОстатковИнвестицииВАрендуЛокализация_73"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ИнвестицииВАренду КАК СтрокиДт
	...
	|	""ВводОстатковИнвестицииВАрендуЛокализация_74"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
