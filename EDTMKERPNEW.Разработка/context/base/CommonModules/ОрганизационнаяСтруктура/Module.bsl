...
Процедура ОбновитьМестаПозицийШтатногоРасписанияПоДвижениямИзмененияМеста() Экспорт
	...
	Исключение
		...
		ЗаписьЖурналаРегистрации(
			...
			|en = 'Организационная структура. Полное обновление истории изменения места позиции в структуре предприятия.'",
...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Комментарий = НСтр(
		...
		|en = 'Заполнение мест в структуре предприятия движений документов штатного расписания.'");
	...
	Обработчик.Комментарий = НСтр(
		...
		|en = 'Заполнение мест позиций в структуре предприятия по данным движений истории изменения.'");
