...
#Область ТекстПоступлениеАвансаОтКлиентаДругойОрганизации
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1783"" КАК НомерФрагмента
	|
	|ИЗ
...
#Область ТекстПоступлениеОплатыОтКлиентаДругойОрганизации
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1784"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВнутренняяПередачаДС
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_887"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПоступлениеСДругогоСчетаКассы
	...
	|			""Инкассация в банк""
	|	КОНЕЦ КАК Содержание,
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1785"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПоступлениеОплатыПоЭквайрингу
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_888"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстКомиссияПоОперациямЭквайринга
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_889"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПолучениеКредитаЗайма            // (Дт 51 :: Кт 66.01)
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_890"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстРасчетыПоДепозиту                  // (Дт 51 :: Кт 55.03, 76.09)
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1786"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстРасчетыПоПредоставленномуЗайму     // (Дт 51 :: Кт 58.03, 76.09)
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1787"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПрочиеДоходы
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_891"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПрочиеПоступления
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_892"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстКонвертацияВалюты
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_893"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстКонвертацияВалютыПрочиеДоходы    // (Дт 52:: Кт 91.1)
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_894"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстКонвертацияВалютыПрочиеРасходы   // (Дт 91.2 :: Кт 52)
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_895"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПогашениеЗаймаСотрудником        // (Дт 51 :: Кт 73.01)
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1788"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстПоступлениеЗалогаЗаПереданнуюТару
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_896"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВозвратОтПодотчетника
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_897"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВозвратНеперечисленнойЗарплатыНаЛицевыеСчета // (Дт 51 :: Кт 70)
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_898"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВозвратНеперечисленнойЗарплатыПоЗарплатномуПроекту // (Дт 51 :: Кт 70, 57.01)
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_899"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВозвратНеперечисленнойЗарплатыПоЗарплатномуПроектуЧерезПереводыВПути // (Дт 51 :: Кт 57.01)
	...
	|	0 КАК СуммаВРКт,
	|	""Возврат неперечисленной зарплаты по зарплатному проекту"" КАК Содержание,
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_900"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВозвратОплатыОтАрендодателя     // (Дт <51, 52> :: Кт <76.В, 76.Л, 76.ОЛП>)
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_901"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
// Налоги и сборы
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_902"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Процедура ЗаполнитьРеквизитыЗначениямиПоУмолчанию(Объект)
	...
	Объект.БанковскийСчет = ДенежныеСредстваСервер.ПолучитьБанковскийСчетОрганизацииПоУмолчанию(СтруктураПараметров, ,
...
Функция ТекстПоступлениеДолгаАвансаОтКлиентаДругойОрганизацииМежФилиальная()
	...
	|		ИНАЧЕ ""Поступление аванса от клиента""
	|	КОНЕЦ КАК Содержание,
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1789"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ВозвратАвансаПогашениеДолгаСтарыеВзаиморасчеты()
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1790"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ВозвратДССтарыеВзаиморасчеты()
	...
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1791"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ВозвратАвансаНовыеВзаиморасчеты()
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1792"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ПогашениеДолгаНовыеВзаиморасчеты()
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1793"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
...
Функция ВозвратДСНовыеВзаиморасчеты()
	...
	|	КОНЕЦ КАК Содержание,
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_1794"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстКомиссияПоОперациямЭквайринга() Экспорт
	...
	|
	|	""Комиссия по операциям эквайринга"" КАК Содержание,
	|	""ПоступлениеБезналичныхДенежныхСредствЛокализация_2000"" КАК НомерФрагмента
	|	
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
