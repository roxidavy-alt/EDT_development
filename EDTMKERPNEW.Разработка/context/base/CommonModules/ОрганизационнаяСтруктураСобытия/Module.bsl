	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьШтатноеРасписание") 
		...
		Если ПодразделениеПредприятияОбъект.ПометкаУдаления
			...
			ТекстСообщения = СтрШаблон(
				НСтр("ru = 'Нельзя пометить на удаление действующее подразделение ""%1""';
					|en = 'Нельзя пометить на удаление действующее подразделение ""%1""'"), ПодразделениеПредприятияОбъект);
...
Функция СписокИсключаемыхРеквизитов(Источник)
	...
	Если ТипЗнч(Источник) = Тип("СправочникСсылка.Организации") Тогда
		СписокИсключаемыхРеквизитов.Добавить("Сформировано");
		СписокИсключаемыхРеквизитов.Добавить("ДатаСоздания");
		СписокИсключаемыхРеквизитов.Добавить("Расформировано");
		СписокИсключаемыхРеквизитов.Добавить("ДатаРасформирования");
	КонецЕсли;
