...
Функция ВидОшибкиПроверкаПодписейНедоступна()
	...
	ВидОшибки.ОписаниеРешения = НСтр("ru = '<a href = ""%1"">Включите</a> проверку электронных подписей на сервере
		...
		|en = '<a href = ""%1"">Включите</a> проверку электронных подписей на сервере
		|и повторите операцию'");
...
Процедура ЗаполнитьРезультатПолученияПоИдентификаторуЭДО(Результат, ИдентификаторЭДО, ДатаНачала, РезультатДействийЭДО)
	...
	Если Остановлено Тогда
		ТекстСообщения = НСтр("ru = 'Автоматическое получение остановлено с ошибками:';
								|en = 'Автоматическое получение остановлено с ошибками:'")
	Иначе
		ТекстСообщения = НСтр("ru = 'Автоматическое получение выполнено с ошибками:';
								|en = 'Автоматическое получение выполнено с ошибками:'")
	КонецЕсли;
