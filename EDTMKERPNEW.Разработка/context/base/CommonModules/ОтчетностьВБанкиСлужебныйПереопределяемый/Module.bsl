...
// Вызывается при получении общих настроек функционирования подсистемы "Отчетность в банки".
// Предназначена для изменения значения настройки в конфигурации-потребителе.
// 
// Параметры:
//  Настройки - см. ОтчетностьВБанкиСлужебный.ОбщиеНастройки
// 
// Пример:
//  Настройки.БанковскиеСчета.ЦифровойРубль = ПланыСчетов.Хозрасчетный.ЦифровойРубль;
// 
