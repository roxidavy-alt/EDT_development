...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	ТекстыОтражения.Добавить(РеглУчетВыборкиСерверПовтИсп.ТекстВыручкаОтРеализации()); // Выручка от реализации товара (Дт 62.01 :: Кт 90.01)
...
Функция ТекстОтражениеВзаиморасчетовПоКомиссионномуТовару()
	...
	|	""ОтчетКомиссионераЛокализация_651"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстЗатратыНаКомиссионноеВознаграждение()
	...
	|	""ОтчетКомиссионераЛокализация_656"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстРаспределениеЗатратКомиссионногоВознаграждения()
	...
	|	""ОтчетКомиссионераЛокализация_657"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстНДСНаКомиссионноеВознаграждение()
	...
	|	""ОтчетКомиссионераЛокализация_658"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстУдержатьВознаграждениеАванс()
	...
	|	""ОтчетКомиссионераЛокализация_659"" КАК НомерФрагмента
	|
	|ИЗ	
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстУдержатьВознаграждениеОплатаДолга()
	...
	|	""ОтчетКомиссионераЛокализация_660"" КАК НомерФрагмента
	|
	|ИЗ 	
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстПродажаАгентскихУслуг()
	...
	|	""ОтчетКомиссионераЛокализация_661"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстВключениеИсключениеНДСВСтоимость()
	...
	|	""ОтчетКомиссионераЛокализация_664"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстПродажаКомиссионногоТовара()
	...
	|	""ОтчетКомиссионераЛокализация_665"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
Функция ТекстВключенияНДСВЗатратыНаКомиссионноеВознаграждение()
	...
	|	""ОтчетКомиссионераЛокализация_666"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
...
Функция ТекстВосстановлениеАвансаКлиента()
	...
	|	""ОтчетКомиссионераЛокализация_667"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
