...
Функция ТекстОтраженияВРеглУчете() Экспорт
	...
	|	""ЗаключениеДоговораАрендыЛокализация_363"" КАК НомерФрагмента
	|ИЗ
	...
	|	""ЗаключениеДоговораАрендыЛокализация_364"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрочиеРасходы КАК СтрокиДт
	...
	|
	|	""Формирование стоимости предметов аренды"" КАК Содержание,
	|	""ЗаключениеДоговораАрендыЛокализация_365"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрочиеРасходы КАК СтрокиДт
	...
	|	""ЗаключениеДоговораАрендыЛокализация_366"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""ЗаключениеДоговораАрендыЛокализация_367"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.РасчетыПоФинансовымИнструментам КАК Строки
	...
	|	""ЗаключениеДоговораАрендыЛокализация_368"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""ЗаключениеДоговораАрендыЛокализация_369"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.ЗаключениеДоговораАренды КАК Операция
	...
	|	""ЗаключениеДоговораАрендыЛокализация_370"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	0 КАК СуммаВРКт,
	|	""Корректировка арендных обязательств"" КАК Содержание,
	|	""ЗаключениеДоговораАрендыЛокализация_371"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.ПрочиеРасходы КАК СтрокиДт
	...
	|	0 КАК СуммаВРКт,
	|	""Корректировка арендных обязательств"" КАК Содержание,
	|	""ЗаключениеДоговораАрендыЛокализация_372"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.РасчетыПоФинансовымИнструментам КАК СтрокиДт
	...
	|	0 КАК СуммаВРКт,
	|	""Корректировка арендных обязательств"" КАК Содержание,
	|	""ЗаключениеДоговораАрендыЛокализация_373"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	...
	|	""ЗаключениеДоговораАрендыЛокализация_374"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ РегистрНакопления.РасчетыПоФинансовымИнструментам КАК Строки
