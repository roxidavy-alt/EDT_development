...
Процедура ВедомостиПлатежногоДокументаПеречисленияЗарплаты(ПлатежныйДокумент, МассивВедомостей, СтандартнаяОбработка = Истина) Экспорт
	...
	|		ИЛИ ВедомостиЗаявки.Ведомость ССЫЛКА Документ.ВедомостьПрочихДоходовВБанк)
	|
	|ОБЪЕДИНИТЬ ВСЕ
	|
	|ВЫБРАТЬ
	...
	|		ИЛИ ВедомостиСписания.Ведомость ССЫЛКА Документ.ВедомостьПрочихДоходовВБанк)");
	...
	Пока Выборка.Следующий() Цикл
		Если ЗначениеЗаполнено(Выборка.Ведомость) Тогда
...
Процедура ЗаполнитьДанныеПлатежногоДокумента(ДанныеПлатежногоДокумента, ПлатежныйДокумент, СтандартнаяОбработка) Экспорт
	...
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(ПлатежныйДокумент, "ЖелательнаяДатаПлатежа") Тогда
		ДанныеПлатежногоДокумента.Дата = ПлатежныйДокумент.ЖелательнаяДатаПлатежа;
	Иначе
