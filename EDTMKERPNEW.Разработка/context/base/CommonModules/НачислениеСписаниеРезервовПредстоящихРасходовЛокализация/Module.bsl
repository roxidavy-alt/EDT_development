...
#Область ТекстНачислениеРезерва_ПрочиеРасходы
	...
	|	""НачислениеСписаниеРезервовПредстоящихРасходовЛокализация_601"" КАК НомерФрагмента
	|
	|ИЗ 
...
#Область ТекстНачислениеРезерва_СтоимостьОС
	...
	|	""Начисление резерва"" КАК Содержание,
	|	""НачислениеСписаниеРезервовПредстоящихРасходовЛокализация_602"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВосстановлениеРезерва_ПрочиеДоходы
	...
	|	""НачислениеСписаниеРезервовПредстоящихРасходовЛокализация_603"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВосстановлениеРезерва_ПрочиеРасходы
	...
	|	ПрочиеРасходы.ВременнаяРазница КАК СуммаВРКт,
	|	""Восстановление резерва"" КАК Содержание,
	|	""НачислениеСписаниеРезервовПредстоящихРасходовЛокализация_604"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстВосстановлениеРезерва_СтоимостьОС
	...
	|	СтоимостьОС.СтоимостьВР КАК СуммаВРКт,
	|	""Восстановление резерва"" КАК Содержание,
	|	""НачислениеСписаниеРезервовПредстоящихРасходовЛокализация_605"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстНачислениеПроцентовПоДисконтированию
	...
	|	""НачислениеСписаниеРезервовПредстоящихРасходовЛокализация_606"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область ТекстСписаниеПроцентовПоДисконтированию
	...
	|	""НачислениеСписаниеРезервовПредстоящихРасходовЛокализация_607"" КАК НомерФрагмента
	|
	|ИЗ 
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область СписаниеРасходовЗаСчетРезервов //(Дт 96 :: Кт 25, 26)
	...
	|	ДД.ИдентификаторФинЗаписи КАК ИдентификаторСтроки,
	|
	...
	|	""НачислениеСписаниеРезервовПредстоящихРасходовЛокализация_608"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область СписаниеРасходовЗаСчетРезервовПР //(Дт 91 :: Кт 96)
	...
	|	""Списание расходов за счет резервов"" КАК Содержание,
	|	""НачислениеСписаниеРезервовПредстоящихРасходовЛокализация_609"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
...
#Область СписаниеРасходовЗаСчетРезервов //(Дт 91 :: Кт 96)
	...
	|	-ДД.ВременнаяРазница КАК СуммаВРКт,
	|	""Списание расходов за счет резервов"" КАК Содержание,
	|	""НачислениеСписаниеРезервовПредстоящихРасходовЛокализация_610"" КАК НомерФрагмента
	|
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
