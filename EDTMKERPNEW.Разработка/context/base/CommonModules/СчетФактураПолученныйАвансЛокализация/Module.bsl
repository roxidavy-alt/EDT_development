...
Процедура СформироватьТекстОтраженияВРеглУчете(ТекстЗапроса) Экспорт
	...
	|	""СчетФактураПолученныйАвансЛокализация_1307"" КАК НомерФрагмента
	|ИЗ
	...
	|	""СчетФактураПолученныйАвансЛокализация_1308"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	""СчетФактураПолученныйАвансЛокализация_1309"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	""СчетФактураПолученныйАвансЛокализация_1310"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
	...
	|	""СчетФактураПолученныйАвансЛокализация_1311"" КАК НомерФрагмента
	|ИЗ
	|	ДокументыКОтражению КАК ДокументыКОтражению
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ
