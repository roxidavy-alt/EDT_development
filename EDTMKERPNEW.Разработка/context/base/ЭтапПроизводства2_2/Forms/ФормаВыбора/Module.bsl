...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Отбор") Тогда
		...
		Если Параметры.Отбор.Свойство("Распоряжение", Распоряжение) Тогда
		
			УстановитьОтборПоРаспоряжению(ЭтаФорма);
		
		ИначеЕсли Параметры.Отбор.Свойство("ПартияПроизводства", ПартияПроизводства) Тогда
			
			Элементы.Распоряжение.Видимость = Ложь;
			Элементы.ПартияПроизводства.Видимость = Истина;
